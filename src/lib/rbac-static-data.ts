...
export const PAGES: StaticPageRow[] = [
  ...
  // نفس نمط التجميع: "نظرة عامة" ظاهرة دايمًا، والباقي بمجموعتين حسب
  // طبيعة القرار: "المنهج والمحتوى" (مراجعة/موافقة تعليمية) مقابل
  // "الإشراف والمالية" (متابعة أشخاص وأموال).
  {
