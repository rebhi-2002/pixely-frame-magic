...
const CONFIG: Record<AdminFeature, Config> = {
  dashboard: {
    ...
    rowsEn: [["Review 8 verification requests", "Teachers", "Awaiting decision"], ["Approve physics curriculum update", "Curriculum", "New"], ["Triage 4 community reports", "Safety", "Urgent"]],
    chart: { kind: "trend", data: [["يناير", "Jan", 1240], ["فبراير", "Feb", 1680], ["مارس", "Mar", 2140], ["أبريل", "Apr", 2620], ["مايو", "May", 3180], ["يونيو", "Jun", 3910]] },
  },
  teachers: {
    ...
    rowsEn: [["Sara Al-Hasan", "Mathematics", "Aug 5, 2026", "In review"], ["Mohammed Al-Ali", "Physics", "Aug 4, 2026", "Complete"], ["Reem Khaled", "Arabic", "Aug 4, 2026", "Missing document"]],
    chart: { kind: "bar", data: [["جديدة", "New", 8], ["مكتملة", "Complete", 21], ["ناقصة", "Incomplete", 3], ["مرفوضة", "Rejected", 2]] },
  },
  "content-review": {
    ...
    rowsEn: [["Calculus — Unit 2", "Ahmed Youssef", "Lesson", "New"], ["Electricity quiz", "Lina Samir", "Quiz", "Second review"], ["Organic chemistry", "Yasser Ali", "Course", "Ready to approve"]],
    chart: { kind: "bar", data: [["دروس", "Lessons", 12], ["اختبارات", "Quizzes", 11], ["كورسات", "Courses", 7], ["ملفات", "Files", 9]] },
  },
  "community-reports": {
    ...
    rowsEn: [["#R-1042", "High-school math", "Inappropriate content", "High"], ["#R-1041", "Physics community", "Repeated spam", "Medium"], ["#R-1038", "Arabic language", "Misleading information", "Medium"]],
    chart: { kind: "split", data: [["مفتوحة", "Open", 12], ["مغلقة", "Closed", 34], ["مؤجلة", "Deferred", 5]] },
  },
  users: {
    ...
    rowsEn: [["Nour Al-Khatib", "Student", "4 minutes ago", "Active"], ["Mahmoud Sulaiman", "Teacher", "1 hour ago", "Active"], ["Huda Karim", "Parent", "Yesterday", "Suspended"]],
    chart: { kind: "split", data: [["طلاب", "Students", 15770], ["معلمون", "Teachers", 412], ["أولياء أمور", "Parents", 2238]] },
  },
  payments: {
    ...
    rowsEn: [["#PAY-9281", "Omar Salim", "$49", "Successful"], ["#PAY-9280", "Sara Kamel", "$89", "Processing"], ["#PAY-9274", "Layan Ahmed", "$29", "Refunded"]],
    chart: { kind: "trend", data: [["مارس", "Mar", 28400], ["أبريل", "Apr", 33900], ["مايو", "May", 41200], ["يونيو", "Jun", 44800], ["يوليو", "Jul", 48260]] },
  },
  roles: {
    ...
    rowsEn: [["Student", "/dashboard", "15,770", "Enabled"], ["Teacher", "/teacher/dashboard", "412", "Enabled"], ["Parent", "/parent/report", "2,238", "Enabled"], ["Academic supervisor", "/supervisor/dashboard", "14", "Enabled"], ["Administrator", "/admin/dashboard", "3", "Enabled"]],
    chart: { kind: "bar", data: [["طالب", "Student", 15770], ["معلم", "Teacher", 412], ["ولي أمر", "Parent", 2238], ["مشرف", "Supervisor", 14], ["مدير", "Admin", 3]] },
  },
  curriculum: {
    ...
    rowsEn: [["Grade 12", "Science", "Physics", "8"], ["Grade 12", "Science", "Mathematics", "11"], ["Grade 11", "Literary", "Arabic", "6"]],
    chart: { kind: "bar", data: [["الصفوف", "Grades", 12], ["المجموعات", "Groups", 36], ["المواد", "Subjects", 42], ["الوحدات", "Modules", 684]] },
  },
  "curriculum-requests": {
    ...
    rowsEn: [["Add waves module", "Dr. Khaled Omar", "Module", "New"], ["Reorder chemistry units", "Salma Hasan", "Subject", "In review"], ["Add literary group", "Academic supervisor", "Group", "Ready to approve"]],
    chart: { kind: "split", data: [["جديدة", "New", 9], ["قيد الدراسة", "In review", 6], ["معتمدة", "Approved", 31], ["مرفوضة", "Rejected", 4]] },
  },
  settings: {
    ...
    rowsEn: [["Email confirmation", "Accounts", "Required", "Enabled"], ["Teacher content review", "Publishing", "Before release", "Enabled"], ["Default interface language", "Interface", "Arabic", "Enabled"]],
    chart: { kind: "bar", data: [["الحسابات", "Accounts", 6], ["النشر", "Publishing", 4], ["الإشعارات", "Notifications", 5], ["الأمان", "Security", 7]] },
  },
};
