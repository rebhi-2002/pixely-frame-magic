    ...
    >
      <StatGrid
        items={[
          ...
          { icon: "MessagesSquare", label: bi("أسئلة بلا جواب", "Unanswered questions"), value: "7" },
      ...
      <Panel title={bi("إجراءات سريعة", "Quick actions")} icon="Zap">
        <QuickLinks
          items={[
            ...
            { to: "/teacher/quizzes", label: bi("إنشاء اختبار", "Create quiz"), icon: "ListChecks" },
            { to: "/teacher/grading", label: bi("ابدأ التصحيح", "Start grading"), icon: "PenSquare" },
            { to: "/teacher/community", label: bi("مجتمع الصف", "Class community"), icon: "MessagesSquare" },
      ...
      <Panel title={bi("يحتاج انتباهك", "Needs your attention")} icon="Bell">
        <RowList
          rows={[
            { title: bi("18 ورقة رياضيات بانتظار التصحيح", "18 math papers to grade"), meta: bi("الصف الحادي عشر", "Grade 11"), value: bi("عاجل", "Urgent"), tone: "danger" },
            { title: bi("7 أسئلة في مجتمع الفيزياء", "7 questions in physics community"), meta: bi("منذ يومين", "2 days ago"), value: bi("متابعة", "Follow up"), tone: "primary" },
            { title: bi("درس «الدوال» بانتظار مراجعة المحتوى", "Functions lesson pending review"), meta: bi("أُرسل 2026/07/29", "Sent 2026/07/29"), value: bi("قيد المراجعة", "In review"), tone: "muted" },
          ]}
        />
      </Panel>
    </AppPage>
