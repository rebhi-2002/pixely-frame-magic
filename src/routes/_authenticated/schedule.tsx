...
function Body() {
  ...
  return (
    <AppPage
      ...
      icon="CalendarDays"
      subtitle={bi(
        "جدول دراسي يذكّرك: حصص، واجبات، امتحانات، وجلسات مراجعة.",
        ...
        <DataTable
          ...
          rows={[
            [
              ...
              bi("17:00", "17:00"),
              <Badge tone="primary">{bi("مراجعة", "Review")}</Badge>,
            ],
            [
              bi("الاثنين", "Monday"),
              bi("امتحان فيزياء", "Physics quiz"),
              bi("09:00", "09:00"),
              <Badge tone="danger">{bi("امتحان", "Exam")}</Badge>,
            ],
            [
              bi("الأربعاء", "Wednesday"),
              bi("تسليم واجب كيمياء", "Chemistry homework due"),
              bi("23:59", "23:59"),
              <Badge tone="muted">{bi("واجب", "Homework")}</Badge>,
            ],
          ]}
        />
      </Panel>
