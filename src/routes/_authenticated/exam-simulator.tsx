...
const description = "امتحان تدريبي بمؤقّت وشكل ورقة حقيقية، وتحليل يكشف نقاط ضعفك قبل الامتحان الحقيقي.";
...
function Body() {
  ...
  return (
    <AppPage
      ...
      icon="Timer"
      subtitle={bi("امتحان تدريبي بمؤقّت وشكل ورقة حقيقية، وتحليل يكشف نقاط ضعفك قبل الامتحان الحقيقي.", "A timed mock exam that looks like the real paper, with analysis that exposes weak spots.")}
    >
      <StatGrid
        items={[
      ...
      <Panel title={bi("نتائجك السابقة", "Past results")} icon="History">
        <DataTable
          head={[bi("الامتحان", "Exam"), bi("التاريخ", "Date"), bi("النتيجة", "Score"), bi("الوقت", "Time")]}
          rows={[
            [bi("رياضيات — نموذج 2", "Math — model 2"), bi("2026/07/28", "2026/07/28"), <Badge tone="success">88%</Badge>, bi("54 د", "54 min")],
            [bi("فيزياء — وحدة 2", "Physics — unit 2"), bi("2026/07/21", "2026/07/21"), <Badge tone="primary">72%</Badge>, bi("31 د", "31 min")],
            [bi("كيمياء — سريع", "Chemistry — quick"), bi("2026/07/14", "2026/07/14"), <Badge tone="danger">54%</Badge>, bi("11 د", "11 min")],
          ]}
        />
      </Panel>
    </AppPage>
