...
import { i as r, r as i } from "./dist-LHEW5aEh.js";
import { r as a } from "./dist-DIUTVkhN.js";
var o = n(t(), 1),
  s = e(),
...
function u(e) {
  let t = e + `CollectionProvider`,
    [n, c] = a(t),
    [u, d] = n(t, { collectionRef: { current: null }, itemMap: new Map() }),
    f = l((e) => {
      let { scope: t, children: n } = e,
        r = o.useRef(null),
        i = o.useRef(new Map()).current;
      return (0, s.jsx)(u, { scope: t, itemMap: i, collectionRef: r, children: n });
    }, `CollectionProvider`);
  f.displayName = t;
  let p = e + `CollectionSlot`,
    ...
    h = o.forwardRef((e, t) => {
      let { scope: n, children: i } = e,
        a = d(p, n),
        o = r(t, a.collectionRef);
      return (0, s.jsx)(m, { ref: o, children: i });
    });
  h.displayName = p;
  let g = e + `CollectionItemSlot`,
    ...
    y = o.forwardRef((e, t) => {
      let { scope: n, children: i, ...a } = e,
        ...
        u = d(g, n);
      return (
        o.useEffect(() => (u.itemMap.set(c, { ref: c, ...a }), () => void u.itemMap.delete(c))),
        (0, s.jsx)(v, { [_]: ``, ref: l, children: i })
      );
    });
  y.displayName = g;
  function b(t) {
  ...
  return (l(b, `useCollection`), [{ Provider: f, Slot: h, ItemSlot: y }, b, c]);
}
l(u, `createCollection`);
var d = new WeakMap(),
  f = class e extends Map {
    static {
      l(this, `OrderedDict`);
    }
    #e;
...
function g(e) {
  let t = e + `CollectionProvider`,
    ...
    [u, d] = n(t, {
      ...
      itemMap: new f(),
      setItemMap: l(() => void 0, `setItemMap`),
    }),
    p = l(
      ({ state: e, ...t }) => (e ? (0, s.jsx)(h, { ...t, state: e }) : (0, s.jsx)(m, { ...t })),
      `CollectionProvider`,
    );
  p.displayName = t;
  let m = l((e) => {
    let t = T();
    return (0, s.jsx)(h, { ...e, state: t });
  }, `CollectionInit`);
  m.displayName = t + `Init`;
  let h = l((e) => {
    let { scope: t, children: n, state: i } = e,
      a = o.useRef(null),
      [c, l] = o.useState(null),
      d = r(a, l),
      [f, p] = i;
    return (
      o.useEffect(() => {
        ...
        let e = b(() => {});
        return (
          e.observe(c, { childList: !0, subtree: !0 }),
          () => {
            e.disconnect();
          }
        );
  ...
  let g = e + `CollectionSlot`,
    ...
    x = o.forwardRef((e, t) => {
      let { scope: n, children: i } = e,
        a = d(g, n),
        o = r(t, a.collectionRef);
      return (0, s.jsx)(v, { ref: o, children: i });
    });
  x.displayName = g;
        ...
        o.useEffect(() => {
          ...
          return (
            m((t) =>
              l
                ? t.has(l)
                  ? t.set(l, { ...e, element: l }).toSorted(y)
                  : (t.set(l, { ...e, element: l }), t.toSorted(y))
                : t,
            ),
            () => {
              m((e) => (!l || !e.has(l) ? e : (e.delete(l), new f(e))));
            }
          );
        }, [l, g, m]),
        (0, s.jsx)(C, { "data-radix-collection-item": ``, ref: p, children: i })
      );
    });
  w.displayName = S;
  function T() {
    return o.useState(new f());
  }
  l(T, `useInitCollection`);
  function E(t) {
    let { itemMap: n } = d(e + `CollectionConsumer`, t);
    return n;
  }
  return (
    l(E, `useCollection`),
    [
      { Provider: p, Slot: x, ItemSlot: w },
      { createCollectionScope: c, useCollection: E, useInitCollection: T },
    ]
  );
}
l(g, `createCollection`);
function _(e, t) {
  if (e === t) return !0;
...
l(v, `isElementPreceding`);
function y(e, t) {
  return !e[1].element || !t[1].element ? 0 : v(e[1].element, t[1].element) ? -1 : 1;
}
l(y, `sortByDocumentPosition`);
function b(e) {
