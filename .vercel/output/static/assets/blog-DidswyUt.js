...
import { n as a, t as o } from "./clock-3-Dl5TSbyD.js";
import { t as s } from "./notebook-pen-sPf5Qce7.js";
import { t as c } from "./blog-posts-CxW631lu.js";
import { t as l } from "./reveal-Cj6tVgBd.js";
import { n as u } from "./public-layout-BGA3sCZD.js";
var d = n();
function f() {
  let { t: n } = r(),
    { locale: f } = e(),
    p = i(),
    m = new Intl.DateTimeFormat(f === `en` ? `en-US` : `ar`, {
      year: `numeric`,
      month: `long`,
      day: `numeric`,
    });
        ...
        children: (0, d.jsxs)(`div`, {
          ...
          children: [
            (0, d.jsx)(`span`, {
              ...
              children: (0, d.jsx)(s, { className: `size-6` }),
            }),
            (0, d.jsx)(`h1`, {
                      ...
                      (0, d.jsxs)(`div`, {
                        ...
                        children: [
                          (0, d.jsxs)(`span`, {
                            ...
                            children: [
                              (0, d.jsx)(a, { className: `size-3.5` }),
                              m.format(new Date(e.publishedAt)),
                            ],
                          }),
                          (0, d.jsxs)(`span`, {
                            className: `inline-flex items-center gap-1.5`,
                            children: [
                              (0, d.jsx)(o, { className: `size-3.5` }),
                              n(`blog.readMinutes`, { count: e.readMinutes }),
                            ],
                          }),
                        ],
                      }),
