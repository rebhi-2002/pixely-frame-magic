...
var d = class e {
  ...
  p = (e) => ({ status: `dirty`, value: e }),
  m = (e) => ({ status: `valid`, value: e }),
  ee = (e) => e.status === `aborted`,
  te = (e) => e.status === `dirty`,
  h = (e) => e.status === `valid`,
  g = (e) => typeof Promise < `u` && e instanceof Promise,
  _;
(function (e) {
...
var v = class {
  ...
  ne = (e, t) => {
    if (h(t)) return { success: !0, data: t.value };
...
var b = class {
    ...
    safeParse(e, t) {
      ...
      return ne(n, this._parseSync({ data: e, path: n.path, parent: n }));
    }
    "~validate"(e) {
      let t = {
      ...
      return this._parseAsync({ data: e, path: [], parent: t }).then((e) =>
        h(e) ? { value: e.value } : { issues: t.common.issues },
      );
    }
    ...
    async safeParseAsync(e, t) {
      ...
      return ne(n, await (g(i) ? i : Promise.resolve(i)));
    }
    refine(e, t) {
      let n = (e) =>
    ...
    default(e) {
      ...
      return new X({ ...y(this._def), innerType: this, defaultValue: t, typeName: $.ZodDefault });
    }
    brand() {
      return new Pe({ typeName: $.ZodBranded, type: this, ...y(this._def) });
    }
    catch(e) {
      let t = typeof e == `function` ? e : () => e;
      return new Z({ ...y(this._def), innerType: this, catchValue: t, typeName: $.ZodCatch });
    }
    describe(e) {
  ...
  re = /^c[^\s-]{8,}$/i,
  ie = /^[0-9a-z]+$/,
  ae = /^[0-9A-HJKMNP-TV-Z]{26}$/i,
  oe = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
  se = /^[a-z0-9_-]{21}$/i,
  ce = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/,
  le =
    /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
  ue = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
  de = `^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$`,
  fe,
  pe =
...
var x = class t extends b {
  _parse(t) {
    if ((this._def.coerce && (t.data = String(t.data)), this._getType(t) !== n.string)) {
      ...
      return (u(e, { code: i.invalid_type, expected: n.string, received: e.parsedType }), f);
    }
    let r = new d(),
      a;
    for (let n of this._def.checks)
      if (n.kind === `min`)
        ...
        ue.test(t.data) ||
          ((a = this._getOrReturnCtx(t, a)),
          u(a, { validation: `email`, code: i.invalid_string, message: n.message }),
          r.dirty());
      else if (n.kind === `emoji`)
        ((fe ||= new RegExp(de, `u`)),
          fe.test(t.data) ||
            ((a = this._getOrReturnCtx(t, a)),
            u(a, { validation: `emoji`, code: i.invalid_string, message: n.message }),
            r.dirty()));
      else if (n.kind === `uuid`)
        oe.test(t.data) ||
          ((a = this._getOrReturnCtx(t, a)),
          u(a, { validation: `uuid`, code: i.invalid_string, message: n.message }),
          r.dirty());
      else if (n.kind === `nanoid`)
        se.test(t.data) ||
          ((a = this._getOrReturnCtx(t, a)),
          u(a, { validation: `nanoid`, code: i.invalid_string, message: n.message }),
          r.dirty());
      else if (n.kind === `cuid`)
        re.test(t.data) ||
          ((a = this._getOrReturnCtx(t, a)),
          u(a, { validation: `cuid`, code: i.invalid_string, message: n.message }),
          r.dirty());
      else if (n.kind === `cuid2`)
        ie.test(t.data) ||
          ((a = this._getOrReturnCtx(t, a)),
          u(a, { validation: `cuid2`, code: i.invalid_string, message: n.message }),
          r.dirty());
      else if (n.kind === `ulid`)
        ae.test(t.data) ||
          ((a = this._getOrReturnCtx(t, a)),
          u(a, { validation: `ulid`, code: i.invalid_string, message: n.message }),
          r.dirty());
      else if (n.kind === `url`)
        try {
          new URL(t.data);
          ...
          ((a = this._getOrReturnCtx(t, a)),
            u(a, { validation: `url`, code: i.invalid_string, message: n.message }),
            r.dirty());
        }
      else
        n.kind === `regex`
          ? ((n.regex.lastIndex = 0),
            n.regex.test(t.data) ||
              ((a = this._getOrReturnCtx(t, a)),
              u(a, { validation: `regex`, code: i.invalid_string, message: n.message }),
              r.dirty()))
          : n.kind === `trim`
            ? (t.data = t.data.trim())
            : n.kind === `includes`
...
x.create = (e) => new x({ checks: [], typeName: $.ZodString, coerce: e?.coerce ?? !1, ...y(e) });
function De(e, t) {
...
var S = class t extends b {
  ...
  _parse(t) {
    if ((this._def.coerce && (t.data = Number(t.data)), this._getType(t) !== n.number)) {
      let e = this._getOrReturnCtx(t);
      return (u(e, { code: i.invalid_type, expected: n.number, received: e.parsedType }), f);
    }
    let r,
      a = new d();
    for (let n of this._def.checks)
        ...
        : n.kind === `min`
          ...
          : n.kind === `max`
            ...
            : n.kind === `multipleOf`
              ? De(t.data, n.value) !== 0 &&
                ((r = this._getOrReturnCtx(t, r)),
                u(r, { code: i.not_multiple_of, multipleOf: n.value, message: n.message }),
                a.dirty())
              : n.kind === `finite`
                ? Number.isFinite(t.data) ||
                  ((r = this._getOrReturnCtx(t, r)),
                  u(r, { code: i.not_finite, message: n.message }),
                  a.dirty())
                : e.assertNever(n);
  ...
  setLimit(e, n, r, i) {
    return new t({
      ...this._def,
      checks: [...this._def.checks, { kind: e, value: n, inclusive: r, message: _.toString(i) }],
    });
  }
  _addCheck(e) {
    return new t({ ...this._def, checks: [...this._def.checks, e] });
  ...
  safe(e) {
    ...
    })._addCheck({ kind: `max`, inclusive: !0, value: 2 ** 53 - 1, message: _.toString(e) });
  }
  get minValue() {
    let e = null;
    for (let t of this._def.checks)
...
S.create = (e) => new S({ checks: [], typeName: $.ZodNumber, coerce: e?.coerce || !1, ...y(e) });
var C = class t extends b {
  ...
  _getInvalidInput(e) {
    ...
    return (u(t, { code: i.invalid_type, expected: n.bigint, received: t.parsedType }), f);
  }
  gte(e, t) {
    return this.setLimit(`min`, e, !0, _.toString(t));
  }
  ...
  positive(e) {
    return this._addCheck({ kind: `min`, value: BigInt(0), inclusive: !1, message: _.toString(e) });
  }
  negative(e) {
    return this._addCheck({ kind: `max`, value: BigInt(0), inclusive: !1, message: _.toString(e) });
  }
  nonpositive(e) {
    return this._addCheck({ kind: `max`, value: BigInt(0), inclusive: !0, message: _.toString(e) });
  }
  nonnegative(e) {
    return this._addCheck({ kind: `min`, value: BigInt(0), inclusive: !0, message: _.toString(e) });
  }
  multipleOf(e, t) {
    return this._addCheck({ kind: `multipleOf`, value: e, message: _.toString(t) });
  }
...
C.create = (e) => new C({ checks: [], typeName: $.ZodBigInt, coerce: e?.coerce ?? !1, ...y(e) });
var w = class extends b {
  _parse(e) {
    if ((this._def.coerce && (e.data = !!e.data), this._getType(e) !== n.boolean)) {
      let t = this._getOrReturnCtx(e);
      return (u(t, { code: i.invalid_type, expected: n.boolean, received: t.parsedType }), f);
    }
    return m(e.data);
  }
};
w.create = (e) => new w({ typeName: $.ZodBoolean, coerce: e?.coerce || !1, ...y(e) });
var T = class t extends b {
  _parse(t) {
    if ((this._def.coerce && (t.data = new Date(t.data)), this._getType(t) !== n.date)) {
      let e = this._getOrReturnCtx(t);
      return (u(e, { code: i.invalid_type, expected: n.date, received: e.parsedType }), f);
    }
    if (Number.isNaN(t.data.getTime()))
      return (u(this._getOrReturnCtx(t), { code: i.invalid_date }), f);
    let r = new d(),
      a;
    for (let n of this._def.checks)
      n.kind === `min`
...
T.create = (e) => new T({ checks: [], coerce: e?.coerce || !1, typeName: $.ZodDate, ...y(e) });
var E = class extends b {
  _parse(e) {
    if (this._getType(e) !== n.symbol) {
      let t = this._getOrReturnCtx(e);
      return (u(t, { code: i.invalid_type, expected: n.symbol, received: t.parsedType }), f);
    }
    return m(e.data);
  }
};
E.create = (e) => new E({ typeName: $.ZodSymbol, ...y(e) });
var D = class extends b {
  _parse(e) {
    if (this._getType(e) !== n.undefined) {
      let t = this._getOrReturnCtx(e);
      return (u(t, { code: i.invalid_type, expected: n.undefined, received: t.parsedType }), f);
    }
    return m(e.data);
  }
};
D.create = (e) => new D({ typeName: $.ZodUndefined, ...y(e) });
var O = class extends b {
  _parse(e) {
    if (this._getType(e) !== n.null) {
      let t = this._getOrReturnCtx(e);
      return (u(t, { code: i.invalid_type, expected: n.null, received: t.parsedType }), f);
    }
    return m(e.data);
  }
};
O.create = (e) => new O({ typeName: $.ZodNull, ...y(e) });
...
Oe.create = (e) => new Oe({ typeName: $.ZodAny, ...y(e) });
...
k.create = (e) => new k({ typeName: $.ZodUnknown, ...y(e) });
var A = class extends b {
  _parse(e) {
    let t = this._getOrReturnCtx(e);
    return (u(t, { code: i.invalid_type, expected: n.never, received: t.parsedType }), f);
  }
};
A.create = (e) => new A({ typeName: $.ZodNever, ...y(e) });
var j = class extends b {
  _parse(e) {
    if (this._getType(e) !== n.undefined) {
      let t = this._getOrReturnCtx(e);
      return (u(t, { code: i.invalid_type, expected: n.void, received: t.parsedType }), f);
    }
    return m(e.data);
  }
};
j.create = (e) => new j({ typeName: $.ZodVoid, ...y(e) });
var M = class e extends b {
  _parse(e) {
    let { ctx: t, status: r } = this._processInputParams(e),
      a = this._def;
    if (t.parsedType !== n.array)
      return (u(t, { code: i.invalid_type, expected: n.array, received: t.parsedType }), f);
    ...
    if (
      ...
      return Promise.all(
        [...t.data].map((e, n) => a.type._parseAsync(new v(t, e, t.path, n))),
      ).then((e) => d.mergeArray(r, e));
    let o = [...t.data].map((e, n) => a.type._parseSync(new v(t, e, t.path, n)));
    return d.mergeArray(r, o);
  }
  get element() {
    return this._def.type;
  }
  min(t, n) {
    return new e({ ...this._def, minLength: { value: t, message: _.toString(n) } });
  }
  max(t, n) {
    return new e({ ...this._def, maxLength: { value: t, message: _.toString(n) } });
  }
  length(t, n) {
    return new e({ ...this._def, exactLength: { value: t, message: _.toString(n) } });
  }
  nonempty(e) {
    return this.min(1, e);
  }
...
var P = class t extends b {
  ...
  _parse(e) {
    if (this._getType(e) !== n.object) {
      let t = this._getOrReturnCtx(e);
      return (u(t, { code: i.invalid_type, expected: n.object, received: t.parsedType }), f);
    }
    ...
    for (let e of o) {
      ...
      c.push({
        ...
        value: t._parse(new v(r, n, r.path, e)),
    ...
    if (this._def.catchall instanceof A) {
      ...
      if (e === `passthrough`)
        ...
        s.length > 0 && (u(r, { code: i.unrecognized_keys, keys: s }), t.dirty());
      ...
      for (let t of s) {
        ...
        c.push({
          ...
          value: e._parse(new v(r, n, r.path, t)),
    ...
    return r.common.async
      ? Promise.resolve()
          ...
          .then((e) => d.mergeObjectSync(t, e))
      : d.mergeObjectSync(t, c);
  }
  get shape() {
  ...
  required(n) {
    ...
    for (let t of e.objectKeys(this.shape))
      if (n && !n[t]) r[t] = this.shape[t];
        ...
        let e = this.shape[t];
        for (; e instanceof J;) e = e._def.innerType;
        r[t] = e;
      }
    return new t({ ...this._def, shape: () => r });
  }
  keyof() {
    return Me(e.objectKeys(this.shape));
  }
};
((P.create = (e, t) =>
  new P({
...
var F = class extends b {
  _parse(e) {
    ...
    function r(e) {
      ...
      return (u(t, { code: i.invalid_union, unionErrors: n }), f);
    }
    if (t.common.async)
      return Promise.all(
        n.map(async (e) => {
      ...
      ).then(r);
    {
      ...
      return (u(t, { code: i.invalid_union, unionErrors: o }), f);
    }
  }
  get options() {
...
F.create = (e, t) => new F({ options: e, typeName: $.ZodUnion, ...y(t) });
var I = (t) =>
    t instanceof H
      ? I(t.schema)
      : t instanceof q
                ...
                : t instanceof D
                  ...
                  : t instanceof O
                    ...
                    : t instanceof J
                      ...
                      : t instanceof Y
                        ? [null, ...I(t.unwrap())]
                        : t instanceof Pe || t instanceof Q
                          ? I(t.unwrap())
                          : t instanceof Z
                            ? I(t._def.innerType)
                            : [],
...
function L(t, i) {
  ...
  return a === n.date && o === n.date && +t == +i ? { valid: !0, data: t } : { valid: !1 };
}
var R = class extends b {
  _parse(e) {
    let { status: t, ctx: n } = this._processInputParams(e),
      r = (e, r) => {
        if (ee(e) || ee(r)) return f;
        let a = L(e.value, r.value);
        return a.valid
          ? ((te(e) || te(r)) && t.dirty(), { status: t.value, value: a.data })
          : (u(n, { code: i.invalid_intersection_types }), f);
      };
...
R.create = (e, t, n) => new R({ left: e, right: t, typeName: $.ZodIntersection, ...y(n) });
var z = class e extends b {
  _parse(e) {
    let { status: t, ctx: r } = this._processInputParams(e);
    if (r.parsedType !== n.array)
      return (u(r, { code: i.invalid_type, expected: n.array, received: r.parsedType }), f);
    ...
    let a = [...r.data]
      .map((e, t) => {
        ...
        return n ? n._parse(new v(r, e, r.path, t)) : null;
      })
      .filter((e) => !!e);
    return r.common.async ? Promise.all(a).then((e) => d.mergeArray(t, e)) : d.mergeArray(t, a);
  }
  get items() {
...
z.create = (e, t) => {
  ...
  return new z({ items: e, typeName: $.ZodTuple, rest: null, ...y(t) });
};
var Ae = class e extends b {
    get keySchema() {
    ...
    _parse(e) {
      ...
      if (r.parsedType !== n.object)
        return (u(r, { code: i.invalid_type, expected: n.object, received: r.parsedType }), f);
      let a = [],
        o = this._def.keyType,
        s = this._def.valueType;
      for (let e in r.data)
        a.push({
          key: o._parse(new v(r, e, r.path, e)),
          value: s._parse(new v(r, r.data[e], r.path, e)),
          alwaysSet: e in r.data,
        });
      return r.common.async ? d.mergeObjectAsync(t, a) : d.mergeObjectSync(t, a);
    }
    get element() {
      return this._def.valueType;
    }
    static create(t, n, r) {
      return n instanceof b
        ? new e({ keyType: t, valueType: n, typeName: $.ZodRecord, ...y(r) })
        : new e({ keyType: x.create(), valueType: t, typeName: $.ZodRecord, ...y(n) });
    }
  },
  B = class extends b {
    get keySchema() {
    ...
    _parse(e) {
      ...
      if (r.parsedType !== n.map)
        return (u(r, { code: i.invalid_type, expected: n.map, received: r.parsedType }), f);
      let a = this._def.keyType,
        o = this._def.valueType,
        s = [...r.data.entries()].map(([e, t], n) => ({
          key: a._parse(new v(r, e, r.path, [n, `key`])),
          value: o._parse(new v(r, t, r.path, [n, `value`])),
        }));
      if (r.common.async) {
        let e = new Map();
...
B.create = (e, t, n) => new B({ valueType: t, keyType: e, typeName: $.ZodMap, ...y(n) });
var V = class e extends b {
  _parse(e) {
    let { status: t, ctx: r } = this._processInputParams(e);
    if (r.parsedType !== n.set)
      return (u(r, { code: i.invalid_type, expected: n.set, received: r.parsedType }), f);
    let a = this._def;
    (a.minSize !== null &&
    ...
    let c = [...r.data.values()].map((e, t) => o._parse(new v(r, e, r.path, t)));
    return r.common.async ? Promise.all(c).then((e) => s(e)) : s(c);
  }
  min(t, n) {
    return new e({ ...this._def, minSize: { value: t, message: _.toString(n) } });
  }
  max(t, n) {
    return new e({ ...this._def, maxSize: { value: t, message: _.toString(n) } });
  }
  size(e, t) {
...
V.create = (e, t) =>
  new V({ valueType: e, minSize: null, maxSize: null, typeName: $.ZodSet, ...y(t) });
var je = class e extends b {
    ...
    _parse(e) {
      ...
      if (t.parsedType !== n.function)
        return (u(t, { code: i.invalid_type, expected: n.function, received: t.parsedType }), f);
      function r(e, n) {
        return l({
          data: e,
          path: t.path,
      ...
      let d = { errorMap: t.common.contextualErrorMap },
        p = t.data;
      if (this._def.returns instanceof K) {
        let e = this;
        return m(async function (...t) {
          let n = new a([]),
            i = await e._def.args.parseAsync(t, d).catch((e) => {
              throw (n.addIssue(r(t, e)), n);
            }),
            o = await Reflect.apply(p, this, i);
      ...
      }
      {
        let e = this;
        return m(function (...t) {
          let n = e._def.args.safeParse(t, d);
          if (!n.success) throw new a([r(t, n.error)]);
          let i = Reflect.apply(p, this, n.data),
            o = e._def.returns.safeParse(i, d);
    ...
    args(...t) {
      return new e({ ...this._def, args: z.create(t).rest(k.create()) });
    }
    returns(t) {
...
H.create = (e, t) => new H({ getter: e, typeName: $.ZodLazy, ...y(t) });
var U = class extends b {
  _parse(e) {
    if (e.data !== this._def.value) {
      let t = this._getOrReturnCtx(e);
      return (u(t, { received: t.data, code: i.invalid_literal, expected: this._def.value }), f);
    }
...
U.create = (e, t) => new U({ value: e, typeName: $.ZodLiteral, ...y(t) });
function Me(e, t) {
  return new W({ values: e, typeName: $.ZodEnum, ...y(t) });
}
var W = class t extends b {
  _parse(t) {
    if (typeof t.data != `string`) {
      let n = this._getOrReturnCtx(t),
        r = this._def.values;
      return (u(n, { expected: e.joinValues(r), received: n.parsedType, code: i.invalid_type }), f);
    }
    if (((this._cache ||= new Set(this._def.values)), !this._cache.has(t.data))) {
      let e = this._getOrReturnCtx(t),
        n = this._def.values;
      return (u(e, { received: e.data, code: i.invalid_enum_value, options: n }), f);
    }
    return m(t.data);
  }
  get options() {
...
var G = class extends b {
  _parse(t) {
    ...
    if (a.parsedType !== n.string && a.parsedType !== n.number) {
      ...
      return (u(a, { expected: e.joinValues(t), received: a.parsedType, code: i.invalid_type }), f);
    }
    if (
      ((this._cache ||= new Set(e.getValidEnumValues(this._def.values))), !this._cache.has(t.data))
    ) {
      let t = e.objectValues(r);
      return (u(a, { received: a.data, code: i.invalid_enum_value, options: t }), f);
    }
    return m(t.data);
  }
  get enum() {
...
G.create = (e, t) => new G({ values: e, typeName: $.ZodNativeEnum, ...y(t) });
var K = class extends b {
  unwrap() {
    return this._def.type;
  }
  _parse(e) {
    ...
    return t.parsedType !== n.promise && t.common.async === !1
      ? (u(t, { code: i.invalid_type, expected: n.promise, received: t.parsedType }), f)
      : m(
...
K.create = (e, t) => new K({ type: e, typeName: $.ZodPromise, ...y(t) });
  ...
  _parse(t) {
    ...
    if (i.type === `transform`) {
      ...
      return this._def.schema
        ...
        .then((e) =>
          h(e)
            ? Promise.resolve(i.transform(e.value, a)).then((e) => ({ status: n.value, value: e }))
            : f,
        );
    }
    e.assertNever(i);
...
((q.create = (e, t, n) => new q({ schema: e, typeName: $.ZodEffects, effect: t, ...y(n) })),
  (q.createWithPreprocess = (e, t, n) =>
    new q({
      schema: t,
...
var J = class extends b {
  _parse(e) {
    return this._getType(e) === n.undefined ? m(void 0) : this._def.innerType._parse(e);
  }
  unwrap() {
    return this._def.innerType;
  }
};
J.create = (e, t) => new J({ innerType: e, typeName: $.ZodOptional, ...y(t) });
var Y = class extends b {
  _parse(e) {
    return this._getType(e) === n.null ? m(null) : this._def.innerType._parse(e);
  }
  unwrap() {
    return this._def.innerType;
  }
};
Y.create = (e, t) => new Y({ innerType: e, typeName: $.ZodNullable, ...y(t) });
...
var Ne = class extends b {
  _parse(e) {
    if (this._getType(e) !== n.nan) {
      let t = this._getOrReturnCtx(e);
      return (u(t, { code: i.invalid_type, expected: n.nan, received: t.parsedType }), f);
    }
    return { status: `valid`, value: e.data };
  }
};
Ne.create = (e) => new Ne({ typeName: $.ZodNaN, ...y(e) });
  ...
  Q = class extends b {
    _parse(e) {
      let t = this._def.innerType._parse(e),
        n = (e) => (h(e) && (e.value = Object.freeze(e.value)), e);
...
((Q.create = (e, t) => new Q({ innerType: e, typeName: $.ZodReadonly, ...y(t) })), P.lazycreate);
var $;
(function (e) {
...
(P.strictCreate,
  ...
  U.create);
var Re = W.create;
(G.create, K.create, q.create, J.create, Y.create, q.createWithPreprocess, Fe.create);
export { Le as n, Ie as r, Re as t };
