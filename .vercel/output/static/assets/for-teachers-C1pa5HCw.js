...
import { t as n } from "./badge-check-19fgxV1C.js";
import { t as r } from "./chart-line-C5wyEOtC.js";
import { n as i, t as a } from "./upload-1fd7l-SJ.js";
...
import { t as l } from "./faq-section-D-eiy1K0.js";
import { t as u } from "./testimonials-section-CasrGQiW.js";
var d = e(),
  f = [
    { icon: a, key: `upload` },
    { icon: r, key: `analytics` },
    { icon: i, key: `income` },
    { icon: n, key: `verified` },
  ];
function p() {
  ...
  return (0, d.jsxs)(s, {
    children: [
        ...
        children: (0, d.jsxs)(`div`, {
          ...
          children: [
            (0, d.jsx)(`h1`, {
              ...
              children: e(`forTeachers.h1`),
            }),
            (0, d.jsx)(`p`, {
              className: `mt-5 max-w-2xl text-lg text-muted-foreground`,
              children: e(`forTeachers.sub`),
            }),
            (0, d.jsx)(c, {
              to: `/signup`,
              label: e(`forTeachers.cta`),
              ...
              children: (0, d.jsxs)(`article`, {
                ...
                children: [
                  (0, d.jsx)(`span`, {
                    ...
                    children: (0, d.jsx)(t.icon, { className: `size-5` }),
                  }),
                  (0, d.jsx)(`h2`, {
                    className: `mt-4 text-base font-bold text-foreground`,
                    children: e(`forTeachers.benefits.${t.key}.t`),
                  }),
                  (0, d.jsx)(`p`, {
                    className: `mt-2 text-sm leading-relaxed text-muted-foreground`,
                    children: e(`forTeachers.benefits.${t.key}.d`),
                  }),
                ],
              }),
            },
      ...
      (0, d.jsx)(u, { className: `border-y border-border bg-card/40` }),
      (0, d.jsx)(l, { i18nKey: `forTeachers.faq` }),
    ],
  });
}
