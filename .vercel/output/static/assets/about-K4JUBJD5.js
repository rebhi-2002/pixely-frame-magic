...
import { f as r } from "./dist-LHEW5aEh.js";
import { n as i, r as a, t as o } from "./target-D67iDw40.js";
import { t as s } from "./reveal-Cj6tVgBd.js";
import { t as c } from "./use-session-CMsGjsyr.js";
import { n as l } from "./public-layout-BGA3sCZD.js";
import { t as u } from "./session-cta-DDRdl3yw.js";
var d = t(),
  f = [a, i, r, o];
function p() {
  let { t } = n(),
    { isSignedIn: r } = c(),
    i = t(`about.values`, { returnObjects: !0 }),
    a = t(`about.team`, { returnObjects: !0 });
  return (0, d.jsxs)(l, {
    children: [
      (0, d.jsx)(`section`, {
                  ...
                  children: (0, d.jsxs)(`article`, {
                    ...
                    children: [
                      (0, d.jsx)(`span`, {
                        ...
                        children: (0, d.jsx)(n, { className: `size-5` }),
                      }),
                      (0, d.jsx)(`h3`, {
              ...
              children: a.map((e, t) =>
                (0, d.jsx)(
                  s,
                  {
                    delay: t * 0.06,
                    children: (0, d.jsxs)(`div`, {
                      className: `shadow-elevation-1 h-full rounded-2xl border border-border bg-background p-6`,
                      children: [
                        (0, d.jsx)(`h3`, { className: `font-bold text-foreground`, children: e.t }),
                        (0, d.jsx)(`p`, {
      ...
      (0, d.jsxs)(`section`, {
        ...
        children: [
          ...
          (0, d.jsx)(`p`, { className: `mt-3 text-muted-foreground`, children: t(`about.ctaSub`) }),
          (0, d.jsxs)(`div`, {
