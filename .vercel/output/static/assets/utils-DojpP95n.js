...
var n = (e, t) => {
  ...
  ke = k(() => {
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: [`auto`, `square`, L, W, q, h] }],
        container: [`container`],
        "container-type": [{ "@container": [``, `normal`, `size`, q, W] }],
        "container-named": [de],
        columns: [{ columns: [R, W, q, s] }],
        ...
        z: [{ z: [z, `auto`, q, W] }],
        basis: [{ basis: [L, `full`, `auto`, s, ...C()] }],
        "flex-direction": [{ flex: [`row`, `row-reverse`, `col`, `col-reverse`] }],
        "flex-wrap": [{ flex: [`nowrap`, `wrap`, `wrap-reverse`] }],
        flex: [{ flex: [R, L, `auto`, `initial`, `none`, W] }],
        grow: [{ grow: [``, R, q, W] }],
        shrink: [{ shrink: [``, R, q, W] }],
        order: [{ order: [z, `first`, `last`, `none`, q, W] }],
        ...
        "max-w": [{ "max-w": [s, `screen`, `none`, `prose`, { screen: [o] }, ...k()] }],
        h: [{ h: [`screen`, `lh`, ...k()] }],
        "min-h": [{ "min-h": [`screen`, `lh`, `none`, ...k()] }],
        "max-h": [{ "max-h": [`screen`, `lh`, ...k()] }],
        "font-size": [{ text: [`base`, n, J, G] }],
        "font-smoothing": [`antialiased`, `subpixel-antialiased`],
        "font-style": [`italic`, `not-italic`],
        "font-weight": [{ font: [r, Se, me] }],
        "font-stretch": [
          {
            "font-stretch": [
              `ultra-condensed`,
        ...
        "text-decoration-thickness": [{ decoration: [R, `from-font`, `auto`, q, G] }],
        "text-decoration-color": [{ decoration: N() }],
        "underline-offset": [{ "underline-offset": [R, `auto`, q, W] }],
        ...
        "bg-image": [
          {
            bg: [
              `none`,
              {
                linear: [{ to: [`t`, `tr`, `r`, `br`, `b`, `bl`, `l`, `tl`] }, z, q, W],
                radial: [``, q, W],
                conic: [z, q, W],
              },
              xe,
        ...
        "outline-offset": [{ "outline-offset": [R, q, W] }],
        "outline-w": [{ outline: [``, R, J, G] }],
        "outline-color": [{ outline: N() }],
        shadow: [{ shadow: [``, `none`, u, Y, K] }],
        "shadow-color": [{ shadow: N() }],
        "inset-shadow": [{ "inset-shadow": [`none`, d, Y, K] }],
        ...
        "text-shadow": [{ "text-shadow": [`none`, ee, Y, K] }],
        "text-shadow-color": [{ "text-shadow": N() }],
        opacity: [{ opacity: [R, q, W] }],
        ...
        blur: [{ blur: le() }],
        brightness: [{ brightness: [R, q, W] }],
        contrast: [{ contrast: [R, q, W] }],
        "drop-shadow": [{ "drop-shadow": [``, `none`, f, Y, K] }],
        "drop-shadow-color": [{ "drop-shadow": N() }],
        grayscale: [{ grayscale: [``, R, q, W] }],
        "hue-rotate": [{ "hue-rotate": [R, q, W] }],
        invert: [{ invert: [``, R, q, W] }],
        saturate: [{ saturate: [R, q, W] }],
        sepia: [{ sepia: [``, R, q, W] }],
        "backdrop-filter": [{ "backdrop-filter": [``, `none`, q, W] }],
        "backdrop-blur": [{ "backdrop-blur": le() }],
        "backdrop-brightness": [{ "backdrop-brightness": [R, q, W] }],
        "backdrop-contrast": [{ "backdrop-contrast": [R, q, W] }],
        "backdrop-grayscale": [{ "backdrop-grayscale": [``, R, q, W] }],
        "backdrop-hue-rotate": [{ "backdrop-hue-rotate": [R, q, W] }],
        "backdrop-invert": [{ "backdrop-invert": [``, R, q, W] }],
        "backdrop-opacity": [{ "backdrop-opacity": [R, q, W] }],
        "backdrop-saturate": [{ "backdrop-saturate": [R, q, W] }],
        "backdrop-sepia": [{ "backdrop-sepia": [``, R, q, W] }],
        ...
        duration: [{ duration: [R, `initial`, q, W] }],
        ease: [{ ease: [`linear`, `initial`, g, q, W] }],
        delay: [{ delay: [R, q, W] }],
        animate: [{ animate: [`none`, _, q, W] }],
        backface: [{ backface: [`hidden`, `visible`] }],
        perspective: [{ perspective: [m, q, W] }],
        ...
        "will-change": [{ "will-change": [`auto`, `scroll`, `contents`, `transform`, q, W] }],
        fill: [{ fill: [`none`, ...N()] }],
        "stroke-w": [{ stroke: [R, J, G, pe] }],
