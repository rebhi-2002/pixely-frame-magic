...
import { t as r } from "./utils-DojpP95n.js";
var i = n(t());
function a(e) {
  if (e === void 0)
...
var s = { autoSleep: 120, force3D: `auto`, nullTargetWarn: 1, units: { lineHeight: `` } },
  ...
  le = function (e, t) {
    return (e && (R[e] = t) && ae && (ae[e] = t)) || R;
  },
  B = function () {
    return 0;
  },
  ue = { suppressEvents: !0, isStart: !0, kill: !1 },
  ...
  ye = function (e) {
    ...
    for (r = e.length; r--;)
      (e[r] && (e[r]._gsap || (e[r]._gsap = new sn(e[r], n)))) || e.splice(r, 1);
    return e;
  },
  be = function (e) {
    return e._gsap || ye(ht(e))[0]._gsap;
  },
  xe = function (e, t, n) {
  ...
  G = function (e, t, n, r) {
    (V.length && !u && Ee(), e.render(t, n, r || !!(u && t < 0 && De(e))), V.length && !u && Ee());
  },
  Oe = function (e) {
    var t = parseFloat(e);
    return (t || t === 0) && (e + ``).match(ne).length < 2 ? t : b(e) ? e.trim() : e;
  },
  ke = function (e) {
    return e;
  },
  ...
  Fe = function (e) {
    var t = e.parent || F,
      n = e.keyframes ? je(k(e.keyframes)) : Ae;
  ...
  qe = function (e) {
    return (e._end = Ce(e._start + (e._tDur / Math.abs(e._ts || e._rts || p) || 0)));
  },
  Je = function (e, t) {
    var n = e._dp;
    return (
  ...
  Ye = function (e, t) {
    ...
    if (
      ((t._time || (!t._dur && t._initted) || (t._start < e._time && (t._dur || !t.add))) &&
        ((n = Ke(e.rawTime(), t)),
        (!t._dur || lt(0, t.totalDuration(), n) - t._tTime > p) && t.render(n, !0)),
  ...
  Xe = function (e, t, n, r) {
    return (
      t.parent && ze(t),
      (t._start = Ce((S(n) ? n : n || e !== F ? ot(e, n, t) : e._time) + t._delay)),
      (t._end = Ce(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0))),
      Le(e, t, `_first`, `_last`, e._sort ? `_start` : 0),
      et(t) || (e._recent = t),
      r || Ye(e, t),
  ...
  Ze = function (e, t) {
    return (R.ScrollTrigger || z(`scrollTrigger`, t)) && R.ScrollTrigger.create(t, e);
  },
  Qe = function (e, t, n, r, i) {
    if ((gn(e, t, i), !e._initted)) return 1;
    if (
      !n &&
      e._pt &&
      !u &&
  ...
  tt = function (e, t, n, r) {
    ...
    if (
      ...
      for (
        ...
        (c.r(a, c.d), (c = c._next));
      (t < 0 && He(e, t, n, !0),
        e._onUpdate && !n && Mt(e, `onUpdate`),
        s && e._repeat && !n && e.parent && Mt(e, `onRepeat`),
        (t >= e._tDur || t < 0) &&
          e.ratio === a &&
          (a && ze(e, 1),
          !n && !u && (Mt(e, a ? `onComplete` : `onReverseComplete`, !0), e._prom && e._prom())));
    } else e._zTime ||= t;
  },
  nt = function (e, t, n) {
    var r;
  ...
  rt = function (e, t, n, r) {
    ...
    return (
      ...
      (e._dur = a),
      (e._tDur = i ? (i < 0 ? 1e10 : Ce(a * (i + 1) + e._rDelay * i)) : a),
  ...
  it = function (e) {
    return e instanceof ln ? Be(e) : rt(e, e._dur);
  },
  at = { _start: 0, endTime: B, totalDuration: B },
  ot = function e(t, n, r) {
    var i = t.labels,
      a = t._recent || at,
      o = t.duration() >= f ? a.endTime(!1) : t._dur,
      s,
      c,
      l;
    return b(n) && (isNaN(n) || n in i)
      ? ((c = n.charAt(0)),
        (l = n.substr(-1) === `%`),
        (s = n.indexOf(`=`)),
        c === `<` || c === `>`
          ...
          : s < 0
            ...
            : ((c = parseFloat(n.charAt(s - 1) + n.substr(s + 1))),
              l && r && (c = (c / 100) * (k(r) ? r[0] : r).totalDuration()),
  ...
  st = function (e, t, n) {
    ...
    if ((r && (a.duration = t[1]), (a.parent = n), e)) {
      for (o = a, s = n; s && !(`immediateRender` in o);)
        ((o = s.vars.defaults || {}), (s = T(s.vars.inherit) && s.parent));
      ((a.immediateRender = T(o.immediateRender)),
        e < 2 ? (a.runBackwards = 1) : (a.startAt = t[i - 1]));
    }
    return new Cn(t[0], a, t[i + 1]);
  },
  ct = function (e, t) {
    return e || e === 0 ? t(e) : t;
  },
  ...
  mt = function (e, t, n) {
    return (
      ...
      e.forEach(function (e) {
        var r;
        return (b(e) && !t) || pt(e, 1) ? (r = n).push.apply(r, ht(e)) : n.push(e);
      }) || n
    );
  },
  ht = function (e, t, n) {
    return d && !t && d.selector
      ? d.selector(e)
      : b(e) && !n && (L || !Jt())
        ? ft.call((t || ie).querySelectorAll(e), 0)
        : k(e)
          ? mt(e, n)
          : pt(e)
            ? ft.call(e, 0)
  ...
  gt = function (e) {
    return (
      (e = ht(e)[0] || ce(`Invalid scope`) || {}),
      function (t) {
        var n = e.current || e.nativeElement || e;
        return ht(
          t,
          n.querySelectorAll ? n : n === e ? ce(`Invalid scope`) || ie.createElement(`div`) : e,
        );
      }
    );
  },
      ...
      function (e, o, d) {
        ...
        if (!m) {
          ...
          for (
            ...
            ((v = (x % w) - h),
              (y = g - ((x / w) | 0)),
              (m[x] = b = c ? Math.abs(c === `y` ? y : v) : _(v * v + y * y)),
              b > S && (S = b),
              b < C && (C = b));
          (r === `random` && _t(m),
            (m.max = S - C),
            ...
            (m.v = p =
              (parseFloat(t.amount) ||
                parseFloat(t.each) *
                  (w > p ? p - 1 : c ? (c === `y` ? p / w : w) : Math.max(w, p / w)) ||
                0) * (r === `edges` ? -1 : 1)),
            (m.b = p < 0 ? i - p : i),
            (m.u = ut(t.amount || t.each) || 0),
            (n = n && p < 0 ? en(n) : n));
        }
        return ((p = (m[e] - m.min) / m.max || 0), Ce(m.b + (n ? n(p) : p) * m.v) + m.u);
      }
    );
  },
  yt = function (e) {
  ...
  bt = function (e, t) {
    ...
    return (
      !n &&
        w(e) &&
        ((r = n = e.radius || f),
        e.values ? ((e = ht(e.values)), (i = !S(e[0])) && (r *= r)) : (e = yt(e.increment))),
      ct(
        t,
        n
          ? x(e)
            ...
            : function (t) {
                for (
                  ...
                  (i
                    ...
                    : (l = Math.abs(e[c] - n)),
                    l < o && ((o = l), (s = c)));
                return ((s = !r || o <= r ? e[s] : t), i || s === t || S(t) ? s : s + ut(t));
              }
          : yt(e),
      )
    );
  ...
  xt = function (e, t, n, r) {
    return ct(k(e) ? !t : n === !0 ? !!(n = 0) : !r, function () {
      return k(e)
  ...
  Ot = function (e) {
    return e.replace(A, function (e) {
      var t = e.indexOf(`[`) + 1,
        n = e.substring(t || 7, t ? e.indexOf(`]`) : e.length - 1).split(j);
      return xt(t ? n : +n[0], t ? 0 : +n[1], +n[2] || 1e-5);
    });
  },
  ...
  At = function e(t, n, r, i) {
    ...
    if (!a) {
      ...
      if (!u) {
        for (c in n) dn.call(s, t, c, `get`, n[c]);
        a = function (e) {
          return Mn(e, s) || (o ? t.p : t);
        };
      }
    }
    return ct(r, a);
        ...
        var t = e.name,
          ...
          r =
            t && !n && e.init
              ...
              : e,
          i = { init: B, render: Mn, add: dn, kill: Pn, modifier: Nn, rawVars: 0 },
          a = { targetTest: 0, get: 0, getSetter: On, aliases: {}, register: 0 };
        if ((Jt(), e !== r)) {
          if (ge[t]) return;
          (Ae(r, Ae(Pe(e, i), a)),
            Me(r.prototype, Me(i, Pe(e, a))),
            (ge[(r.prop = t)] = r),
            e.targetTest && (ve.push(r), (pe[t] = 1)),
            (t = (t === `css` ? `CSS` : t.charAt(0).toUpperCase() + t.substr(1)) + `Plugin`));
        }
        (le(t, r), e.register && e.register(Zn, r, Ln));
      } else Ft.push(e);
    }
  },
  Lt = 255,
  ...
  Bt = function (e, t, n) {
    var r = e ? (S(e) ? [e >> 16, (e >> 8) & Lt, e & Lt] : 0) : Rt.black,
      i,
      a,
      o,
      s,
      ...
      p;
    if (!r) {
      if ((e.substr(-1) === `,` && (e = e.substr(0, e.length - 1)), Rt[e])) r = Rt[e];
      else if (e.charAt(0) === `#`) {
        if (
          (e.length < 6 &&
            ((i = e.charAt(1)),
          ...
          return (
            ...
            [r >> 16, (r >> 8) & Lt, r & Lt, parseInt(e.substr(7), 16) / 255]
          );
        ((e = parseInt(e.substr(1), 16)), (r = [e >> 16, (e >> 8) & Lt, e & Lt]));
      ...
      } else r = e.match(M) || Rt.transparent;
      r = r.map(Number);
    }
    return (
      t &&
  ...
  Ht = function (e, t, n) {
    ...
    if (
      ...
      n && ((l = Vt(e)), (s = n.c), s.join(r) !== l.c.join(r)))
    )
      for (c = e.replace(Ut, `1`).split(P), u = c.length - 1; o < u; o++)
        r +=
          c[o] +
          (~s.indexOf(o) ? i.shift() || a + `0,0,0,0)` : (l.length ? l : i.length ? i : n).shift());
    if (!c) for (c = e.split(Ut), u = c.length - 1; o < u; o++) r += c[o] + i[o];
    return r + c[u];
  },
  Ut = (function () {
  ...
  Gt = function (e) {
    var t = e.join(` `),
      n;
    if (((Ut.lastIndex = 0), Ut.test(t)))
      return ((n = Wt.test(t)), (e[1] = Ht(e[1], n)), (e[0] = Ht(e[0], n, Vt(e[1]))), !0);
  },
  Kt,
  qt = (function () {
    var e = Date.now,
    ...
    return (
      (d = {
        ...
        wake: function () {
          oe &&
            (!L &&
              ...
              (ie = I.document || {}),
              (R.gsap = Zn),
              (I.gsapVersions || (I.gsapVersions = [])).push(Zn.version),
              se(ae || I.GreenSockGlobals || (!I.gsap && I) || {}),
              Ft.forEach(It)),
        ...
        sleep: function () {
          ((u ? cancelAnimationFrame : clearTimeout)(c), (Kt = 0), (l = B));
        },
        ...
        add: function (e, t, n) {
          var r = t
            ...
            : e;
          return (d.remove(e), s[n ? `unshift` : `push`](r), Jt(), r);
        },
        remove: function (e, t) {
  ...
  Zt = function (e) {
    for (
      ...
      ((s = n[i]),
        ...
        (c = s.substr(0, o)),
        (t[r] = isNaN(c) ? c.replace(Xt, ``).trim() : +c),
        (r = s.substr(o + 1).trim()));
    return t;
  },
  Qt = function (e) {
  ...
  $t = function (e) {
    ...
    return n && t.length > 1 && n.config
      ? n.config.apply(null, ~e.indexOf(`{`) ? [Zt(t[1])] : Qt(e).split(`,`).map(Oe))
      : K._CE && Yt.test(e)
        ? K._CE(``, e)
        : n;
  },
  ...
  nn = function (e, t, n, r) {
    ...
    return (
      Se(e, function (e) {
        for (var t in ((K[e] = R[e] = i), (K[(a = e.toLowerCase())] = n), i))
          K[a + (t === `easeIn` ? `.in` : t === `easeOut` ? `.out` : `.inOut`)] = K[e + `.` + t] =
            i[t];
      }),
      i
    );
  ...
  cn = (function () {
    ...
    return (
      ...
      (t.totalDuration = function (e) {
        return arguments.length
          ? ((this._dirty = 0),
            rt(this, this._repeat < 0 ? e : (e - this._repeat * this._rDelay) / (this._repeat + 1)))
          : this._tDur;
      }),
      (t.totalTime = function (e, t) {
        ...
        if (n && n.smoothChildTiming && this._ts) {
          for (Je(this, e), !n._dp || n.parent || Ye(n, this); n && n.parent;)
            (n.parent._time !==
              n._start +
          ...
          !this.parent &&
            ...
            Xe(this._dp, this, this._start - this._delay);
        }
        return (
          (this._tTime !== e ||
            (!this._dur && !t) ||
            ...
            (this._ts || (this._pTime = e), G(this, e, t)),
          this
        );
      }),
      (t.time = function (e, t) {
        return arguments.length
          ? this.totalTime(
              Math.min(this.totalDuration(), e + We(this)) % (this._dur + this._rDelay) ||
                (e ? this._dur : 0),
              t,
            )
          : this._time;
      ...
      (t.progress = function (e, t) {
        return arguments.length
          ? this.totalTime(
              this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - e : e) + We(this),
              t,
            )
          : this.duration()
      ...
      (t.timeScale = function (e, t) {
        ...
        return (
          ...
          this.totalTime(lt(-Math.abs(this._delay), this.totalDuration(), n), t !== !1),
          qe(this),
          Ve(this)
        );
      }),
              ...
              e
                ...
                : (Jt(),
                  ...
                  this.totalTime(
                    ...
                    this.progress() === 1 && Math.abs(this._zTime) !== p && (this._tTime -= p),
                  ))),
            this)
          : this._ps;
      }),
      ...
      (t.seek = function (e, t) {
        return this.totalTime(ot(this, e), T(t));
      }),
      (t.restart = function (e, t) {
        return (
          this.play().totalTime(e ? -this._delay : 0, T(t)),
      ...
      (t.reversed = function (e) {
        return arguments.length
          ? (!!e !== this.reversed() && this.timeScale(-this._rts || (e ? -p : 0)), this)
          : this._rts < 0;
      }),
...
var ln = (function (e) {
  ...
  function t(t, n) {
    ...
    return (
      ...
      (r._sort = T(t.sortChildren)),
      F && Xe(t.parent || F, a(r), n),
      t.reversed && r.reverse(),
      t.paused && r.paused(!0),
      t.scrollTrigger && Ze(a(r), t.scrollTrigger),
      r
    );
  }
  var n = t.prototype;
  return (
    ...
    (n.set = function (e, t, n) {
      return (
        (t.duration = 0),
        (t.parent = this),
        Fe(t).repeatDelay || (t.repeat = 0),
        (t.immediateRender = !!t.immediateRender),
        new Cn(e, t, ot(this, n), 1),
        this
      );
    }),
    (n.call = function (e, t, n) {
      return Xe(this, Cn.delayedCall(0, e, t), n);
    }),
    ...
    (n.staggerFrom = function (e, t, n, r, i, a, o) {
      return (
        (n.runBackwards = 1),
        (Fe(n).immediateRender = T(n.immediateRender)),
    ...
    (n.staggerFromTo = function (e, t, n, r, i, a, o, s) {
      return (
        (r.startAt = n),
        (Fe(r).immediateRender = T(r.immediateRender)),
    ...
    (n.render = function (e, t, n) {
      var r = this._time,
        ...
        b,
        x;
      if ((this !== F && o > i && e >= 0 && (o = i), o !== this._tTime || n || s)) {
        if (
          ...
          if (((b = this._yoyo), (m = a + this._rDelay), this._repeat < -1 && e < 0))
            return this.totalTime(m * 100 + e, t, n);
          if (
            ((c = Ce(o % m)),
            o === i
              ? ((f = this._repeat), (c = a))
              : ((y = Ce(o / m)), (f = ~~y), f && f === y && ((c = a), f--), c > a && (c = a)),
            (y = Ge(this._tTime, m)),
            !r && this._tTime && y !== f && this._tTime - y * m - this._dur <= 0 && (y = f),
            b && f & 1 && ((c = a - c), (x = 1)),
            f !== y && !this._lock)
          ) {
            var S = b && y & 1,
            ...
            if (
              ...
              (r = S ? 0 : o % a ? a : o),
              (this._lock = 1),
              (this.render(r || (x ? 0 : Ce(f * m)), t, !a)._lock = 0),
              (this._tTime = o),
              !t && this.parent && Mt(this, `onRepeat`),
              this.vars.repeatRefresh && !x && ((this.invalidate()._lock = 1), (y = f)),
              (r && r !== this._time) ||
                h !== !this._ts ||
        ...
        if (
          (this._hasPause &&
            !this._forcing &&
            this._lock < 2 &&
            ((g = nt(this, Ce(r), Ce(c))), g && (o -= c - (c = g._start))),
          (this._tTime = o),
          (this._time = c),
          (this._act = !!_),
          this._initted ||
            ...
            (this._zTime = e),
            (r = 0)),
          !r && o && a && !t && !y && (Mt(this, `onStart`), this._tTime !== o))
        )
          return this;
        if (c >= r && e >= 0)
          for (l = this._first; l;) {
            ...
            if (((d = l._prev), (l._act || w <= l._end) && l._ts && g !== l)) {
              ...
              if (
                (l.render(
                  l._ts > 0
                    ? (w - l._start) * l._ts
                    : (l._dirty ? l.totalDuration() : l._tDur) + (w - l._start) * l._ts,
                  t,
                  n || (u && De(l)),
                ),
                c !== this._time || (!this._ts && !h))
        ...
        if (
          g &&
          !t &&
          (this.pause(), (g.render(c >= r ? 0 : -p)._zTime = c >= r ? 1 : -1), this._ts)
        )
          return ((this._start = v), qe(this), this.render(e, t, n));
        (this._onUpdate && !t && Mt(this, `onUpdate`, !0),
          ((o === i && this._tTime >= this.totalDuration()) || (!o && r)) &&
            (v === this._start || Math.abs(_) !== Math.abs(this._ts)) &&
            (this._lock ||
              ((e || !a) && ((o === i && this._ts > 0) || (!o && this._ts < 0)) && ze(this, 1),
              !t &&
                !(e < 0 && !r) &&
                (o || r || !i) &&
                (Mt(this, o === i && e >= 0 ? `onComplete` : `onReverseComplete`, !0),
    ...
    (n.add = function (e, t) {
      var n = this;
      if ((S(t) || (t = ot(this, t, e)), !(e instanceof cn))) {
        if (k(e))
          return (
            e.forEach(function (e) {
              return n.add(e, t);
      ...
      return arguments.length
        ? ((this._forcing = 1),
          !this._dp &&
            this._ts &&
            (this._start = Ce(
              qt.time - (this._ts > 0 ? t / this._ts : (this.totalDuration() - t) / -this._ts),
            )),
    ...
    (n.getTweensOf = function (e, t) {
      for (var n = [], r = ht(e), i = this._first, a = S(t), o; i;)
        (i instanceof Cn
          ? Te(i._targets, r) &&
            (a
              ? (!mn || (i._initted && i._ts)) &&
    ...
    (n.tweenFromTo = function (e, t, n) {
      return this.tweenTo(t, Ae({ startAt: { time: ot(this, e) } }, n));
    }),
    (n.recent = function () {
      return this._recent;
    }),
    (n.nextLabel = function (e) {
      return (e === void 0 && (e = this._time), jt(this, ot(this, e)));
    }),
    (n.previousLabel = function (e) {
      return (e === void 0 && (e = this._time), jt(this, ot(this, e), 1));
    }),
    ...
    (n.shiftChildren = function (e, t, n) {
      ...
      var r = this._first,
        i = this.labels,
        a;
      for (e = Ce(e); r;) (r._start >= n && ((r._start += e), (r._end += e)), (r = r._next));
        ...
        for (s = n.parent; r;)
          ((a = r._prev),
            ...
            o > i && n._sort && r._ts && !n._lock
              ? ((n._lock = 1), (Xe(n, r, o - r._delay, 1)._lock = 0))
              : (i = o),
            o < 0 &&
              r._ts &&
              ((t -= o),
              ((!s && !n._dp) || (s && s.smoothChildTiming)) &&
                ((n._start += Ce(o / n._ts)), (n._time -= o), (n._tTime -= o)),
              n.shiftChildren(-o, !1, -1 / 0),
              (i = 0)),
            r._end > t && r._ts && (t = r._end),
            (r = a));
        (rt(n, n === F && n._time > t ? n._time : t, 1, 1), (n._dirty = 0));
      }
      return n._tDur;
    }),
    (t.updateRoot = function (e) {
      if ((F._ts && (G(F, Ke(e, F)), (he = qt.frame)), qt.frame >= H)) {
        H += s.autoSleep || 120;
        var t = F._first;
        if ((!t || !t._ts) && s.autoSleep && qt._listeners.length < 2) {
...
Ae(ln.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
var un = function (e, t, n, r, i, a, o) {
    var s = new Ln(this._pt, e, t, 0, 1, jn, null, i),
      c = 0,
      l = 0,
      u,
      d,
  ...
  dn = function (e, t, n, r, i, a, o, c, l, u) {
    x(r) && (r = r(i || 0, e, a));
    var d = e[t],
      f =
        n === `get`
          ? x(d)
            ? l
              ? e[t.indexOf(`set`) || !x(e[`get` + t.substr(3)]) ? t : `get` + t.substr(3)](l)
              : e[t]()
            : d
          : n,
      p = x(d) ? (l ? En : Tn) : wn,
    ...
    if (
      (b(r) &&
        ...
        r.charAt(1) === `=` && ((m = we(f, r) + (ut(f) || 0)), (m || m === 0) && (r = m))),
      !u || f !== r || hn)
    )
      return !isNaN(f * r) && r !== ``
        ? ((m = new Ln(
          ...
          (this._pt = m))
        : (!d && !(t in e) && z(t, r), un.call(this, e, t, f, r, p, c || s.stringFilter, l));
  },
  fn = function (e, t, n, r, i) {
    if ((x(e) && (e = bn(e, i, t, n, r)), !w(e) || (e.style && e.nodeType) || k(e) || O(e)))
      return b(e) ? bn(e, i, t, n, r) : e;
    var a = {},
      o;
    for (o in e) a[o] = bn(e[o], i, t, n, r);
    return a;
  },
  pn = function (e, t, n, r, i, a) {
    var o, s, c, l;
    if (
      ge[e] &&
      (o = new ge[e]()).init(i, o.rawVars ? t[e] : fn(t[e], r, i, a, n), n, r, a) !== !1 &&
      ((n._pt = s = new Ln(n._pt, i, e, 0, 1, o.render, o, 0, o.priority)), n !== Pt)
    )
  ...
  gn = function e(t, n, r) {
    ...
    if (
      (E && (!_ || !a) && (a = `none`),
      (t._ease = tn(a, c.ease)),
      (t._rEase = D && (tn(D) || t._ease)),
      (t._from = !E && !!i.runBackwards),
      t._from && (t.ratio = 1),
      !E || (_ && !i.stagger))
    ) {
      if (
        ((ee = x[0] ? be(x[0]).harness : 0),
        (I = ee && i[ee.prop]),
        (O = Pe(i, pe)),
        b &&
          (b._zTime < 0 && b.progress(1),
          n < 0 && h && s && !v ? b.render(-1, !0) : b.revert(h && y ? de : ue),
          (b._lazy = 0)),
        o)
      ) {
        if (
          ...
          (t._startAt._dp = 0),
          (t._startAt._sat = t),
          n < 0 && (u || (!s && !v)) && t._startAt.revert(de),
          s && y && n <= 0 && r <= 0)
        ) {
          n && (t._zTime = n);
          return;
        ...
        if (
          ...
          I && (A[ee.prop] = I),
          ze((t._startAt = Cn.set(x, A))),
          (t._startAt._dp = 0),
          (t._startAt._sat = t),
          n < 0 && (u ? t._startAt.revert(de) : t._startAt.render(-1, !0)),
          (t._zTime = n),
          !s)
        )
          e(t._startAt, p, p);
      ...
      for (t._pt = t._ptCache = 0, d = (y && T(d)) || (d && !y), k = 0; k < x.length; k++) {
        if (
          ((M = x[k]),
          (P = M._gsap || ye(x)[k]._gsap),
          (t._ptLookup[k] = ne = {}),
          me[P.id] && V.length && Ee(),
          (re = C === x ? k : C.indexOf(M)),
          ee &&
            (te = new ee()).init(M, I || O, t, re, C) !== !1 &&
            ((t._pt = j = new Ln(t._pt, M, te.name, 0, 1, te.render, te, 0, te.priority)),
          ...
          for (A in O)
            ge[A] && (te = pn(A, O, t, re, M, C))
              ? te.priority && (N = 1)
              : (ne[A] = j = dn.call(t, M, A, `get`, O[A], re, C, 0, i.stringFilter));
        (t._op && t._op[k] && t.kill(M, t._op[k]),
          w &&
            t._pt &&
            ((mn = t), F.killTweensOf(M, ne, t.globalTime(n)), (L = !t.parent), (mn = 0)),
          t._pt && d && (me[P.id] = 1));
      }
      (N && In(t), t._onInit && t._onInit(t));
    }
    ((t._onUpdate = m), (t._initted = (!t._op || t._pt) && !L), _ && n <= 0 && E.render(f, !0, !0));
  },
  _n = function (e, t, n, r, i, a, o, s) {
      ...
      for (c = e._ptCache[t] = [], d = e._ptLookup, f = e._targets.length; f--;) {
        ...
        if (!l)
          return (
            ...
            gn(e, o),
            (hn = 0),
            s ? ce(t + ` not eligible for reset. Try splitting into individual properties`) : 1
          );
        c.push(l);
      }
    for (f = c.length; f--;)
  ...
  bn = function (e, t, n, r, i) {
    return x(e) ? e.call(t, n, r, i) : b(e) && ~e.indexOf(`random(`) ? Ot(e) : e;
  },
  xn = U + `repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert`,
  Sn = {};
Se(xn + `,id,stagger,delay,duration,paused,scrollTrigger`, function (e) {
  return (Sn[e] = 1);
});
var Cn = (function (e) {
  o(t, e);
  function t(t, n, r, i) {
    ...
    var c = o.vars,
      ...
      v = c.scrollTrigger,
      y = n.parent || F,
      b = (k(t) || O(t) ? S(t[0]) : `length` in n) ? [t] : ht(t),
      x,
      C,
      E,
      A,
    ...
    if (
      ((o._targets = b.length
        ? ye(b)
        : ce(`GSAP target ` + t + ` not found. https://gsap.com`, !s.nullTargetWarn) || []),
      (o._ptLookup = []),
      (o._overwrite = h),
      g || m || D(u) || D(d))
    ) {
      ...
      if (
        ...
        if (((A = b.length), (N = m && vt(m)), w(m)))
          for (j in m) ~xn.indexOf(j) && ((P ||= {}), (P[j] = m[j]));
        for (C = 0; C < A; C++)
          ((E = Pe(n, Sn)),
            (E.stagger = 0),
            ee && (E.easeReverse = ee),
            P && Me(E, P),
            (M = b[C]),
            (E.duration = +bn(u, a(o), C, M, b)),
            (E.delay = (+bn(d, a(o), C, M, b) || 0) - o._delay),
            !m && A === 1 && E.delay && ((o._delay = d = E.delay), (o._start += d), (E.delay = 0)),
            x.to(M, E, N ? N(C, M, b) : 0),
            (x._ease = K.none));
        x.duration() ? (u = d = 0) : (o.timeline = 0);
      } else if (g) {
        (Fe(Ae(x.vars.defaults, { ease: `none` })), (x._ease = tn(g.ease || n.ease || `none`)));
        var te = 0,
          ne,
          re,
          I;
        if (k(g))
          ...
          for (j in ((E = {}), g)) j === `ease` || j === `easeEach` || yn(j, g[j], E, g.easeEach);
          for (j in E)
            for (
              ne = E[j].sort(function (e, t) {
                return e.t - t.t;
              }),
                te = 0,
                C = 0;
              ...
              ((re = ne[C]),
                (I = { ease: re.e, duration: ((re.t - (C ? ne[C - 1].t : 0)) / 100) * u }),
                (I[j] = re.v),
                x.to(b, I, te),
                (te += I.duration));
    ...
    return (
      h === !0 && !l && ((mn = a(o)), F.killTweensOf(b), (mn = 0)),
      Xe(y, a(o), r),
      n.reversed && o.reverse(),
      n.paused && o.paused(!0),
      (f || (!u && !g && o._start === Ce(y._time) && T(f) && Ue(a(o)) && y.data !== `nested`)) &&
        ((o._tTime = -p), o.render(Math.max(0, -d) || 0)),
      v && Ze(a(o), v),
      o
    );
  }
  ...
  return (
      ...
      if (!a) tt(this, e, t, n);
        ...
        if (((c = s), (g = this.timeline), this._repeat)) {
          ...
          if (
            ...
            s === i
              ? ((u = this._repeat), (c = a))
              : ((f = Ce(s / d)), (u = ~~f), u && u === f ? ((c = a), u--) : c > a && (c = a)),
            (m = this._yoyo && u & 1),
            m && (c = a - c),
            (f = Ge(this._tTime, d)),
          ...
          u !== f &&
            ...
            c !== d &&
            this._initted &&
            ((this._lock = n = 1), (this.render(Ce(d * u), !0).invalidate()._lock = 0));
        }
        if (!this._initted) {
        ...
        ((g && g.render(e < 0 ? e : g._dur * g._ease(c / this._dur), t, n)) ||
          ...
          (s === this._tDur || !s) &&
            this._tTime === s &&
            (o && !this._onUpdate && He(this, e, !0, !0),
            (e || !a) &&
            ...
            !t &&
              !(o && !r) &&
              (s || r || m) &&
              (Mt(this, s === i ? `onComplete` : `onReverseComplete`, !0),
    ...
    (n.resetTo = function (e, t, n, r, i) {
      (Kt || qt.wake(), this._ts || this.play());
      var a = Math.min(this._dur, (this._dp._time - this._start) * this._ts),
        o;
      return (
        this._initted || gn(this, a),
        (o = this._ease(a / this._dur)),
        _n(this, e, t, n, r, o, a, i)
          ? this.resetTo(e, t, n, r, 1)
          : (Je(this, 0),
            this.parent || Le(this._dp, this, `_first`, `_last`, this._dp._sort ? `_start` : 0),
            this.render(0))
      );
    }),
    (n.kill = function (e, t) {
      if ((t === void 0 && (t = `all`), !e && (!t || t === `all`)))
        return (
          ...
          this.parent ? Nt(this) : this.scrollTrigger && this.scrollTrigger.kill(!!u),
          this
        );
      if (this.timeline) {
        var n = this.timeline.totalDuration();
        return (
          this.timeline.killTweensOf(e, t, mn && mn.vars.overwrite !== !0)._first || Nt(this),
          this.parent &&
      ...
      var r = this._targets,
        ...
        p,
        m;
      if ((!t || t === `all`) && Ie(r, i)) return (t === `all` && (this._pt = 0), Nt(this));
      for (
        s = this._op = this._op || [],
          t !== `all` &&
            (b(t) &&
        ...
        if (~i.indexOf(r[m]))
          for (f in ((c = a[m]),
          t === `all` ? ((s[m] = t), (d = c), (l = {})) : ((l = s[m] = s[m] || {}), (d = t)),
          d))
            ((p = c && c[f]),
              p && ((!(`kill` in p.d) || p.d.kill(f) === !0) && Re(this, p, `_pt`), delete c[f]),
              l !== `all` && (l[f] = 1));
      return (this._initted && !this._pt && o && Nt(this), this);
    }),
    (t.to = function (e, n) {
...
(Ae(Cn.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 }),
...
var wn = function (e, t, n) {
  ...
  On = function (e, t) {
    return x(e[t]) ? Tn : C(e[t]) && e.setAttribute ? Dn : wn;
  },
  kn = function (e, t) {
  ...
  Pn = function (e) {
    for (var t = this._pt, n, r; t;)
      ((r = t._next),
        (t.p === e && !t.op) || t.op === e ? Re(this, t, `_pt`) : t.dep || (n = 1),
        (t = r));
    return !n;
  },
  Fn = function (e, t, n, r) {
...
(Se(
  ...
  (R.TweenMax = R.TweenLite = Cn),
  (R.TimelineLite = R.TimelineMax = ln),
  (F = new ln({
    sortChildren: !1,
    defaults: c,
...
var Rn = [],
    ...
    e - Vn > 2 &&
      ...
      Rn.forEach(function (e) {
        var n = e.queries,
          ...
          s;
        for (a in n)
          ((i = I.matchMedia(n[a]).matches), i && (o = 1), i !== r[a] && ((r[a] = i), (s = 1)));
    ...
    return (
        ...
        return (
          this.data.forEach(function (n) {
            return n instanceof e
              ...
              : n instanceof Cn && !(n.parent && n.parent.data === `nested`) && t.push(n);
          }),
          t
        );
      }),
      ...
      (t.kill = function (e, t) {
        ...
        if (
                ...
                for (
                  ...
                  ((i = n.data[r]),
                    i instanceof ln
                      ...
                      : !(i instanceof Cn) && i.revert && i.revert(e));
          ...
          for (var r = Rn.length; r--;) Rn[r].id === this.id && Rn.splice(r, 1);
      }),
      (t.revert = function (e) {
        this.kill(e || {});
      }),
  ...
  Kn = (function () {
    ...
    return (
      (t.add = function (e, t, n) {
        w(e) || (e = { matches: e });
        var r = new Gn(0, n || this.scope),
          i = (r.conditions = {}),
          a,
          o,
          s;
        for (o in (d && !r.selector && (r.selector = d.selector),
        ...
        e))
          o === `all`
            ...
            : ((a = I.matchMedia(e[o])),
              a &&
                (Rn.indexOf(r) < 0 && Rn.push(r),
                (i[o] = a.matches) && (s = 1),
                a.addListener ? a.addListener(Wn) : a.addEventListener(`change`, Wn)));
        return (
          s &&
            t(r, function (e) {
              return r.add(null, e);
  ...
  qn = {
    ...
    quickTo: function (e, t, n) {
      var r,
        i = Zn.to(
          e,
          Ae(((r = {}), (r[t] = `+=0.1`), (r.paused = !0), (r.stagger = 0), r), n || {}),
        ),
        a = function (e, n, r) {
    ...
    defaults: function (e) {
      return (e && e.ease && (e.ease = tn(e.ease, c.ease)), Ne(c, e || {}));
    },
    config: function (e) {
      return Ne(s, e || {});
    },
    registerEffect: function (e) {
      ...
      ((r || ``).split(`,`).forEach(function (e) {
        return e && !ge[e] && !R[e] && ce(t + ` effect requires ` + e + ` plugin.`);
      }),
        (_e[t] = function (e, t, r) {
          return n(ht(e), Ae(t || {}, i), r);
        }),
        a &&
          (ln.prototype[t] = function (e, n, r) {
            return this.add(_e[t](e, w(n) ? n : (r = n) && {}, this), r);
          }));
    },
    ...
    parseEase: function (e, t) {
      return arguments.length ? tn(e, t) : K;
    },
    getById: function (e) {
      return F.getById(e);
    },
    exportRoot: function (e, t) {
      ...
      for (
        ...
        ((i = r._next),
          (t || !(!r._dur && r instanceof Cn && r.vars.onComplete === r._targets[0])) &&
            Xe(n, r, r._start - r._delay),
          (r = i));
      return (Xe(F, n, 0), n);
    },
    context: function (e, t) {
      return e ? new Gn(e, t) : d;
    },
  ...
  Yn = function (e, t) {
    ...
    for (r in t)
      for (i = n.length; i--;)
        ((a = e._ptLookup[i][r]),
          (a &&= a.d) &&
            (a._pt && (a = Jn(a, r)), a && a.modifier && a.modifier(t[r], e, n[i], r)));
  },
  Xn = function (e, t) {
    return {
      name: e,
...
((Cn.version = ln.version = Zn.version = `3.15.0`),
  (oe = 1),
  E() && Jt(),
  K.Power0,
  K.Power1,
...
var Qn,
      ...
      if (((this.tfm = this.tfm || {}), t !== `transform`))
        ((t = mr[t] || t),
          ~t.indexOf(`,`)
            ...
            : (this.tfm[t] = o.x ? o[t] : Yr(i, t)),
          t === kr && (this.tfm.zOrigin = o.zOrigin));
      else
        return mr.transform.split(`,`).forEach(function (t) {
          return e.call(r, t, n);
        });
      if (this.props.indexOf(Or) >= 0) return;
      (o.svg && ((this.svgo = i.getAttribute(`data-svg-origin`)), this.props.push(kr, n, ``)),
        (t = Or));
    }
    ...
    for (i = 0; i < e.length; i += 3)
      e[i + 1]
        ...
        : e[i + 2]
          ? (n[e[i]] = e[i + 2])
          : n.removeProperty(
              e[i].substr(0, 2) === `--` ? e[i] : e[i].replace(dr, `-$1`).toLowerCase(),
            );
    if (this.tfm) {
      ...
      (r.svg && (r.renderTransform(), t.setAttribute(`data-svg-origin`, this.svgo || ``)),
        ...
        (!i || !i.isStart) &&
          ...
          r.zOrigin &&
            n[kr] &&
            ((n[kr] += ` ` + r.zOrigin + `px`), (r.zOrigin = 0), r.renderTransform()),
          (r.uncache = 1)));
    }
  },
  Nr = function (e, t) {
    var n = { target: e, props: [], revert: Mr, save: Ar };
    return (
      e._gsap || Zn.core.getCache(e),
      t &&
        e.style &&
        e.nodeType &&
        t.split(`,`).forEach(function (e) {
  ...
  Fr = function (e, t) {
    var n = $n.createElementNS
      ? $n.createElementNS((t || `http://www.w3.org/1999/xhtml`).replace(/^https/, `http`), e)
      : $n.createElement(e);
    return n && n.style ? n : $n.createElement(e);
  },
  Ir = function e(t, n, r) {
    var i = getComputedStyle(t);
    return (
      i[n] ||
      i.getPropertyValue(n.replace(dr, `-$1`).toLowerCase()) ||
  ...
  Rr = function (e, t, n) {
    ...
    return i < 0 ? null : (i === 3 ? `ms` : i >= 0 ? Lr[i] : ``) + e;
  },
  zr = function () {
    ar() &&
      window.document &&
      ...
      (Pr = !!Rr(`perspective`)),
      (ir = Zn.core.reverting),
      (tr = 1));
  },
  Br = function (e) {
    var t = e.ownerSVGElement,
      n = Fr(`svg`, (t && t.getAttribute(`xmlns`)) || `http://www.w3.org/2000/svg`),
      r = e.cloneNode(!0),
      i;
    ...
    return (n.removeChild(r), er.removeChild(n), i);
  },
  Vr = function (e, t) {
      ...
      (t in or && t !== kr && (t = Or),
        n.removeProperty
          ? ((r = t.substr(0, 2)),
            ...
            n.removeProperty(r === `--` ? t : t.replace(dr, `-$1`).toLowerCase()))
          : n.removeAttribute(t));
    }
  },
  Gr = function (e, t, n, r, i, a) {
    var o = new Ln(e._pt, t, n, 0, 1, a ? xr : br);
  ...
  Jr = function e(t, n, r, i) {
    var a = parseFloat(r) || 0,
      ...
      g,
      _;
    if (i === o || !a || Kr[i] || Kr[o]) return a;
    if (
      (o !== `px` && !f && (a = e(t, n, r, `px`)),
      (_ = t.getCTM && Ur(t)),
      (p || o === `%`) && (or[n] || ~n.indexOf(`adius`)))
    )
      return (
    ...
    if (
      ...
      (!h || h === $n || !h.appendChild) && (h = $n.body),
      (g = h._gsap),
      g && p && g.width && c && g.time === qt.time && !g.uncache)
    )
      return W((a / g.width) * d);
    if (p && (n === `height` || n === `width`)) {
      var v = t.style[n];
      ((t.style[n] = d + i), (m = t[u]), v ? (t.style[n] = v) : Wr(t, n));
    } else
      ((p || o === `%`) && !qr[Ir(h, `display`)] && (s.position = Ir(t, `position`)),
        ...
        (s.position = `absolute`));
    return (
      c && p && ((g = be(h)), (g.time = qt.time), (g.width = h[u])),
  ...
  Yr = function (e, t, n, r) {
    ...
    return (
      tr || zr(),
      t in mr && t !== `transform` && ((t = mr[t]), ~t.indexOf(`,`) && (t = t.split(`,`)[0])),
      or[t] && t !== `transform`
        ? ((i = si(e, r)),
          (i =
            t === `transformOrigin`
              ? i.svg
                ? i.origin
                : ci(Ir(e, kr)) + ` ` + i.zOrigin + `px`
              : i[t]))
        : ((i = e.style[t]),
          (!i || i === `auto` || r || ~(i + ``).indexOf(`calc(`)) &&
            (i = (ei[t] && ei[t](e, t, n)) || Ir(e, t) || xe(e, t) || +(t === `opacity`))),
      n && !~(i + ``).trim().indexOf(` `) ? Jr(e, t, i, n) + n : i
    );
  },
  Xr = function (e, t, n, r) {
    if (!n || n === `none`) {
      var i = Rr(t, e, 1),
        a = i && Ir(e, i, 1);
      a && a !== n ? ((t = i), (n = a)) : t === `borderColor` && (n = Ir(e, `borderTopColor`));
    }
    var o = new Ln(this._pt, e.style, t, 0, 1, jn),
      c = 0,
      l = 0,
      u,
      d,
    ...
    if (
      ...
      (n += ``),
      (r += ``),
      r.substring(0, 6) === `var(--` && (r = Ir(e, r.substring(4, r.indexOf(`)`)))),
      r === `auto` &&
        ((h = e.style[t]), (e.style[t] = r), (r = Ir(e, t) || r), h ? (e.style[t] = h) : Wr(e, t)),
      (u = [n, r]),
      Gt(u),
      (n = u[0]),
      (r = u[1]),
      ...
      for (; (d = P.exec(r));)
        ((g = d[0]),
          ...
          g !== (h = f[l++] || ``) &&
            ((p = parseFloat(h) || 0),
            (b = h.substr((p + ``).length)),
            g.charAt(1) === `=` && (g = we(p, g) + b),
            (_ = parseFloat(g)),
            (y = g.substr((_ + ``).length)),
            (c = P.lastIndex - y.length),
            y || ((y = y || s.units[t] || b), c === r.length && ((r += y), (o.e += y))),
            b !== y && (p = Jr(e, t, h, y) || 0),
            (o._pt = {
              _next: o._pt,
              p: v || l === 1 ? v : `,`,
    ...
    } else o.r = t === `display` && r === `none` ? xr : br;
    return (te.test(r) && (o.e = 0), (this._pt = o), o);
  },
  Zr = { top: `0%`, bottom: `100%`, left: `0%`, right: `100%`, center: `50%` },
  Qr = function (e) {
    var t = e.split(` `),
      n = t[0],
      r = t[1] || `50%`;
    ...
    if (t.tween && t.tween._time === t.tween._dur) {
      ...
      if (i === `all` || i === !0) ((r.cssText = ``), (s = 1));
        ...
        for (i = i.split(`,`), c = i.length; --c > -1;)
          ((o = i[c]), or[o] && ((s = 1), (o = o === `transformOrigin` ? kr : Or)), Wr(n, o));
      s &&
        (Wr(n, Or),
        a &&
  ...
  ei = {
    clearProps: function (e, t, n, r, i) {
      if (i.data !== `isFromStart`) {
        var a = (e._pt = new Ln(e._pt, t, n, 0, 0, $r));
  ...
  ii = function (e) {
    var t = Ir(e, Or);
    return ri(t) ? ti : t.substr(7).match(N).map(W);
  },
  ai = function (e, t) {
    var n = e._gsap || be(e),
      r = e.style,
    ...
    return n.svg && e.getAttribute(`transform`)
      ...
      : (i === ti &&
          ...
          (i = ii(e)),
          s ? (r.display = s) : Wr(e, `display`),
          c && (o ? a.insertBefore(e, o) : a ? a.appendChild(e) : er.removeChild(e))),
  ...
  oi = function (e, t, n, r, i, a) {
    ...
    (n
      ...
      a &&
        (Gr(a, o, `xOrigin`, c, y),
        Gr(a, o, `yOrigin`, l, b),
        Gr(a, o, `xOffset`, u, o.xOffset),
        Gr(a, o, `yOffset`, d, o.yOffset)),
  ...
  si = function (e, t) {
    ...
    return (
      ...
      n.svg &&
        (n.uncache
          ? ((P = e.getBBox()), (l = n.xOrigin - P.x + `px ` + (n.yOrigin - P.y) + `px`), (N = ``))
          : (N = !t && e.getAttribute(`data-svg-origin`)),
        oi(e, N || l, !!N || n.originIsAbsolute, n.smooth !== !1, C)),
      (x = n.xOrigin || 0),
      (S = n.yOrigin || 0),
      C !== ti &&
        ((D = C[0]),
        ...
        C.length === 6
          ...
          : ((L = C[6]),
            ...
            w &&
              ...
              (D = N),
              (j = P)),
            g && Math.abs(g) + Math.abs(h) > 359.9 && ((g = h = 0), (_ = 180 - _)),
            (p = W(Math.sqrt(D * D + O * O + k * k))),
            (m = W(Math.sqrt(M * M + L * L))),
            (w = lr(j, M)),
            (v = Math.abs(w) > 2e-4 ? w * sr : 0),
            (b = I ? 1 / (I < 0 ? -I : I) : 0)),
        n.svg &&
          ((N = e.getAttribute(`transform`)),
          (n.forceCSS = e.setAttribute(`transform`, ``) || !ri(Ir(e, Or))),
      ...
      (n.x =
        u -
        ((n.xPercent =
          u && ((!t && n.xPercent) || (Math.round(e.offsetWidth / 2) === Math.round(-u) ? -50 : 0)))
      ...
      (n.y =
        ...
        ((n.yPercent =
          d &&
          ((!t && n.yPercent) || (Math.round(e.offsetHeight / 2) === Math.round(-d) ? -50 : 0)))
      ...
      (n.zOrigin = parseFloat(l.split(` `)[2]) || (!t && n.zOrigin) || 0) && (r[kr] = ci(l)),
      (n.xOffset = n.yOffset = 0),
      (n.force3D = s.force3D),
      (n.renderTransform = n.svg ? hi : Pr ? mi : ui),
      (n.uncache = 0),
      n
    );
  },
  ...
  li = function (e, t, n) {
    var r = ut(t);
    return W(parseFloat(t) + parseFloat(Jr(e, `x`, n + `px`, r))) + r;
  },
  ui = function (e, t) {
  ...
  mi = function (e, t) {
    ...
    (h !== fi && (y += `perspective(` + h + pi),
      ...
      l !== di && (y += `rotateY(` + l + pi),
      u !== di && (y += `rotateX(` + u + pi),
      (d !== di || f !== di) && (y += `skew(` + d + `, ` + f + pi),
      (p !== 1 || m !== 1) && (y += `scale(` + p + `, ` + m + pi),
  ...
  hi = function (e, t) {
    ...
    ((s = parseFloat(s)),
      ...
      ((v && !~(a + ``).indexOf(`px`)) || (y && !~(o + ``).indexOf(`px`))) &&
        ((v = Jr(f, `x`, a, `px`)), (y = Jr(f, `y`, o, `px`))),
      (p || m || h || g) &&
        ((v = W(v + p - (p * b + m * S) + h)), (y = W(y + m - (p * x + m * C) + g))),
      (r || i) &&
        ((w = f.getBBox()), (v = W(v + (r / 100) * w.width)), (y = W(y + (i / 100) * w.height))),
  ...
  gi = function (e, t, n, r, i) {
    var a = 360,
      o = b(i),
      s = parseFloat(i) * (o && ~i.indexOf(`rad`) ? sr : 1) - r,
      c = r + s + `deg`,
      l,
      u;
    return (
      o &&
        ...
        l === `cw` && s < 0
          ? (s = ((s + a * ur) % a) - ~~(s / a) * a)
          : l === `ccw` && s > 0 && (s = ((s - a * ur) % a) - ~~(s / a) * a)),
      (e._pt = u = new Ln(e._pt, t, n, r, s, gr)),
      (u.e = c),
      (u.u = `deg`),
      e._props.push(n),
      u
  ...
  vi = function (e, t, n) {
    ...
    for (s in (r.svg
      ...
      : ((c = getComputedStyle(n)[Or]), (a[Or] = t), (o = si(n, 1)), (a[Or] = c)),
    or))
      ((c = r[s]),
        (l = o[s]),
        c !== l &&
          ...
          ((f = ut(c)),
          (p = ut(l)),
          (u = f === p ? parseFloat(c) : Jr(n, s, c, p)),
          (d = parseFloat(l)),
          (e._pt = new Ln(e._pt, o, s, u, d - u, hr)),
          (e._pt.u = p || 0),
          e._props.push(s)));
    _i(o, r);
  };
...
var yi = {
  ...
  init: function (e, t, n, r, i) {
    ...
    (this.tween = n),
    t))
      if (h !== `autoRound` && ((u = t[h]), !(ge[h] && pn(h, t, n, r, e, i)))) {
        if (
          ((p = typeof u),
          (m = ei[h]),
          p === `function` && ((u = u.call(n, r, e, i)), (p = typeof u)),
          p === `string` && ~u.indexOf(`random(`) && (u = Ot(u)),
          m)
        )
          m(this, e, h, u, n) && (w = 1);
          ...
          ((l = (getComputedStyle(e).getPropertyValue(h) + ``).trim()),
            ...
            (Ut.lastIndex = 0),
            Ut.test(l) ||
              ((g = ut(l)), (_ = ut(u)), _ ? g !== _ && (l = Jr(e, h, l, _) + _) : g && (u += g)),
            this.add(o, `setProperty`, l, u, r, i, 0, 0, h),
            a.push(h),
            T.push(h, 0, o[h]));
        else if (p !== `undefined`) {
          if (
            (c && h in c
              ? ((l = typeof c[h] == `function` ? c[h].call(n, r, e, i) : c[h]),
                b(l) && ~l.indexOf(`random(`) && (l = Ot(l)),
                ut(l + ``) || l === `auto` || (l += s.units[h] || ut(Yr(e, h)) || ``),
                (l + ``).charAt(1) === `=` && (l = Yr(e, h)))
              : (l = Yr(e, h)),
            (f = parseFloat(l)),
            ...
            h in mr &&
              (h === `autoAlpha` &&
                (f === 1 && Yr(e, `visibility`) === `hidden` && d && (f = 0),
                T.push(`visibility`, 0, o.visibility),
                Gr(this, o, `visibility`, f ? `inherit` : `hidden`, d ? `inherit` : `hidden`, !d)),
              h !== `scale` &&
                h !== `transform` &&
                ((h = mr[h]), ~h.indexOf(`,`) && (h = h.split(`,`)[0]))),
            (y = h in or),
            y)
          ) {
            if ((this.styles.save(h), (E = u), p === `string` && u.substring(0, 6) === `var(--`)) {
              if (((u = Ir(e, u.substring(4, u.indexOf(`)`)))), u.substring(0, 5) === `calc(`)) {
                var D = e.style.perspective;
                ((e.style.perspective = u),
                  (u = Ir(e, `perspective`)),
                  D ? (e.style.perspective = D) : Wr(e, `perspective`));
              }
              d = parseFloat(u);
            }
            if (
              (x ||
                ((S = e._gsap),
                (S.renderTransform && !t.parseTransform) || si(e, t.parseTransform),
                (C = t.smoothOrigin !== !1 && S.smooth),
                (x = this._pt = new Ln(this._pt, o, Or, 0, 1, S.renderTransform, S, 0, -1)),
                (x.dep = 1)),
              h === `scale`)
            )
              ((this._pt = new Ln(
                ...
                `scaleY`,
                S.scaleY,
                (v ? we(S.scaleY, v + d) : d) - S.scaleY || 0,
                hr,
              )),
                (this._pt.u = 0),
                a.push(`scaleY`, h),
              ...
              (T.push(kr, 0, o[kr]),
                ...
                S.svg
                  ...
                  : ((_ = parseFloat(u.split(` `)[2]) || 0),
                    _ !== S.zOrigin && Gr(this, S, `zOrigin`, S.zOrigin, _),
                    Gr(this, o, h, ci(l), ci(u))));
              continue;
            } else if (h === `svgOrigin`) {
              oi(e, u, 1, C, 0, this);
              continue;
            } else if (h in ni) {
              gi(this, S, h, f, v ? we(f, v + u) : u);
              continue;
            } else if (h === `smoothOrigin`) {
              Gr(this, S, `smooth`, S.smooth, u);
              continue;
            } else if (h === `force3D`) {
              S[h] = u;
              continue;
          ...
          } else h in o || (h = Rr(h) || h);
          if (y || ((d || d === 0) && (f || f === 0) && !pr.test(u) && h in o))
            ((g = (l + ``).substr((f + ``).length)),
              (d ||= 0),
              (_ = ut(u) || (h in s.units ? s.units[h] : g)),
              g !== _ && (f = Jr(e, h, l, _)),
              (this._pt = new Ln(
                this._pt,
                y ? S : o,
                ...
                f,
                (v ? we(f, v + d) : d) - f,
                !y && (_ === `px` || h === `zIndex`) && t.autoRound !== !1 ? yr : hr,
              )),
              (this._pt.u = _ || 0),
              y && E !== u
                ? ((this._pt.b = l), (this._pt.e = E), (this._pt.r = vr))
                : g !== _ && _ !== `%` && ((this._pt.b = l), (this._pt.r = _r)));
          else if (h in o) Xr.call(this, e, h, l, v ? v + u : u);
  ...
  render: function (e, t) {
    if (t.tween._time || !ir()) for (var n = t._pt; n;) (n.r(e, n.d), (n = n._next));
  ...
  core: { _removeProperty: Wr, _getMatrix: ai },
};
((Zn.utils.checkPrefix = Rr),
  (Zn.core.getStyleSaver = Nr),
  (function (e, t, n, r) {
    var i = Se(e + `,` + t + `,` + n, function (e) {
      or[e] = 1;
    });
    (Se(t, function (e) {
      ((s.units[e] = `deg`), (ni[e] = 1));
    }),
      (mr[i[13]] = e + `,` + t),
      Se(r, function (e) {
        var t = e.split(`:`);
  ...
  Zn.registerPlugin(yi));
var bi = Zn.registerPlugin(yi) || Zn;
bi.core.Tween;
function xi(e, t) {
...
var Ci,
  ...
  Fi,
  Ii = function () {
    return Ci || (typeof window < `u` && (Ci = window.gsap) && Ci.registerPlugin && Ci);
  },
  Li = 1,
  Ri = [],
  q = [],
  ...
  Ui = function (e, t) {
    return ~zi.indexOf(e) && zi[zi.indexOf(e) + 1][t];
  },
  Wi = function (e) {
    return !!~Mi.indexOf(e);
  },
  ...
  Ji = `scrollTop`,
  Yi = function () {
    return (Ni && Ni.isPressed) || q.cache++;
  },
  Xi = function (e, t) {
    var n = function n(r) {
      if (r || r === 0) {
        Li && (Ti.history.scrollRestoration = `manual`);
        var i = Ni && Ni.isPressed;
        ((r = n.v = Math.round(r) || (Ni && Ni.iOS ? 1 : 0)),
          e(r),
          (n.cacheID = q.cache),
          i && Vi(`ss`, r));
      } else (t || q.cache !== n.cacheID || Vi(`ref`)) && ((n.cacheID = q.cache), (n.v = e()));
      return n.v + n.offset;
    };
  ...
  Zi = {
    ...
    sc: Xi(function (e) {
      return arguments.length
        ? Ti.scrollTo(e, Qi.sc())
        : Ti.pageXOffset || Ei[qi] || Di[qi] || Oi[qi] || 0;
    }),
  },
  Qi = {
    s: Ji,
    ...
    sc: Xi(function (e) {
      return arguments.length
        ? Ti.scrollTo(Zi.sc(), e)
        : Ti.pageYOffset || Ei[Ji] || Di[Ji] || Oi[Ji] || 0;
    }),
  },
  $i = function (e, t) {
    return (
      ((t && t._ctx && t._ctx.selector) || Ci.utils.toArray)(e)[0] ||
      (typeof e == `string` && Ci.config().nullTargetWarn !== !1
  ...
  ta = function (e, t) {
    var n = t.s,
      r = t.sc;
    Wi(e) && (e = Ei.scrollingElement || Di);
    var i = q.indexOf(e),
      a = r === Qi.sc ? 1 : 2;
    (!~i && (i = q.push(e) - 1), q[i + a] || Gi(e, `scroll`, Yi));
    var o = q[i + a],
      s =
        o ||
        (q[i + a] =
    ...
    return ((s.target = e), o || (s.smooth = Ci.getProperty(e, `scrollBehavior`) === `smooth`), s);
  },
  na = function (e, t, n) {
    var r = e,
      i = e,
  ...
  aa = function () {
    ((ji = Ci.core.globals().ScrollTrigger), ji && ji.core && Hi());
  },
  oa = function (e) {
    return (
      (Ci = e || Ii()),
      !wi &&
        ...
        (Mi = [Ti, Ei, Di, Oi]),
        Ci.utils.clamp,
        (Fi = Ci.core.context || function () {}),
        (Ai = `onpointerenter` in Oi ? `pointer` : `mouse`),
        (ki = sa.isTouch =
          Ti.matchMedia && Ti.matchMedia(`(hover: none), (pointer: coarse)`).matches
            ? 1
            : `ontouchstart` in Ti || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0
              ? 2
              : 0),
        (Pi = sa.eventTypes =
          (
...
var sa = (function () {
  ...
  return (
    (t.init = function (e) {
      (wi || oa(Ci) || console.warn(`Please gsap.registerPlugin(Observer)`), ji || aa());
      var t = e.tolerance,
        n = e.dragMinimum,
        r = e.type,
        i = e.target,
        ...
        L = e.lockAxis,
        ie = e.onLockAxis;
      ((this.target = i = $i(i) || Di),
        (this.vars = e),
        (u &&= Ci.utils.toArray(u)),
        (t ||= 1e-9),
        (n ||= 0),
        (d ||= 1),
        (re ||= 1),
        ...
        (o = o !== !1),
        (a ||= parseFloat(Ti.getComputedStyle(Oi).lineHeight) || 22));
      var R,
        ae,
        oe,
        se,
        ...
        me = pe(),
        he = V(),
        ge = ~r.indexOf(`touch`) && !~r.indexOf(`pointer`) && Pi[0] === `pointerdown`,
        _e = Wi(i),
        H = i.ownerDocument || Ei,
        ve = [0, 0, 0],
        U = [0, 0, 0],
        ye = 0,
        be = function () {
        ...
        xe = function (e, t) {
          return (
            ((B.event = e) && u && ea(e.target, u)) ||
            (t && ge && e.pointerType !== `touch`) ||
            (A && A(e, t))
          );
        },
        Se = function () {
          (B._vx.reset(), B._vy.reset(), ae.pause(), c && c(B));
        },
        W = function () {
          var e = (B.deltaX = ia(ve)),
            n = (B.deltaY = ia(U)),
            r = Math.abs(e) >= t,
            i = Math.abs(n) >= t;
          (w && (r || i) && w(B, e, n, ve, U),
            ...
            i &&
              ...
              (de = B.deltaY),
              (U[0] = U[1] = U[2] = 0)),
            (se || oe) && (k && k(B), (oe &&= (p && oe === 1 && p(B), h && h(B), 0)), (se = !1)),
            ce && !(ce = !1) && ie && ie(B),
            (z &&= (P(B), !1)),
            (R = 0));
        },
        Ce = function (e, t, n) {
          ((ve[n] += e),
            ...
            B._vx.update(e),
            B._vy.update(t),
            o ? (R ||= requestAnimationFrame(W)) : W());
        },
        we = function (e, t) {
          (L && !le && ((B.axis = le = Math.abs(e) > Math.abs(t) ? `x` : `y`), (ce = !0)),
            le !== `y` && ((ve[2] += e), B._vx.update(e, !0)),
            le !== `x` && ((U[2] += t), B._vy.update(t, !0)),
            o ? (R ||= requestAnimationFrame(W)) : W());
        },
        Te = function (e) {
          if (!xe(e, 1)) {
            ...
            ((B.x = t),
              ...
              (o || ((i || a) && (Math.abs(B.startX - t) >= n || Math.abs(B.startY - r) >= n))) &&
                ((oe ||= o ? 2 : 1), o || (B.isDragging = !0), we(i, a)));
          }
        },
        Ee = (B.onPress = function (e) {
          xe(e, 1) ||
            (e && e.button) ||
            ((B.axis = le = null),
            ae.pause(),
            ...
            B._vx.reset(),
            B._vy.reset(),
            Gi(j ? i : H, Pi[1], Te, fe, !0),
            (B.deltaX = B.deltaY = 0),
            g && g(B));
        }),
        De = (B.onRelease = function (e) {
          if (!xe(e, 1)) {
            Ki(j ? i : H, Pi[1], Te, !0);
            ...
            (!r &&
              ...
              s &&
                I &&
                Ci.delayedCall(0.08, function () {
                  if (Bi() - ye > 300 && !e.defaultPrevented) {
        ...
        Oe = function () {
          return (B.isGesturing = !1) || N(B);
        },
        ke = function (e) {
          if (!xe(e)) {
            var t = pe(),
              n = V();
            (Ce((t - me) * re, (n - he) * re, 1), (me = t), (he = n), c && ae.restart(!0));
          }
        },
        Ae = function (e) {
          if (!xe(e)) {
            ((e = ra(e, s)), P && (z = !0));
            var t = (e.deltaMode === 1 ? a : e.deltaMode === 2 ? Ti.innerHeight : 1) * d;
            (Ce(e.deltaX * t, e.deltaY * t, 0), c && !j && ae.restart(!0));
          }
        },
        je = function (e) {
          if (!xe(e)) {
            var t = e.clientX,
              ...
              r = t - B.x,
              i = n - B.y;
            ((B.x = t), (B.y = n), (se = !0), c && ae.restart(!0), (r || i) && we(r, i));
          }
        },
        Me = function (e) {
          ((B.event = e), D(B));
        ...
        Pe = function (e) {
          return xe(e) || (ra(e, s) && ne(B));
        };
      ((ae = B._dc = Ci.delayedCall(l || 0.25, Se).pause()),
        (B.deltaX = B.deltaY = 0),
        (B._vx = na(0, 50, !0)),
        (B._vy = na(0, 50, !0)),
        (B.scrollX = pe),
        ...
        (B.enable = function (e) {
          return (
            B.isEnabled ||
              (Gi(_e ? H : i, `scroll`, Yi),
              r.indexOf(`scroll`) >= 0 && Gi(_e ? H : i, `scroll`, ke, fe, F),
              r.indexOf(`wheel`) >= 0 && Gi(i, `wheel`, Ae, fe, F),
              ((r.indexOf(`touch`) >= 0 && ki) || r.indexOf(`pointer`) >= 0) &&
                (Gi(i, Pi[0], Ee, fe, F),
                Gi(H, Pi[2], De),
                Gi(H, Pi[3], De),
                I && Gi(i, `click`, be, !0, !0),
                ne && Gi(i, `click`, Pe),
                M && Gi(H, `gesturestart`, G),
                N && Gi(H, `gestureend`, Oe),
                D && Gi(i, Ai + `enter`, Me),
                O && Gi(i, Ai + `leave`, Ne),
                k && Gi(i, Ai + `move`, je)),
              (B.isEnabled = !0),
              (B.isDragging = B.isGesturing = B.isPressed = se = oe = !1),
              B._vx.reset(),
              B._vy.reset(),
              (me = pe()),
              (he = V()),
        ...
        (B.disable = function () {
          B.isEnabled &&
            (Ri.filter(function (e) {
              return e !== B && Wi(e.target);
            }).length || Ki(_e ? H : i, `scroll`, Yi),
            B.isPressed && (B._vx.reset(), B._vy.reset(), Ki(j ? i : H, Pi[1], Te, !0)),
            Ki(_e ? H : i, `scroll`, ke, F),
            Ki(i, `wheel`, Ae, F),
            Ki(i, Pi[0], Ee, F),
            Ki(H, Pi[2], De),
            Ki(H, Pi[3], De),
...
var J,
  ...
  $a = function (e) {
    return (e === `Height` ? Pa : Y[`inner` + e]) || la[`client` + e] || Z[`client` + e];
  },
  eo = function (e) {
    return (
  ...
  to = function (e, t, n) {
    var r = n.d,
      i = n.d2,
      a = n.a;
    return (a = Ui(e, `getBoundingClientRect`))
      ? function () {
          return a()[r];
        }
      : function () {
  ...
  Go = function (e, t, n, r, i, a, o, s) {
    ...
    return (
      ...
      (h || s || !m) && (y += (r === Qi ? ho : go) + `:` + (a + parseFloat(d)) + `px;`),
  ...
  Xo = function () {
    (!Ea || !Ea.isPressed || Ea.startX > Z.clientWidth) &&
      (q.cache++,
    ...
    (q.cache++,
      (e === !0 ||
        (!ga &&
          ...
          (!Da || ka !== Y.innerWidth || Math.abs(Y.innerHeight - Oa) > Y.innerHeight * 0.25))) &&
        da.restart(!0));
  },
  $o = {},
  es = [],
  ts = function e() {
    return zo($, `scrollEnd`, e) || ms(!0);
  },
  ns = function (e) {
    return (
      ($o[e] &&
  ...
  os = function (e, t) {
    var n;
    for (ya = 0; ya < Q.length; ya++)
      ((n = Q[ya]), n && (!t || n._ctx === t) && (e ? n.kill(1) : n.revert(!0, !0)));
  ...
  fs = function () {
    (Z.appendChild(Na), (Pa = (!Ea && Na.offsetHeight) || Y.innerHeight), Z.removeChild(Na));
  },
  ps = function (e) {
    return fa(
  ...
  ms = function (e, t) {
    if (((la = X.documentElement), (Z = X.body), (ua = [Y, X, la, Z]), Va && !e && !Fa)) {
      Ro($, `scrollEnd`, ts);
      return;
    }
    (fs(), (cs = $.isRefreshing = !0), Fa || as());
  ...
  vs = function (e) {
    if (e === 2 || (!cs && !Fa)) {
      ...
      if (
        ((gs = hs > i ? -1 : 1),
        cs || (hs = i),
        r && (Va && !_a && n - Va > 200 && ((Va = 0), ns(`scrollEnd`)), (ma = Ba), (Ba = n)),
        gs < 0)
      ) {
        for (ya = t; ya-- > 0;) Q[ya] && Q[ya].update(0, r);
        gs = 1;
      } else for (ya = 0; ya < t; ya++) Q[ya] && Q[ya].update(0, r);
      $.isUpdating = !1;
    }
    Jo = 0;
  },
  ...
  Ss = function (e, t, n, r) {
    if (!e._gsap.swappedIn) {
      for (var i = ys.length, a = t.style, o = e.style, s; i--;) ((s = ys[i]), (a[s] = n[s]));
  ...
  ws = function (e) {
    if (e) {
      ...
      for ((e.t._gsap || J.core.getCache(e.t)).uncache = 1; r < n; r += 2)
        ((a = e[r + 1]),
          (i = e[r]),
          a ? (t[i] = a) : t[i] && t.removeProperty(i.replace(Cs, `-$1`).toLowerCase()));
    }
  },
  Ts = function (e) {
    for (var t = bs.length, n = e.style, r = [], i = 0; i < t; i++) r.push(bs[i], n[bs[i]]);
    return ((r.t = e), r);
  },
  Es = function (e, t, n) {
    ...
    if ((p && ((s[p] = e || -0.001), e < 0 && (e = 0)), a)) {
      ...
      ((h = `scroll` + r.d2),
        Ko(
          ...
          C,
          r,
          (w && C > 20) || (!w && (u ? Math.max(Z[h], la[h]) : a.parentNode[h]) <= C + 1),
        ),
        u && ((c = jo(o)), u && (a.style[r.op.p] = c[r.op.p] - r.op.m - a._offset + Do)));
    }
    return (
      f &&
        _ &&
    ...
    if (e.parentNode !== t) {
      ...
      if (t === Z) {
        for (a in ((e._stOrig = i.cssText), (o = Oo(e)), o))
          !+a && !ks.test(a) && o[a] && typeof i[a] == `string` && a !== `0` && (i[a] = o[a]);
        ((i.top = n), (i.left = r));
  ...
  Ns = function (e, t) {
    ...
    return (
      ...
      $.isTouch && Ro(e, `touchmove`, n.wheelHandler),
      i
    );
  },
  $ = (function () {
    function e(t, n) {
      (ca || e.register(J) || console.warn(`Please gsap.registerPlugin(ScrollTrigger)`),
        ja(this),
        this.init(t, n));
    }
    var t = e.prototype;
    return (
      (t.init = function (t, n) {
        ...
        var r = t,
          ...
          S = r.fastScrollEnd,
          C = r.preventOverlaps,
          w = t.horizontal || (t.containerAnimation && t.horizontal !== !1) ? Zi : Qi,
          T = !l && l !== 0,
          E = $i(t.scroller || Y),
          D = J.core.getCache(E),
          O = Qa(E),
          k = (`pinType` in t ? t.pinType : Ui(E, `pinType`) || (O && `fixed`)) === `fixed`,
        ...
        if (
          ...
          (P.vars = t),
          (n ||= t.animation),
          `refreshPriority` in t && ((Ca = 1), t.refreshPriority === -9999 && (_s = P)),
          (D.tweenScroll = D.tweenScroll || { top: Ns(E, Qi), left: Ns(E, Zi) }),
          (P.tweenTo = ie = D.tweenScroll[w.p]),
          ...
          v &&
            ...
            `scrollBehavior` in Z.style && J.set(O ? [Z, la] : E, { scrollBehavior: `auto` }),
            q.forEach(function (e) {
              return oo(e) && e.target === (O ? X.scrollingElement || la : E) && (e.smooth = !1);
            }),
            (ae = oo(v.snapTo)
              ? v.snapTo
              : v.snapTo === `labels`
                ...
                : v.snapTo === `labelsDirectional`
                  ...
                  : v.directional === !1
                    ...
                    : function (e, t) {
                        return Fo(v.snapTo)(e, za() - F < 500 ? 0 : t.direction);
                      }),
            ...
            (Ae = J.delayedCall(v.delay || Oe / 2 || 0.1, function () {
              var e = L(),
                t = za() - F < 500,
                r = ie.tween;
              if ((t || Math.abs(P.getVelocity()) < 10) && !r && !_a && re !== e) {
                var i = (e - z) / V,
                ...
                if (
                  ...
                  (v.inertia === !1 && (s = l - i),
                    ie(
                      u,
                      {
                        duration: ke(fo((Math.max(fo(c - a), fo(l - a)) * 0.185) / o / 0.05 || 0)),
                        ease: v.ease || `power3`,
                        data: fo(u - e),
                        ...
                        onComplete: function () {
                          (P.update(),
                            ...
                            n &&
                              !T &&
                              (G
                                ? G.resetTo(`totalProgress`, l, n._tTime / n._tDur)
                                : n.progress(l)),
                            (Ee = De = n && !T ? n.totalProgress() : P.progress),
                            g && g(P),
                            m && uo(P, m));
                        },
                      },
              ...
              } else P.isActive && re !== e && Ae.restart(!0);
            }).pause())),
          o && (qo[o] = P),
          (u = P.trigger = $i(u || (d !== !0 && d))),
          ...
          d &&
            (f === !1 ||
              f === wo ||
              (f =
                !f && d.parentNode && d.parentNode.style && Oo(d.parentNode).display === `flex`
                  ? !1
                  : Co),
            (P.pin = d),
            (R = J.core.getCache(d)),
            R.spacer
              ...
              : (b &&
                  ...
                  (R.spacerIsNative = !!b),
                  b && (R.spacerState = Ts(b))),
                (R.spacer = _e = b || X.createElement(`div`)),
                _e.classList.add(`pin-spacer`),
                o && _e.classList.add(`pin-spacer-` + o),
                (R.pinState = me = Ts(d))),
            t.force3D !== !1 && J.set(d, { force3D: !0 }),
            (P.spacer = _e = R.spacer),
            (Te = Oo(d)),
            (xe = Te[f + w.os2]),
            (ve = J.getProperty(d)),
            (U = J.quickSetter(d, w.a, Do)),
            Ss(d, _e, Te),
            (ge = Ts(d))),
          M)
        ) {
          ((fe = co(M) ? Ao(M, Vo) : Vo),
            (ue = Go(`scroller-start`, o, E, w, fe, 0)),
            (de = Go(`scroller-end`, o, E, w, fe, 0, ue)),
            (H = ue[`offset` + w.op.d2]));
          var Fe = $i(Ui(E, `content`) || E);
          ((le = this.markerStart = Go(`start`, o, Fe, w, fe, H, 0, x)),
            (B = this.markerEnd = Go(`end`, o, Fe, w, fe, H, 0, x)),
            x && (Ne = J.quickSetter([le, B], w.a, Do)),
            !k &&
              !(zi.length && Ui(E, `fixedMarkers`) === !0) &&
              (ko(O ? Z : E),
              J.set([ue, de], { force3D: !0 }),
              (W = J.quickSetter(ue, w.a, Do)),
              (we = J.quickSetter(de, w.a, Do))));
        }
        if (x) {
        ...
        if (
          ...
          (P.revert = function (e, t) {
            ...
            r !== P.isReverted &&
              ...
              r && ((ga = P), P.update(r)),
              d && (!y || !P.isActive) && (r ? xs(d, _e, me) : Ss(d, _e, Oo(d), Se)),
              r || P.update(r),
              (ga = i),
              (P.isReverted = r));
          }),
          (P.refresh = function (r, i, a, o) {
            if (!((ga || !P.enabled) && !i)) {
              ...
              (!cs && ee && ee(P),
                (ga = P),
                ie.tween && !a && (ie.tween.kill(), (ie.tween = 0)),
                G && G.pause(),
                p &&
                  n &&
              ...
              var s = te(),
                ...
                v = co(a) ? a.end : t.end,
                b = t.endTrigger || u,
                S = co(a) ? a.start : t.start || (t.start === 0 || !u ? 0 : d ? `0 0` : `0 100%`),
                C = (P.pinnedContainer = t.pinnedContainer && $i(t.pinnedContainer, P)),
                ...
                Oe;
              for (
                M && co(a) && ((De = J.getProperty(ue, w.p)), (Oe = J.getProperty(de, w.p)));
                A-- > 0;
              )
                ((U = Q[A]),
                  U.end || U.refresh(0, 1) || (ga = P),
                  (xe = U.pin),
                  xe &&
                    (xe === u || xe === d || xe === C) &&
                    !U.isReverted &&
              ...
              for (
                oo(S) && (S = S(P)),
                  S = Ua(S, `start`, P),
                  z =
                    Os(S, u, s, w, L(), le, ue, P, l, N, k, m, x, P._startClamp && `_startClamp`) ||
                    (d ? -0.001 : 0),
                  oo(v) && (v = v(P)),
                  ao(v) &&
                    !v.indexOf(`+=`) &&
                ...
                ((U = Q[A] || {}),
                  (xe = U.pin),
                  xe &&
                    U.start - U._pinPush <= z &&
                    !x &&
                    U.end > 0 &&
                    ((j = U.end - (P._startClamp ? Math.max(0, U.start) : U.start)),
                    ((xe === u && U.start - U._pinPush < z) || xe === C) &&
                      isNaN(S) &&
                      (g += j * (1 - U.progress)),
                    xe === d && (_ += j)));
              if (
                ...
                P._endClamp && !cs && ((P._endClamp = ce || -0.001), (ce = Math.min(ce, ro(E, w)))),
                (V = ce - z || ((z -= 0.01) && 0.001)),
                h && (I = J.utils.clamp(0, 1, J.utils.normalize(z, ce, je))),
                (P._pinPush = _),
                le &&
                  g &&
                  ((j = {}), (j[w.a] = `+=` + g), C && (j[w.p] = `-=` + L()), J.set([le, B], j)),
                d && !(Ia && P.end >= ro(E, w)))
              )
                ((j = Oo(d)),
                  (fe = w === Qi),
                  (ae = L()),
                  (ye = parseFloat(ve(w.a)) + _),
                  !m &&
                    ce > 1 &&
                    ((Ee = (O ? X.scrollingElement || la : E).style),
                    (Ee = { style: Ee, value: Ee[`overflow` + w.a.toUpperCase()] }),
                    O &&
                      Oo(Z)[`overflow` + w.a.toUpperCase()] !== `scroll` &&
                  ...
                  f
                    ? ((Se = [f + w.os2, V + _ + Do]),
                      ...
                      A &&
                        (Se.push(w.d, A + Do),
                        _e.style.flexBasis !== `auto` && (_e.style.flexBasis = A + Do)),
                      ws(Se),
                      C &&
                        Q.forEach(function (e) {
                      ...
                      k && L(je))
                    : ((A = Mo(d, w)),
                      A && _e.style.flexBasis !== `auto` && (_e.style.flexBasis = A + Do)),
                  k &&
                    ((H = {
                      top: R.top + (fe ? ae - z : W) + Do,
                      left: R.left + (fe ? W : ae - z) + Do,
                      boxSizing: `border-box`,
                      position: `fixed`,
                    }),
                    (H[_o] = H[`max` + To] = Math.ceil(R.width) + Do),
                    (H[vo] = H[`max` + Eo] = Math.ceil(R.height) + Do),
                    (H[wo] = H[wo + xo] = H[wo + yo] = H[wo + So] = H[wo + bo] = `0`),
                    (H[Co] = j[Co]),
                    (H[Co + xo] = j[Co + xo]),
                    (H[Co + yo] = j[Co + yo]),
                    (H[Co + So] = j[Co + So]),
                ...
                for (R = u.parentNode; R && R !== Z;)
                  (R._pinOffset && ((z -= R._pinOffset), (ce -= R._pinOffset)), (R = R.parentNode));
              (Te &&
                ...
                (P.end = ce),
                (oe = se = cs ? je : L()),
                !x && !cs && (oe < je && L(je), (P.scroll.rec = 0)),
                P.revert(!1, !0),
                (F = za()),
                Ae && ((re = -1), Ae.restart(!0)),
                (ga = 0),
                n &&
                  T &&
                  (n._initted || Me) &&
                ...
                (h || I !== P.progress || x || p || (n && !n._initted)) &&
                  (n &&
                    ...
                    n.totalProgress(x && z < -0.001 && !I ? J.utils.normalize(z, ce, 0) : I, !0),
                  (P.progress = h || (oe - z) / V === I ? 0 : I)),
                d && f && (_e._pinOffset = Math.round(P.progress * be)),
                G && G.invalidate(),
                isNaN(De) ||
                  ((De -= J.getProperty(ue, w.p)),
                  (Oe -= J.getProperty(de, w.p)),
                  Ms(ue, w, De),
                  Ms(le, w, De - (o || 0)),
                  Ms(de, w, Oe),
                  Ms(B, w, Oe - (o || 0))),
                h && !cs && P.update(),
                c && !cs && !pe && ((pe = !0), c(P), (pe = !1)));
            }
          }),
          (P.getVelocity = function () {
            return ((L() - se) / (za() - ma)) * 1e3 || 0;
          }),
          ...
          (P.labelToScroll = function (e) {
            return (
              (n && n.labels && (z || P.refresh() || z) + (n.labels[e] / n.duration()) * V) || 0
            );
          }),
          (P.getTrailing = function (e) {
            ...
            return (
              ...
              return P.direction > 0 ? e.end <= z : e.start >= ce;
            });
          }),
            ...
            if (!(x && !r && !e)) {
              ...
              if (
                ...
                m &&
                  ...
                  (!u && z < o + ((o - se) / (za() - ma)) * m
                    ? (u = 1e-4)
                    : u === 1 && ce > o + ((o - se) / (za() - ma)) * m && (u = 0.9999)),
                u !== p && P.enabled)
              ) {
                if (
                  ((h = P.isActive = !!u && u < 1),
                    ...
                    (G && !ga && !Ra
                      ? (G._dp._time - G._start !== G._time && G.render(G._dp._time - G._start),
                        G.resetTo
                          ...
                          : ((G.vars.totalProgress = u), G.invalidate().restart()))
                      : n && n.totalProgress(u, !!(ga && (F || e)))),
                  d)
                ) {
                  if ((e && f && (_e.style[f + w.os2] = xe), !k)) U(Ya(ye + be * u));
                  else if (O) {
                    if (((N = !e && u > p && ce + 1 > o && o + 1 >= ro(E, w)), y)) {
                      if (!e && (h || N)) {
                        var te = jo(d, !0),
                          ne = o - z;
                        As(
                          ...
                          Z,
                          te.top + (w === Qi ? ne : 0) + Do,
                          te.left + (w === Qi ? 0 : ne) + Do,
                        );
                      } else As(d, _e);
                    }
                    (ws(h || N ? he : ge), (Ce && u < 1 && h) || U(ye + (u === 1 && !N ? be : 0)));
                  }
                }
                (v && !ie.tween && !ga && !Ra && Ae.restart(!0),
                  a &&
                    (M || (_ && u && (u < 1 || !La))) &&
          ...
          (P.enable = function (t, n) {
            P.enabled ||
              ...
              t !== !1 && ((P.progress = I = 0), (oe = se = re = L())),
              n !== !1 && P.refresh());
          }),
          (P.getTween = function (e) {
            return e && ie ? ie.tween : G;
          }),
          (P.setPositions = function (e, t, n, r) {
            ...
            (P.refresh(
              !1,
              !1,
              { start: Wa(e, n && !!P._startClamp), end: Wa(t, n && !!P._endClamp) },
              r,
            ),
              P.update());
          }),
          (P.adjustPinSpacing = function (e) {
            if (Se && e) {
              var t = Se.indexOf(w.d) + 1;
              ((Se[t] = parseFloat(Se[t]) + e + Do), (Se[1] = parseFloat(Se[1]) + e + Do), ws(Se));
            }
          }),
          (P.disable = function (t, n) {
            if (
              ...
              P.enabled &&
                ...
                Ae && (Ae.pause(), ie.tween && ie.tween.kill() && (ie.tween = 0)),
                !O))
            ) {
              for (var r = Q.length; r--;) if (Q[r].scroller === E && Q[r] !== P) return;
          ...
          var Re = P.update;
          ((P.update = function () {
            ((P.update = Re), q.cache++, z || ce || P.refresh());
          }),
      ...
      (e.register = function (t) {
        return ((ca ||= ((J = t || Za()), Xa() && window.document && e.enable(), Ha)), ca);
      }),
      ...
      (e.disable = function (e, t) {
        ((Ha = 0),
          ...
          zo(X, `touchcancel`, Ja),
          zo(Z, `touchstart`, Ja),
          Lo(zo, X, `pointerdown,touchstart,mousedown`, Ka),
          Lo(zo, X, `pointerup,touchend,mouseup`, qa),
          da.kill(),
          io(zo));
        for (var n = 0; n < q.length; n += 3) (Bo(zo, q[n], q[n + 1]), Bo(zo, q[n], q[n + 2]));
      }),
      (e.enable = function () {
        if (((Y = window), (X = document), (la = X.documentElement), (Z = X.body), J)) {
          if (
            ((fa = J.utils.toArray),
            (pa = J.utils.clamp),
            ...
            ((Ha = 1),
              ...
              Ga(),
              sa.register(J),
              (e.isTouch = sa.isTouch),
              (Aa = sa.isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent)),
              (Da = sa.isTouch === 1),
              Ro(Y, `wheel`, Xo),
              (ua = [Y, X, la, Z]),
              J.matchMedia
            ...
            for (
              i.revert ||
                ...
                a = jo(Z),
                Qi.m = Math.round(a.top + Qi.sc()) || 0,
                Zi.m = Math.round(a.left + Zi.sc()) || 0,
                ...
                Ro(X, `touchcancel`, Ja),
                Ro(Z, `touchstart`, Ja),
                Lo(Ro, X, `pointerdown,touchstart,mousedown`, Ka),
                Lo(Ro, X, `pointerup,touchend,mouseup`, qa),
                ...
                Sa = [
                  ...
                  function () {
                    var e = Y.innerWidth,
                      t = Y.innerHeight;
                    X.hidden ? ((ba = e), (xa = t)) : (ba !== e || xa !== t) && Qo();
                  },
                  X,
                  `DOMContentLoaded`,
                  ms,
            ...
            X &&
              X.addEventListener(`DOMContentLoaded`, function t() {
      ...
      (e.config = function (t) {
        ...
        ((n && clearInterval(ha)) || ((ha = n) && setInterval(Yo, n)),
          `ignoreMobileResize` in t && (Da = e.isTouch === 1 && t.ignoreMobileResize),
      ...
      (e.scrollerProxy = function (e, t) {
        var n = $i(e),
          r = q.indexOf(n),
          i = Qa(n);
        (~r && q.splice(r, i ? 6 : 2), t && (i ? zi.unshift(Y, t, Z, t, la, t) : zi.unshift(n, t)));
      }),
      ...
      (e.isInViewport = function (e, t, n) {
        var r = (ao(e) ? $i(e) : e).getBoundingClientRect(),
          i = r[n ? _o : vo] * t || 0;
        return n
...
(($.version = `3.15.0`),
  ...
  ($.batch = function (e, t) {
    var n = [],
      ...
      s;
    for (s in t)
      r[s] = s.substr(0, 2) === `on` && oo(t[s]) && s !== `onRefreshInit` ? o(s, t[s]) : t[s];
    return (
      oo(a) &&
        ((a = a()),
        Ro($, `refresh`, function () {
...
var Ps = function (e, t, n, r) {
  ...
  Fs = function e(t, n) {
    (n === !0
      ...
      : (t.style.touchAction =
          n === !0 ? `auto` : n ? `pan-` + n + (sa.isTouch ? ` pinch-zoom` : ``) : `none`),
      t === la && e(Z, n));
  },
  Is = { auto: 1, scroll: 1 },
  Ls = function (e) {
    ...
    if (!a._isScrollT || o - a._isScrollT > 2e3) {
      for (
        ...
        i = i.parentNode;
      ((a._isScroll = i && i !== n && !Qa(i) && (Is[(s = Oo(i)).overflowY] || Is[s.overflowX])),
        (a._isScrollT = o));
    }
  ...
  Rs = function (e, t, n, r) {
    return sa.create({
      ...
      onScroll: r,
      onEnable: function () {
        return n && Ro(X, sa.eventTypes[0], Vs, !1, !0);
      },
      onDisable: function () {
        return zo(X, sa.eventTypes[0], Vs, !0);
      },
    });
  },
  ...
  Hs = function (e) {
    ...
    var t = e,
      ...
      d =
        Aa &&
        ((e.content && $i(e.content)) || (u && e.content !== !1 && !u.smooth() && u.content())),
      f = ta(c, Qi),
      p = ta(c, Zi),
      m = 1,
      h =
        (sa.isTouch && Y.visualViewport
      ...
      C = Ja,
      w = function () {
        ((s = ro(c, Qi)), (C = pa(+!!Aa, s)), n && (S = pa(0, ro(c, Zi))), (v = ls));
      },
      T = function () {
    ...
    return (
      ...
      (e.onChange = function (e, t, r, i, a) {
        if (
          (ls !== v && w(), t && n && p(S(i[2] === t ? O + (e.startX - e.x) : p() + t - i[1])), r)
        ) {
          f.offset && T();
          var o = a[2] === r,
      ...
      (e.onDisable = function () {
        (Fs(c, !0), zo(Y, `resize`, j), $.removeEventListener(`refresh`, j), b.kill());
      }),
...
(($.sort = function (e) {
  ...
  ($.normalizeScroll = function (e) {
    ...
    var t = e instanceof sa ? e : Hs(e);
    return (Ea && Ea.target === t.target && Ea.kill(), Qa(t.target) && (Ea = t), t);
  }),
  ($.core = {
    _getVelocityProp: na,
    _inputObserver: Rs,
  ...
  Za() && J.registerPlugin($),
  typeof window < `u` && bi.registerPlugin($));
function Us(e = {}) {
  let t = (0, i.useRef)(null),
    { delay: n = 0, y: r = 24, duration: a = 0.7, disabled: o = !1 } = e;
  return (
    (0, i.useEffect)(() => {
      let e = t.current;
      if (!e || o) return;
      ...
      let i = bi.context(() => {
        bi.fromTo(
          ...
          { opacity: 0, y: r },
          {
            ...
            delay: n,
            ease: `power3.out`,
            onStart: () => e.setAttribute(`data-revealed`, `true`),
...
var Ws = e();
function Gs({ children: e, as: t = `div`, className: n, delay: i, y: a, duration: o }) {
  let s = Us({ delay: i, y: a, duration: o });
  return (0, Ws.jsx)(t, { ref: s, className: r(n), children: e });
}
export { bi as n, Gs as t };
