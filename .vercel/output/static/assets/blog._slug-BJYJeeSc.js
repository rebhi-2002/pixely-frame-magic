import { D as e, M as t, R as n, k as r, u as i } from "./rbac-static-data-Cz2qa6wH.js";
import { t as a } from "./arrow-right-BFjSOc6f.js";
import { n as o, t as s } from "./clock-3-Dl5TSbyD.js";
import { n as c, t as l } from "./blog-posts-CxW631lu.js";
import { x as u } from "./index-CUZEShOB.js";
import { t as d } from "./reveal-Cj6tVgBd.js";
import { n as f } from "./public-layout-BGA3sCZD.js";
import { t as p } from "./session-cta-DDRdl3yw.js";
var m = n();
function h({ blocks: e }) {
  return (0, m.jsx)(`div`, {
    className: `space-y-5`,
    children: e.map((e, t) =>
      e.type === `h2`
        ? (0, m.jsx)(
            `h2`,
            { className: `pt-2 text-xl font-bold text-foreground`, children: e.text },
            t,
          )
        : e.type === `list`
          ? (0, m.jsx)(
          ...
          : e.type === `quote`
            ...
            : (0, m.jsx)(
                `p`,
                { className: `text-[15px] leading-[1.9] text-foreground/90`, children: e.text },
                t,
              ),
    ),
  });
      ...
      children: (0, m.jsxs)(`section`, {
        ...
        children: [
          (0, m.jsx)(`h1`, {
            ...
            children: g(`blog.notFound`),
          }),
          (0, m.jsx)(`p`, {
            className: `mt-3 text-muted-foreground`,
            children: g(`blog.notFoundSub`),
          }),
          (0, m.jsx)(t, {
            to: `/blog`,
            className: `hover-press mt-7 inline-flex rounded-xl bg-primary px-6 py-3 text-sm font-bold text-primary-foreground`,
            children: g(`blog.backToBlog`),
          }),
        ],
      }),
    });
  let b = new Intl.DateTimeFormat(v === `en` ? `en-US` : `ar`, {
      year: `numeric`,
      month: `long`,
      day: `numeric`,
    }),
    x = l.filter((e) => e.slug !== y.slug).slice(0, 2);
  return (0, m.jsx)(f, {
      ...
      children: [
            ...
            (0, m.jsxs)(`div`, {
              ...
              children: [
                (0, m.jsxs)(`span`, {
                  ...
                  children: [
                    (0, m.jsx)(o, { className: `size-3.5` }),
                    b.format(new Date(y.publishedAt)),
                  ],
                }),
                (0, m.jsxs)(`span`, {
                  className: `inline-flex items-center gap-1.5`,
                  children: [
                    (0, m.jsx)(s, { className: `size-3.5` }),
                    g(`blog.readMinutes`, { count: y.readMinutes }),
                  ],
                }),
              ],
            }),
        ...
        (0, m.jsx)(d, {
          ...
          children: (0, m.jsx)(`div`, {
            className: `mt-9`,
            children: (0, m.jsx)(h, { blocks: y.body }),
          }),
        }),
        (0, m.jsx)(d, {
          delay: 0.1,
          children: (0, m.jsxs)(`div`, {
            ...
            children: [
              (0, m.jsx)(`h2`, {
                ...
                children: g(`blog.ctaTitle`),
              }),
              (0, m.jsx)(`p`, {
                className: `mt-1.5 text-sm text-muted-foreground`,
                children: g(`blog.ctaSub`),
              }),
              (0, m.jsx)(p, {
                to: `/signup`,
                label: g(`blog.ctaButton`),
