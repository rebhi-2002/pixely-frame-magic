...
import { t as i } from "./circle-check-ydOT-ci8.js";
import { t as a } from "./circle-x-Bx80P6i_.js";
import { t as o } from "./shield-question-mark-CDr5yNn4.js";
...
var l = r(t()),
  ...
  d = /^ACD-\d{4}-\d{5}$/i;
function f() {
  let { id: e } = s.useParams(),
    { t } = n(),
    r = e === `verify` ? `` : e,
    [f, m] = (0, l.useState)(r),
    [h, g] = (0, l.useState)(r ? (d.test(r) ? `valid` : `invalid`) : null);
  return (0, u.jsx)(c, {
    children: (0, u.jsxs)(`section`, {
      ...
      children: [
        (0, u.jsx)(`span`, {
          ...
          children: (0, u.jsx)(o, { className: `size-6` }),
        }),
        (0, u.jsx)(`h1`, {
        ...
        (0, u.jsxs)(`form`, {
          ...
          onSubmit: (e) => {
            (e.preventDefault(), g(d.test(f.trim()) ? `valid` : `invalid`));
          },
          children: [
            (0, u.jsx)(`input`, {
              value: f,
          ...
          (0, u.jsxs)(`div`, {
            ...
            children: [
              (0, u.jsxs)(`p`, {
                ...
                children: [(0, u.jsx)(i, { className: `size-5` }), t(`certificate.valid`)],
              }),
              (0, u.jsxs)(`dl`, {
                className: `mt-5 grid gap-3 text-sm sm:grid-cols-2`,
                children: [
                  (0, u.jsx)(p, { label: t(`certificate.holder`), value: `—` }),
                  (0, u.jsx)(p, { label: t(`certificate.course`), value: `—` }),
                  (0, u.jsx)(p, { label: t(`certificate.issued`), value: `—` }),
                  (0, u.jsx)(p, { label: t(`certificate.id`), value: f.toUpperCase(), mono: !0 }),
                ],
              }),
            ],
          }),
        h === `invalid` &&
          (0, u.jsxs)(`p`, {
            ...
            children: [(0, u.jsx)(a, { className: `size-5` }), t(`certificate.invalid`)],
          }),
        (0, u.jsx)(`p`, {
...
function p({ label: e, value: t, mono: n }) {
  return (0, u.jsxs)(`div`, {
    children: [
      (0, u.jsx)(`dt`, { className: `text-xs text-muted-foreground`, children: e }),
      (0, u.jsx)(`dd`, {
        className: `font-semibold text-foreground ${n ? `font-mono` : ``}`,
        children: t,
      }),
    ],
  });
