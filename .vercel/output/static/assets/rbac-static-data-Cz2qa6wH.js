var e = Object.create,
  ...
  u = o((e) => {
    ...
    function k(e, r, i, a, o) {
      ...
      if (S(e))
        for (var u = 0; u < e.length; u++)
          ((a = e[u]), (s = l + ne(a, u)), (c += k(a, r, i, s, o)));
      else if (((u = m(e)), typeof u == `function`))
        for (e = u.call(e), u = 0; !(a = e.next()).done;)
          ((a = a.value), (s = l + ne(a, u++)), (c += k(a, r, i, s, o)));
      else if (s === `object`) {
    ...
    ((e.Activity = f),
      ...
      (e.isValidElement = O),
      (e.lazy = function (e) {
        return { $$typeof: d, _payload: { _status: -1, _result: e }, _init: ie };
      }),
      (e.memo = function (e, t) {
...
var E = /[\x00-\x1f\x7f"<>`{}]/g;
function D(e) {
  return e.replace(E, (e) => `%` + e.charCodeAt(0).toString(16).toUpperCase().padStart(2, `0`));
}
function O(e) {
  let t;
  try {
...
function A(e) {
  ...
  let t = /%25|%5C/gi,
    ...
    r = ``,
    i;
  for (; (i = t.exec(e)) !== null;) ((r += O(e.slice(n, i.index)) + i[0]), (n = t.lastIndex));
  r += O(n ? e.slice(n) : e);
  let a = !1;
  return (
        ...
        case 2: {
          ...
          let m = f === 1 ? i.dynamic : f === 3 ? i.optional : i.wildcard,
            h =
              f !== 2 &&
              !d &&
              m?.find((e) => !e.parse && e.caseSensitive === p && e.prefix === t && e.suffix === c);
          if (h) n = h;
          else {
            let e = le(f, r, p, t, c);
...
function fe(e, t, n, r, i) {
  ...
  return (
    o || ((o = F(`/`)), N(t, new Uint16Array(6), { from: e }, 1, o, 0), i.singleCache.set(a, o)),
    ge(r, o, n)
  );
}
function pe(e, t, n = !1) {
...
function ve(e, t, n, r) {
  ...
  for (; s.length;) {
    ...
    r && i.route && i.kind !== M && xe(c, n) && (c = n);
    let _ = u === o;
    if (
      _ &&
      (i.route && (!a || i.kind === M || i.kind === 2) && xe(l, n) && (l = n),
      ...
      (t.dynamics > e.dynamics ||
        (t.dynamics === e.dynamics &&
          (t.optionals > e.optionals ||
            (t.optionals === e.optionals &&
              ((t.node.kind === M) > (e.node.kind === M) ||
                ((t.node.kind === M) == (e.node.kind === M) && t.node.depth > e.node.depth)))))))
  );
}
function Se(e) {
  return Ce(e.filter((e) => e !== void 0).join(`/`));
}
function Ce(e) {
...
function ke({ base: e, to: t, trailingSlash: n = `never`, cache: r }) {
  if ((t.includes(`//`) && (t = Ce(t)), t.startsWith(`/`)))
  ...
  if (i) o = e.split(`/`);
    ...
    for (e.includes(`//`) && (e = Ce(e)), o = e.split(`/`); o.length > 1 && f(o) === ``;) o.pop();
    let n = t.split(`/`);
  ...
  o.length > 1 && (f(o) === `` ? n === `never` && o.pop() : n === `always` && o.push(``));
  let s = o.join(`/`),
    c = (i ? Ce(s) : s) || `/`;
...
var Pe = `Error preloading route! ☝️`,
  z = l(d(), 1),
  Fe = z.use,
  Ie = z.useLayoutEffect;
function Le(e, t, n) {
  z.useEffect(() => {
...
function Ve({ children: e, fallback: t = null }) {
  return (0, B.jsx)(z.Fragment, { children: He() ? e : t });
}
function He() {
...
var We = z.createContext(null);
function Ge(e) {
  return z.useContext(We);
}
var Ke = o((e) => {
    var t = d();
    function n(e, t) {
...
function Ze(e, t, n = Xe) {
  ...
  return (0, Ye.useSyncExternalStoreWithSelector)(r, i, i, t, n);
}
function Qe(e) {
  let t = z.useRef(e);
  return (w(t.current, e, { ignoreUndefined: !1 }) || (t.current = e), t.current);
}
function $e(e, t) {
  return e[0] === t[0] && e[1] === t[1] && e[2] === t[2];
}
function et(e, t, n) {
  if (e?.external) return te(e.href, n) ? void 0 : e.href;
  if (!lt(t) && typeof t == `string` && t.indexOf(`:`) !== -1)
    try {
      return (new URL(t), te(t, n) ? void 0 : t);
    } catch {}
}
function tt(e, t, n, r, i, a) {
  if (a) return !1;
  if (n?.exact) {
    if (!Oe(e.pathname, t.pathname, r)) return !1;
  } else {
    let n = De(e.pathname, r),
      i = De(t.pathname, r);
    if (!(n.startsWith(i) && (n.length === i.length || n[i.length] === `/`))) return !1;
  }
  return (n?.includeSearch ?? !0) &&
    !w(e.search, t.search, { partial: !n?.exact, ignoreUndefined: !n?.explicitUndefined })
    ? !1
...
function nt(e, t) {
  let n = Ge(),
    ...
    P = z.useMemo(
      () => e,
      [n, e.from, e._fromLocation, e.hash, e.to, se, ce, e.state, e.mask, e.unsafeRelative],
    ),
    F = z.useCallback(
      (e) => {
        let t = n.buildLocation({ _fromLocation: e, ...P }),
          r = ct(
          ...
          i = et(r, s, n.protocolAllowlist);
        return [r?.href, i, tt(e, t, N, n.basepath, M, i !== void 0)];
      },
      [N, y, M, P, n, s],
    ),
    [le, ue, de] = Ze(n.stores.location, F, $e),
    fe = de ? (p(i, {}) ?? it) : rt,
    pe = de ? rt : (p(a, {}) ?? rt),
    me = [x, fe.className, pe.className].filter(Boolean).join(` `),
    he = (b || fe.style || pe.style) && { ...b, ...fe.style, ...pe.style },
    ge = z.useRef(!1),
    I = e.reloadDocument || ue || y ? !1 : (c ?? n.options.defaultPreload),
    _e = l ?? n.options.defaultPreloadDelay ?? 0,
    L = z.useCallback(() => {
      n.preloadRoute(P).catch((e) => {
    ...
    ve = z.useCallback(
      (e) => {
        ...
        if (!(e.isIntersecting ?? I === `intent`)) {
          e.isIntersecting === !1 && st(r);
          return;
        }
        if (!_e) {
          L();
  ...
  (Le(r, ve, I !== `viewport`),
    z.useEffect(() => {
      ge.current || (I === `render` && (L(), (ge.current = !0)));
    }, [L, I]));
  let R = (e) => {
...
var rt = {},
  it = { className: `active` },
  at = { role: `link`, "aria-disabled": !0 },
  ot = { "data-status": `active`, "aria-current": `page` },
  V = new WeakMap(),
  st = (e) => {
    (clearTimeout(V.get(e)), V.delete(e));
  },
  H = (e) => (t) => {
    for (let n of e)
      if (n) {
...
var ut = z.forwardRef((e, t) => {
  ...
  dt = z.createContext(void 0),
  ft = (e) => {
    let t = z.useContext(dt);
    if (e) return e;
    if (!t) throw Error(`No QueryClient set, use QueryClientProvider to set one`);
    return t;
  },
  pt = ({ client: e, children: t }) => (
    z.useEffect(
      () => (
        e.mount(),
        () => {
    ...
    (0, B.jsx)(dt.Provider, { value: e, children: t })
  ),
  mt = qe(),
  U = (e) => typeof e == `string`,
  ht = () => {
  ...
  vt = /###/g,
  yt = (e) => (e && e.includes(`###`) ? e.replace(vt, `.`) : e),
  bt = (e) => !e || U(e),
  xt = (e, t, n) => {
    let r = U(t) ? t.split(`.`) : t,
      i = 0;
    ...
    return bt(e) ? {} : { obj: e, k: yt(r[i]) };
  },
  St = (e, t, n) => {
    let { obj: r, k: i } = xt(e, t, Object);
  ...
  Ct = (e, t, n, r) => {
    let { obj: i, k: a } = xt(e, t, Object);
    ((i[a] = i[a] || []), i[a].push(n));
  },
  wt = (e, t) => {
    let { obj: n, k: r } = xt(e, t);
    if (n && Object.prototype.hasOwnProperty.call(n, r)) return n[r];
  },
  Tt = (e, t, n) => {
    let r = wt(e, n);
    return r === void 0 ? wt(t, n) : r;
  },
  Et = (e, t, n) => {
    for (let r in t)
      r !== `__proto__` &&
        ...
        (Object.prototype.hasOwnProperty.call(e, r)
          ? U(e[r]) || e[r] instanceof String || U(t[r]) || t[r] instanceof String
            ? n && (e[r] = t[r])
            : Et(e[r], t[r], n)
          : (e[r] = t[r]));
    return e;
  ...
  Mt = (e, t, n) => {
    ((t ||= ``), (n ||= ``));
    let r = At.filter((e) => !t.includes(e) && !n.includes(e));
    if (r.length === 0) return !0;
    let i = jt.getRegExp(`(${r.map((e) => (e === `?` ? `\\?` : e)).join(`|`)})`),
      a = !i.test(e);
    if (!a) {
      let t = e.indexOf(n);
  ...
  G = new (class e {
    ...
    forward(e, t, n, r) {
      return r && !this.debug
        ? null
        : ((e = e.map((e) => (U(e) ? e.replace(/[\r\n\x00-\x1F\x7F]/g, ` `) : e))),
          U(e[0]) && (e[0] = `${n}${this.prefix} ${e[0]}`),
          this.logger[t](e));
    }
    create(t) {
  ...
  Lt = class extends It {
    ...
    getResource(e, t, n, r = {}) {
      ...
      e.includes(`.`)
        ? (o = e.split(`.`))
        : ((o = [e, t]),
          n && (Array.isArray(n) ? o.push(...n) : U(n) && i ? o.push(...n.split(i)) : o.push(n)));
      let s = wt(this.data, o);
      return (
        !s && !t && !n && e.includes(`.`) && ((e = o[0]), (t = o[1]), (n = o.slice(2).join(`.`))),
        s || !a || !U(n) ? s : Nt(this.data?.[e]?.[t], n, i)
      );
    }
    ...
    addResources(e, t, n, r = { silent: !1 }) {
      for (let r in n)
        (U(n[r]) || Array.isArray(n[r])) && this.addResource(e, t, r, n[r], { silent: !0 });
...
function Bt() {
  ...
  return (
    (t.get = (r, i) => (
      n?.revoke?.(),
      i === zt ? e : (e.push(i), (n = Proxy.revocable(r, t)), n.proxy)
    )),
...
var Vt = (e) => !U(e) && typeof e != `boolean` && typeof e != `number`,
  Ht = class e extends It {
    constructor(e, t = {}) {
      (super(),
        _t(
          [
        ...
        (this.options = t),
        this.options.keySeparator === void 0 && (this.options.keySeparator = `.`),
        (this.logger = G.create(`translator`)),
    ...
    extractFromKey(e, t) {
      ...
      if (a && !o) {
        ...
        if (t && t.length > 0) return { key: e, namespaces: U(i) ? [i] : i };
        let a = e.split(n);
        ((n !== r || (n === r && this.options.ns.includes(a[0]))) && (i = a.shift()),
          (e = a.join(r)));
      }
      return { key: e, namespaces: U(i) ? [i] : i };
    }
    translate(t, n, r) {
      ...
      if (
        ...
        return ``;
      (typeof t == `function` && (t = K(t, { ...this.options, ...i })),
        Array.isArray(t) || (t = [String(t)]),
        (t = t.map((e) => (typeof e == `function` ? K(e, { ...this.options, ...i }) : String(e)))));
      ...
      y && !m && x && (E = T);
      let D = Vt(E),
        O = Object.prototype.toString.apply(E);
      if (y && E && D && !_.includes(O) && !(U(v) && Array.isArray(E))) {
    ...
    resolve(e, t = {}) {
      ...
      return (
        U(e) && (e = [e]),
        Array.isArray(e) &&
          (e = e.map((e) => (typeof e == `function` ? K(e, { ...this.options, ...t }) : e))),
        e.forEach((e) => {
          ...
          let u = t.count !== void 0 && !U(t.count),
            d = u && !t.ordinal && t.count === 0,
            f =
              t.context !== void 0 &&
              (U(t.context) || typeof t.context == `number`) &&
              t.context !== ``,
            p = t.lngs
              ? t.lngs
  ...
  Ut = class {
    ...
    getScriptPartFromCode(e) {
      if (((e = Pt(e)), !e || !e.includes(`-`))) return null;
      let t = e.split(`-`);
    ...
    getLanguagePartFromCode(e) {
      if (((e = Pt(e)), !e || !e.includes(`-`))) return e;
      let t = e.split(`-`);
    ...
    toResolveHierarchy(e, t) {
      ...
      return (
        U(e) && (e.includes(`-`) || e.includes(`_`))
          ...
          : U(e) && u(this.formatLanguageCode(e)),
        c.forEach((e) => {
  ...
  Wt = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 },
  Gt = {
    ...
    getSuffixes(e, t = {}) {
      ...
      return (
        ...
        n
          ? n
              .resolvedOptions()
              .pluralCategories.sort((e, t) => Wt[e] - Wt[t])
              .map(
                (e) =>
  ...
  qt = (e, t, n, r = `.`, i = !0) => {
    let a = Tt(e, t, n);
    return (!a && i && U(n) && ((a = Nt(e, n, r)), a === void 0 && (a = Nt(t, n, r))), a);
  },
  Jt = (e) => e.replace(/\$/g, `$$$$`),
  Yt = class {
    constructor(e = {}) {
    ...
    init(e = {}) {
      ...
      ((this.escape = t === void 0 ? Ot : t),
        (this.escapeValue = n === void 0 || n),
        (this.useRawValueToEscape = r !== void 0 && r),
        (this.prefix = i ? W(i) : a || `{{`),
        (this.suffix = o ? W(o) : s || `}}`),
        (this.formatSeparator = c || `,`),
        (this.unescapePrefix = l ? `` : u ? W(u) : `-`),
        (this.unescapeSuffix = this.unescapePrefix ? `` : l ? W(l) : ``),
        (this.nestingPrefix = d ? W(d) : f || W(`$t(`)),
        (this.nestingSuffix = p ? W(p) : m || W(`)`)),
      ...
      let i,
        ...
        c = (e) => {
          if (!e.includes(this.formatSeparator)) {
            let i = qt(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
          ...
          return this.format(
            qt(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure),
            o,
            n,
            ...
            if (((a = c(n)), a === void 0)) {
              if (typeof l == `function`) {
                ...
                (this.logger.warn(`missed to pass in variable ${n} for interpolating ${e}`),
                  (a = ``));
            } else !U(a) && !this.useRawValueToEscape && (a = gt(a));
            let s = t.safeValue(a);
            if (
              ((e = e.replace(i[0], Jt(s))),
              u
    ...
    nest(e, t, n = {}) {
      ...
      for (; (r = this.nestingRegexp.exec(e));) {
        let s = [];
        ((a = { ...n }),
          (a = a.replace && !U(a.replace) ? a.replace : a),
  ...
  Zt = (e) => {
    ...
    return (n, r, i) => {
      ...
      let o = r + JSON.stringify(a),
        s = t[o];
      return (s || ((s = e(Pt(r), i)), (t[o] = s)), s(n));
    };
  },
  Qt = (e) => (t, n, r) => e(Pt(n), r)(t),
  $t = class {
    constructor(e = {}) {
    ...
    init(e, t = { interpolation: {} }) {
      ...
      let n = t.cacheInBuiltFormats ? Zt : Qt;
      this.formats = {
        number: n((e, t) => {
    ...
    format(e, t, n, r = {}) {
      ...
      return a.reduce((e, t) => {
        let { formatName: i, formatOptions: a } = Xt(t);
        if (this.formats[i]) {
          let t = e;
          try {
  ...
  tn = class extends It {
    constructor(e, t, n, r = {}) {
      (super(),
        ...
        (this.options = r),
        (this.logger = G.create(`backendConnector`)),
        (this.waitingReads = []),
  ...
  q = class e extends It {
    ...
    init(e = {}, t) {
      ...
      let n = nn();
      ((this.options = { ...n, ...this.options, ...rn(e) }),
      ...
      if (!this.options.isClone) {
        ...
        ((n.logger = G),
          ...
          (this.translator = new Ht(this.services, this.options)),
    ...
    loadResources(e, t = an) {
      let n = t,
        r = U(e) ? e : this.language;
      if (
    ...
    use(e) {
      ...
      return (
        ...
        e.type === `postProcessor` && Rt.addPostProcessor(e),
        ...
        a = (t) => {
          ...
          let n = U(t) ? t : t && t[0],
            a = this.store.hasLanguageSomeTranslations(n)
              ? n
              : this.services.languageUtils.getBestMatchFromCodes(U(t) ? [t] : t);
          (a &&
            (this.language || r(a),
      ...
      let i = r?.scopeNs,
        a = (e, t, ...r) => {
          ...
          (Array.isArray(i) && !s && (c.ns = i),
            typeof o.keyPrefix == `function` && (o.keyPrefix = K(o.keyPrefix, c)));
          let l = this.options.keySeparator || `.`,
            u;
          return (
            o.keyPrefix && Array.isArray(e)
              ? (u = e.map(
                  (e) => (typeof e == `function` && (e = K(e, c)), `${o.keyPrefix}${l}${e}`),
                ))
              : (typeof e == `function` && (e = K(e, c)),
                (u = o.keyPrefix ? `${o.keyPrefix}${l}${e}` : e)),
            this.t(u, o)
          );
        };
      return (U(e) ? (a.lng = e) : (a.lngs = e), (a.ns = t), (a.keyPrefix = n), a);
    }
    t(...e) {
    ...
    dir(e) {
      ...
      let t =
        ...
        n = this.services?.languageUtils || new Ut(nn());
    ...
    cloneInstance(t = {}, n = an) {
      ...
      if (
        ...
        let e = { ...nn().interpolation, ...this.options.interpolation, ...t.interpolation },
          n = { ...i, interpolation: e };
        a.services.interpolator = new Yt(n);
      }
      return (
        (a.translator = new Ht(a.services, i)),
        a.translator.on(`*`, (e, ...t) => {
          a.emit(e, ...t);
        }),
        a.init(i, n),
...
var sn = (e, t, n, r) => {
  ...
  cn = {},
  ln = (e, t, n, r) => {
    (J(n) && cn[n]) || (J(n) && (cn[n] = new Date()), sn(e, t, n, r));
  },
  un = (e, t) => () => {
  ...
  dn = (e, t, n) => {
    e.loadNamespaces(t, un(e, n));
  },
  fn = (e, t, n, r) => {
    if ((J(n) && (n = [n]), e.options.preload && e.options.preload.indexOf(t) > -1))
      return dn(e, n, r);
    (n.forEach((t) => {
      e.options.ns.indexOf(t) < 0 && e.options.ns.push(t);
    }),
      e.loadLanguages(t, un(e, r)));
  },
  pn = (e, t, n = {}) =>
    !t.languages || !t.languages.length
      ? (ln(t, `NO_LANGUAGES`, `i18n.languages were undefined or empty`, {
  ...
  wn = {
    type: `3rdParty`,
    init(e) {
      (yn(e.options.react), Sn(e));
    },
  },
  Tn = (0, z.createContext)(),
  En = class {
    constructor() {
      this.usedNamespaces = {};
    }
  ...
  Dn = {
    t: (e, t) => {
      if (J(t)) return t;
      if (mn(t) && J(t.defaultValue)) return t.defaultValue;
  ...
  kn = (e, t = {}) => {
    let { i18n: n } = t,
      { i18n: r, defaultNS: i } = (0, z.useContext)(Tn) || {},
      a = n || r || Cn();
    (a && !a.reportNamespaces && (a.reportNamespaces = new En()),
      a ||
        ln(
          a,
          `NO_I18NEXT_INSTANCE`,
    ...
    let o = (0, z.useMemo)(() => ({ ...bn(), ...a?.options?.react, ...t }), [a, t]),
    ...
    let f = (0, z.useRef)(0),
      ...
      h = (0, z.useCallback)(() => {
        if (!a) return Dn;
        let e = !!(a.isInitialized || a.initializedStoreOnce) && d.every((e) => pn(e, a, o)),
          n = t.lng || a.language,
          r = f.current,
          i = m.current;
      ...
      [g, _] = (0, z.useState)(0),
      { t: v, ready: y } = (0, mt.useSyncExternalStore)(p, h, h);
    (0, z.useEffect)(() => {
      if (a && !y && !s) {
        let e = () => _((e) => e + 1);
        t.lng ? fn(a, t.lng, d, e) : dn(a, d, e);
      }
    }, [a, t.lng, d, y, s, g]);
    let b = a || {},
      x = (0, z.useRef)(null),
    ...
    if (a && s && !y) {
      ...
      throw (
        ...
        new Promise((e) => {
          let n = () => e();
          t.lng ? fn(a, t.lng, d, n) : dn(a, d, n);
        })
      );
    }
    return w;
  };
function An({ i18n: e, defaultNS: t, children: n }) {
  let r = (0, z.useMemo)(() => ({ i18n: e, defaultNS: t }), [e, t]);
  return (0, z.createElement)(Tn.Provider, { value: r }, n);
}
var jn = {
    common: {
      brand: `أكاديميا`,
      ...
      theme: { light: `الوضع الفاتح`, dark: `الوضع الغامق`, auto: `تلقائي (حسب الجهاز)` },
    ...
    home: {
      ...
      roles: {
        student: { t: `طالب`, d: `Dashboard بمهام اليوم، إنجازك، وشاراتك.` },
        teacher: { t: `معلّم`, d: `ارفع محتواك، جهّز Quizzes، وتابع أداء شُعبك.` },
        parent: { t: `ولي أمر`, d: `تقرير أسبوعي مختصر عن الانتظام والإنجاز.` },
      },
      ctaTitle: `جاهز تبلّش؟`,
        ...
        groups: [
          {
            t: `المحتوى والتعلّم`,
            rows: [
              { l: `المكتبة الذكية وتصفح كل المواد`, free: !0, plus: !0 },
              { l: `حفظ الدروس بالمفضلة`, free: !0, plus: !0 },
              { l: `مجتمعات المواد وسؤال وجواب`, free: !0, plus: !0 },
              { l: `الجدول الدراسي التفاعلي`, free: !0, plus: !0 },
            ],
          },
          {
            t: `التحضير للامتحان`,
            rows: [
              { l: `محاكي الامتحان الوزاري بالذكاء الاصطناعي`, free: !1, plus: !0 },
              { l: `بنك أخطائي الخاص + التكرار المتباعد`, free: !1, plus: !0 },
              { l: `مراجعة الـ15 دقيقة (فلاش كاردز ذكية)`, free: !1, plus: !0 },
            ],
          },
          {
            t: `المتابعة والتقارير`,
            rows: [
              { l: `عدّاد إنجاز أساسي`, free: !0, plus: !0 },
              { l: `تقرير أسبوعي مفصّل لولي الأمر`, free: !1, plus: !0 },
              { l: `شهادات رقمية عند إتمام مادة`, free: !1, plus: !0 },
            ],
          },
          {
            t: `الدعم`,
            rows: [
              { l: `الدعم عبر مركز المساعدة`, free: !0, plus: !0 },
              { l: `دعم أولوية عبر البريد الإلكتروني`, free: !1, plus: !0 },
            ],
          },
        ],
      },
    ...
    privacy: {
      ...
      sections: [
        ...
        { t: `تواصل معنا`, d: `[TBD: بريد إلكتروني أو جهة اتصال مخصصة لاستفسارات الخصوصية]` },
      ],
    },
    terms: {
      h1: `شروط الاستخدام`,
      ...
      sections: [
        ...
        { t: `القانون الحاكم`, d: `[TBD — يُحدَّد مع المحامي حسب بلد التأسيس والتشغيل]` },
      ],
    },
    forbidden: {
      code: `403`,
  ...
  Mn = {
    common: {
      ...
      theme: { light: `Light mode`, dark: `Dark mode`, auto: `Auto (system)` },
    ...
    home: {
      ...
      roles: {
        ...
        parent: { t: `Parent`, d: `A short weekly report on consistency and achievement.` },
      },
        ...
        groups: [
          {
            t: `Content & learning`,
            rows: [
              { l: `Smart library across all subjects`, free: !0, plus: !0 },
              { l: `Save lessons to favorites`, free: !0, plus: !0 },
              { l: `Subject communities & Q&A`, free: !0, plus: !0 },
              { l: `Interactive study schedule`, free: !0, plus: !0 },
            ],
          },
          {
            t: `Exam preparation`,
            rows: [
              { l: `AI-powered ministerial exam simulator`, free: !1, plus: !0 },
              { l: `Personal mistake bank + spaced repetition`, free: !1, plus: !0 },
              { l: `15-minute review (smart flashcards)`, free: !1, plus: !0 },
            ],
          },
          {
            t: `Tracking & reports`,
            rows: [
              { l: `Basic achievement counter`, free: !0, plus: !0 },
              { l: `Detailed weekly parent report`, free: !1, plus: !0 },
              { l: `Digital certificates on subject completion`, free: !1, plus: !0 },
            ],
          },
          {
            t: `Support`,
            rows: [
              { l: `Help center support`, free: !0, plus: !0 },
              { l: `Priority email support`, free: !1, plus: !0 },
            ],
          },
        ],
      },
    ...
    privacy: {
      ...
      sections: [
        ...
        { t: `Contact Us`, d: `[TBD: a dedicated email or contact point for privacy inquiries]` },
      ],
    },
    terms: {
      h1: `Terms of Service`,
  ...
  Nn = {
    ...
    authPages: {
      ...
      signup: {
        ...
        roles: {
          student: { t: `طالب`, d: `مكتبة مرتّبة، جدول دراسي، متابعة إنجاز، ومحاكي امتحان.` },
          parent: { t: `ولي أمر`, d: `تقرير أسبوعي مختصر عن انتظام ابنك ونسبة إنجازه.` },
          teacher: {
            t: `معلّم`,
    ...
    about: {
      ...
      values: [
        ...
        { t: `عربي أولاً`, d: `واجهة RTL مصمّمة بالعربية من الصفر، وإنجليزية كاملة كخيار ثانٍ.` },
        {
      ...
      team: [
        { t: `المنتج والتصميم`, d: `أبحاث مع طلاب حقيقيين قبل أي شاشة نطلقها.` },
        { t: `الهندسة`, d: `منصة سريعة تشتغل على شبكات ضعيفة وأجهزة متوسطة.` },
        { t: `المحتوى الأكاديمي`, d: `معلّمون يراجعون التصنيف وبنك الأسئلة قبل النشر.` },
      ],
    ...
    teacherProfile: {
      ...
      reviews: [
        { n: `طالب توجيهي علمي`, d: `الشرح مرتّب والأسئلة بعد كل درس خلّتني أثبت المعلومة.` },
        { n: `طالبة توجيهي عام`, d: `أول مرة ما أضيع بين الملفات — كل وحدة بمكانها.` },
      ],
  ...
  Pn = {
    ...
    about: {
      ...
      team: [
        { t: `Product & design`, d: `Research with real students before any screen ships.` },
        {
          t: `Engineering`,
...
q.isInitialized ||
  q
    .use(wn)
    .init({
      resources: { ar: { translation: Ln(jn, Nn) }, en: { translation: Ln(Mn, Pn) } },
      lng: `ar`,
      fallbackLng: `ar`,
      supportedLngs: Fn,
...
var Rn = q,
  ...
  Bn = `acadimia.locale`,
  Vn = `(function(){try{
var t=localStorage.getItem("${zn}")||"auto";
var d=t==="dark"||(t!=="light"&&window.matchMedia("(prefers-color-scheme: dark)").matches);
var r=document.documentElement;
r.setAttribute("data-theme",d?"dark":"light");
r.classList.toggle("dark",d);
var q=new URLSearchParams(window.location.search).get("lang");
var l=q==="ar"||q==="en"?q:(localStorage.getItem("${Bn}")||"ar");
if(l!=="ar"&&l!=="en")l="ar";
...
var Un = (0, z.createContext)(null);
function Wn(e) {
  if (typeof window > `u`) return;
  let t = new URL(window.location.href);
  (e === `en` ? t.searchParams.set(`lang`, `en`) : t.searchParams.delete(`lang`),
...
function Kn() {
  ...
  if (e && Fn.includes(e)) return e;
  let t = localStorage.getItem(Bn);
  return t && Fn.includes(t) ? t : `ar`;
}
function qn({ children: e }) {
  let { i18n: t } = kn(),
    [n, r] = (0, z.useState)(Gn),
    [i, a] = (0, z.useState)(() => (Hn(Gn()) ? `dark` : `light`)),
    [o, s] = (0, z.useState)(Kn),
    [c, l] = (0, z.useState)(!1);
  ((0, z.useEffect)(() => {
    if (n !== `auto`) return;
    let e = window.matchMedia(`(prefers-color-scheme: dark)`),
      t = () => a(e.matches ? `dark` : `light`);
    return (t(), e.addEventListener(`change`, t), () => e.removeEventListener(`change`, t));
  }, [n]),
    (0, z.useEffect)(() => {
      let e = document.documentElement;
      (e.setAttribute(`data-theme`, i), e.classList.toggle(`dark`, i === `dark`));
    }, [i]),
    (0, z.useEffect)(() => {
      let e = document.documentElement;
      (e.setAttribute(`lang`, o),
        e.setAttribute(`dir`, In[o]),
        t.language !== o && t.changeLanguage(o));
    }, [o, t]));
  let u = (0, z.useCallback)((e) => {
      (r(e), a(Hn(e) ? `dark` : `light`), localStorage.setItem(zn, e));
    }, []),
    d = (0, z.useCallback)((e) => {
      let t = (e) => {
        (localStorage.setItem(Bn, e), Wn(e));
      };
      ...
      (l(!0),
        window.setTimeout(() => {
          (s(e), t(e), window.setTimeout(() => l(!1), 240));
        }, 220));
    }, []),
    f = (0, z.useMemo)(
      () => ({
        ...
        resolvedTheme: i,
        setTheme: u,
        toggleTheme: () => u(i === `dark` ? `light` : `dark`),
        locale: o,
        setLocale: d,
        toggleLocale: () => d(o === `ar` ? `en` : `ar`),
        dir: In[o],
        switchingLocale: c,
      }),
      [n, i, u, o, d, c],
    );
  return (0, B.jsxs)(Un.Provider, {
    value: f,
    children: [
      (0, B.jsx)(`div`, {
        "data-locale-switching": c ? `true` : `false`,
...
function Jn({ children: e }) {
  return (0, B.jsx)(An, { i18n: Rn, children: (0, B.jsx)(qn, { children: e }) });
}
function Yn() {
  let e = (0, z.useContext)(Un);
  if (!e) throw Error(`usePreferences must be used inside PreferencesProvider`);
  return e;
}
var Xn =
    `https://ziadkamalaln2842-001-site1.etempurl.com`.replace(/\/+$/, ``) ??
  ...
  Y = class extends Error {
    ...
    constructor(e, t, n, r) {
      (super(e),
        ...
        (this.status = t),
        (this.kind = n),
        (this.userMessage = r ?? e));
    }
  };
function Qn() {
  return typeof document > `u` ? `ar` : document.documentElement.lang === `en` ? `en` : `ar`;
}
function $n(e, t) {
  let n = Qn() === `ar`;
  if (e === `network`)
  ...
  switch (t) {
    ...
    case 403:
      return n ? `ليس لديك صلاحية للقيام بهذا الإجراء.` : `You don't have permission to do this.`;
    case 404:
      return n ? `لم يتم العثور على البيانات المطلوبة.` : `The requested data couldn't be found.`;
    case 409:
      return n
...
async function er(e, t = {}) {
  let { json: n, headers: r, ...i } = t,
    a = new AbortController(),
    o = setTimeout(() => a.abort(), Zn),
    s;
  try {
    s = await fetch(`${Xn}${e}`, {
      ...i,
      ...
      body: n === void 0 ? i.body : JSON.stringify(n),
    });
  } catch (e) {
    let t = e instanceof DOMException && e.name === `AbortError` ? `timeout` : `network`;
    throw new Y(e instanceof Error ? e.message : String(e), 0, t, $n(t, 0));
  } finally {
    clearTimeout(o);
  }
  let c = await s.text(),
  ...
  if (c)
    try {
      ...
      if (!s.ok) throw new Y(c || s.statusText, s.status, `parse`, $n(`parse`, s.status));
      l = c;
    }
  if (!s.ok) {
    let e = l && typeof l == `object` && `message` in l ? l.message : void 0,
      t = e || `${s.status} ${s.statusText}`,
      n = e?.trim() || $n(`http`, s.status);
    throw new Y(t, s.status, `http`, n);
  }
  return l;
}
var X = {
    get: (e) => er(e, { method: `GET` }),
    post: (e, t) => er(e, { method: `POST`, json: t }),
    delete: (e) => er(e, { method: `DELETE` }),
  },
  tr = {
...
function rr(e, t) {
  throw Error(Qn() === `ar` ? e : t);
}
var ir = `academia.auth`,
  ar = `academia-auth-changed`,
  or = `academia_demo_user`;
function Z() {
  ...
  typeof window > `u` ||
    (e
      ? (localStorage.setItem(ir, JSON.stringify(e)),
        (document.cookie = `${or}=${encodeURIComponent(e.userId)}; path=/; max-age=86400; samesite=lax`))
      : (localStorage.removeItem(ir),
        (document.cookie = `${or}=; path=/; max-age=0; samesite=lax`)),
    window.dispatchEvent(new Event(ar)));
}
function cr(e) {
  let t = e?.myProfileDto ?? e?.MyProfileDto;
  if (!t || typeof t != `object`) return null;
  let n = typeof t.id == `string` ? t.id : ``,
    r = typeof t.name == `string` ? t.name : ``,
    i = typeof t.email == `string` ? t.email : ``;
  return !n || !r || !i
    ? null
    : {
        id: n,
        ...
        genderId: typeof t.genderId == `number` ? t.genderId : null,
...
async function lr(e) {
  try {
    let t = await X.get(`/api/User/CreateEditModal?id=${encodeURIComponent(e)}`),
      n = t?.user ?? t?.User;
    return {
      roleId: typeof n?.userTypeId == `number` ? n.userTypeId : null,
      roleName: typeof n?.userType?.name == `string` ? n.userType.name : null,
    };
  } catch {
...
async function ur(e, t) {
  let n = await X.post(`/api/Auth/Login`, { email: e, password: t, returnUrl: `` });
  if (!n?.success) throw Error(n?.message || `تعذّر تسجيل الدخول`);
  let r = await X.get(`/api/User/MyProfileModal`),
    i = cr(r);
  if (!i)
    throw (
      console.error(`MyProfileModal payload لم يطابق الشكل المتوقع:`, r),
      Error(`تم تسجيل الدخول، لكن تعذّر التحقق من الملف الشخصي`)
    );
  let a = await lr(i.id);
  ((i.roleId = a.roleId),
    (i.roleName = a.roleName),
    sr({ email: i.email, loggedInAt: Date.now(), userId: i.id, isDemo: !1, profile: i }));
}
function dr(e) {
  throw Error(`الدخول التجريبي متاح في بيئة التطوير فقط`);
}
function fr() {
  return Z()?.isDemo === !0;
}
async function pr() {
  if (typeof window > `u` || fr()) return !1;
  try {
    let e = cr(await X.get(`/api/User/MyProfileModal`));
    if (!e) return !1;
    let t = Z();
    return (
      sr({
        email: e.email,
        loggedInAt: t?.loggedInAt ?? Date.now(),
        userId: e.id,
        isDemo: !1,
        profile: e,
      }),
    ...
    return (e instanceof Y && [401, 403].includes(e.status) && sr(null), !1);
  }
}
async function mr() {
  let e = Z()?.isDemo;
  try {
    e || (await X.post(`/api/Auth/Logout`));
  } catch (e) {
    e instanceof Y || console.error(e);
  } finally {
    sr(null);
  }
}
...
function yr() {
  let e = Z();
  return e?.isDemo === !1 && e.profile?.roleId === 1;
}
function br() {
  let { locale: e } = Yn();
  return (t, n) => (e === `en` ? n : t);
...
function Cr(e, t) {
  return Sr[t].some((t) => e === t || e.startsWith(t));
}
function wr(e, t = !1) {
  return e && xr[e] ? xr[e] : t ? `admin` : `student`;
}
var Tr = {
  student: `/dashboard`,
...
function Q(e) {
  return jr.filter((t) => t.module_id === e);
}
function $(e) {
  return e.flatMap((e) => kr.map((t) => `${e.id}:${t.key}`));
}
(new Set($(jr)),
  new Set($([...Q(`m-supervisor`), ...Q(`m-account`)])),
  new Set($([...Q(`m-teacher`), ...Q(`m-account`)])),
  new Set($([...Q(`m-parent`), ...Q(`m-account`)])),
  new Set($([...Q(`m-student`), ...Q(`m-account`)])));
var Nr = [
  {
    id: `u-admin`,
    full_name: `الأدمن`,
