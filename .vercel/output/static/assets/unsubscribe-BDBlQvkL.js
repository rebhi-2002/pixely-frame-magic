...
import { t as a } from "./mail-x-Bg8EUHIZ.js";
import { B as o } from "./index-CUZEShOB.js";
import { n as s } from "./public-layout-BGA3sCZD.js";
var c = i(n()),
  l = t(),
  u = [`weekly`, `reminders`, `community`, `marketing`];
function d() {
  let { t } = r(),
    [n, i] = (0, c.useState)(``),
    [d, f] = (0, c.useState)([]),
    ...
    children: (0, l.jsxs)(`section`, {
      ...
      children: [
        (0, l.jsx)(`span`, {
          ...
          children: (0, l.jsx)(a, { className: `size-6` }),
        }),
        (0, l.jsx)(`h1`, {
        ...
        (0, l.jsxs)(`form`, {
          ...
          onSubmit: (e) => {
            (e.preventDefault(), m(!0), o.success(t(`unsubscribe.done`)));
          },
          children: [
            (0, l.jsxs)(`div`, {
              children: [
                    ...
                    `label`,
                    {
                      ...
                      children: [
                        (0, l.jsx)(`input`, {
                          ...
                          onChange: (t) =>
                            f((n) => (t.target.checked ? [...n, e] : n.filter((t) => t !== e))),
                          className: `size-4 accent-[var(--color-primary)]`,
                        }),
                        t(`unsubscribe.options.${e}`),
                      ],
                    },
                    e,
                  ),
                ...
                (0, l.jsxs)(`label`, {
                  ...
                  children: [
                    (0, l.jsx)(`input`, {
                      type: `checkbox`,
                      checked: h,
                      onChange: (e) => f(e.target.checked ? [...u] : []),
                      className: `size-4 accent-[var(--color-primary)]`,
                    }),
                    t(`unsubscribe.all`),
                  ],
