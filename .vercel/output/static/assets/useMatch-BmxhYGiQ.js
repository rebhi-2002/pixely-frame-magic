import { N as e, P as t, ht as n, mt as r, tt as i, vt as a } from "./rbac-static-data-Cz2qa6wH.js";
var o = a(n(), 1),
...
function u(e, t) {
  ...
  return (i) => {
    ...
    return (e?.structuralSharing ?? t.options.defaultStructuralSharing)
      ? (n.current = r(n.current, a))
      : a;
  };
}
function d(n) {
  let r = t(),
    a = o.useContext(n.from ? c : s),
    d = n.from ?? a,
    f = r.stores.getMatchStore(d),
    p = u(n, r),
    m = e(f, (e) => (e ? p(e) : l));
  if (m !== l) return m;
  (n.shouldThrow ?? !0) && i();
