import { ht as e, j as t, vt as n } from "./rbac-static-data-Cz2qa6wH.js";
import { b as r, c as i, d as a, g as o, o as s, x as c } from "./query-DmDC6lXh.js";
import { V as l } from "./index-CUZEShOB.js";
...
function f(e, n) {
  ...
  let a = d.useSyncExternalStore(
      d.useCallback((e) => i.subscribe(s.batchCalls(e)), [i]),
      () => i.getCurrentResult(),
      () => i.getCurrentResult(),
    ),
    l = d.useCallback(
      (...e) => {
        i.mutate(e[0], e[1]).catch(o);
      },
      [i],
    );
  if (a.error && c(i.options.throwOnError, [a.error])) throw a.error;
