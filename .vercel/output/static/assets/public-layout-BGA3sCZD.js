...
import {
  ...
  t as h,
  u as g,
} from "./dist-LHEW5aEh.js";
import { t as _ } from "./utils-DojpP95n.js";
import { a as v, c as y, i as b, n as x, o as S, r as C, s as w, t as T } from "./dist-CJVfaj2u.js";
import { t as E } from "./use-session-CMsGjsyr.js";
import { n as D, r as O, t as k } from "./use-sign-out-CNBnA5pU.js";
import { t as A } from "./page-transition-1bN-KoDq.js";
var j = o(r()),
  M = n(),
  N = `inline-flex size-9 items-center justify-center rounded-lg border border-border bg-card text-muted-foreground transition-colors hover:text-foreground`;
function P() {
  let { t } = i(),
    { resolvedTheme: n, toggleTheme: r } = e();
  return (0, M.jsx)(`button`, {
    type: `button`,
    onClick: r,
    "aria-label": t(`common.themeToggle`),
    title: t(n === `dark` ? `common.theme.light` : `common.theme.dark`),
    className: N,
    children:
      n === `dark`
        ? (0, M.jsx)(f, { className: `size-4` })
        : (0, M.jsx)(c, { className: `size-4` }),
  });
}
function F() {
  let { t } = i(),
    { locale: n, toggleLocale: r } = e();
  return (0, M.jsxs)(`button`, {
    type: `button`,
    onClick: r,
    "aria-label": t(`common.languageToggle`),
    title: t(n === `ar` ? `common.language.en` : `common.language.ar`),
    className: `${N} w-auto gap-1.5 px-2.5 text-xs font-bold`,
    children: [(0, M.jsx)(u, { className: `size-4` }), n === `ar` ? `EN` : `AR`],
  });
}
function I({ className: e = `` }) {
  return (0, M.jsxs)(`div`, {
    className: `flex items-center gap-2 ${e}`,
    children: [(0, M.jsx)(P, {}), (0, M.jsx)(F, {})],
  });
}
var L = `flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-sm font-semibold text-foreground/80 transition-all duration-200 hover:translate-x-0 hover:bg-secondary hover:text-foreground rtl:hover:-translate-x-0.5 ltr:hover:translate-x-0.5`;
function R({ session: n }) {
  let { t: r } = i(),
    [a, o] = (0, j.useState)(!1),
    s = (0, j.useRef)(null),
    { signOut: d, pending: h } = D(`/`),
    { resolvedTheme: _, toggleTheme: v, locale: y, toggleLocale: b } = e();
  (0, j.useEffect)(() => {
    if (!a) return;
    let e = (e) => {
  ...
  let x = n.fullName.trim().charAt(0) || `A`;
  return (0, M.jsxs)(`div`, {
    ref: s,
    className: `relative`,
    children: [
      ...
      (0, M.jsxs)(`button`, {
        ...
        children: [
          ...
          (0, M.jsx)(p, {
            className: `size-4 text-muted-foreground transition-transform duration-200 ${a ? `rotate-180` : ``}`,
          }),
        ],
      }),
      a &&
          ...
          children: [
            ...
            (0, M.jsxs)(`div`, {
              ...
              children: [
                (0, M.jsxs)(t, {
                  ...
                  className: L,
                  children: [
                    (0, M.jsx)(l, { className: `size-4 text-primary` }),
                    r(`common.dashboard`),
                  ],
                }),
                (0, M.jsxs)(t, {
                  ...
                  onClick: () => o(!1),
                  className: L,
                  children: [(0, M.jsx)(m, { className: `size-4` }), r(`common.settings`)],
                }),
                (0, M.jsxs)(`button`, {
                  type: `button`,
                  onClick: v,
                  ...
                  children: [
                    _ === `dark`
                      ? (0, M.jsx)(f, { className: `size-4` })
                      : (0, M.jsx)(c, { className: `size-4` }),
                    r(_ === `dark` ? `common.theme.light` : `common.theme.dark`),
                  ],
                }),
                (0, M.jsxs)(`button`, {
                  type: `button`,
                  ...
                  className: L,
                  children: [
                    (0, M.jsx)(u, { className: `size-4` }),
                    r(y === `ar` ? `common.language.en` : `common.language.ar`),
                  ],
                }),
              ],
            }),
            (0, M.jsx)(`div`, {
              ...
              children: (0, M.jsxs)(`button`, {
                type: `button`,
                onClick: () => void d(),
                className: `${L} text-destructive hover:bg-destructive/10 hover:text-destructive`,
                children: [
                  (0, M.jsx)(g, { className: `size-4` }),
                  r(h ? `common.signingOut` : `common.signOut`),
                ],
              }),
            }),
          ],
...
var B = T,
  V = y,
  H = S,
  U = j.forwardRef(({ className: e, ...t }, n) =>
    (0, M.jsx)(v, {
      className: _(
...
var W = h(
  ...
  G = j.forwardRef(({ side: e = `end`, className: t, children: n, ...r }, i) =>
    (0, M.jsxs)(H, {
      children: [
        (0, M.jsx)(U, {}),
        (0, M.jsxs)(C, {
          ref: i,
          className: _(W({ side: e }), t),
          ...r,
          children: [
            (0, M.jsxs)(x, {
...
var K = ({ className: e, ...t }) =>
  (0, M.jsx)(`div`, { className: _(`flex flex-col space-y-2 text-start`, e), ...t });
K.displayName = `SheetHeader`;
var q = j.forwardRef(({ className: e, ...t }, n) =>
  (0, M.jsx)(w, { ref: n, className: _(`text-lg font-semibold text-foreground`, e), ...t }),
);
q.displayName = w.displayName;
var J = j.forwardRef(({ className: e, ...t }, n) =>
  (0, M.jsx)(b, { ref: n, className: _(`text-sm text-muted-foreground`, e), ...t }),
);
...
function $({ children: e }) {
  let { t: n } = i(),
    { session: r, isSignedIn: o } = E(),
    [s, c] = (0, j.useState)(!1),
    u = z(),
    f = a(r?.roleKey ?? null),
    p = (e) => (f ? e.filter((e) => f.includes(e.to)) : e),
    m = p(Y);
  return (0, M.jsxs)(`div`, {
    ...
    children: [
      (0, M.jsx)(`a`, {
        ...
        children: n(`common.skipToContent`),
      }),
      (0, M.jsx)(`header`, {
        className: _(
                  ...
                  children: [
                    (0, M.jsx)(V, {
                      ...
                      children: (0, M.jsx)(`button`, {
                        ...
                        children: (0, M.jsx)(d, { "aria-hidden": `true`, className: `size-5` }),
                      }),
                    }),
                    (0, M.jsxs)(G, {
                      side: `start`,
                      ...
                      children: [
                        (0, M.jsxs)(K, {
                          ...
                          children: [
                            (0, M.jsx)(q, { children: n(`common.menu`) }),
                            (0, M.jsx)(J, { children: n(`nav.tagline`) }),
                          ],
                        }),
                        (0, M.jsx)(`nav`, {
                          ...
                          children: [
                            o && r
                              ? (0, M.jsxs)(t, {
                                  ...
                                  children: [
                                    (0, M.jsx)(l, { "aria-hidden": `true`, className: `size-4` }),
                                    n(`common.dashboard`),
                                  ],
                                })
                              : (0, M.jsxs)(M.Fragment, {
                                  children: [
                                    ...
                                    (0, M.jsx)(t, {
                                      ...
                                      children: n(`common.startFree`),
                                    }),
                                  ],
                                }),
                            (0, M.jsx)(I, { className: `justify-center pt-2` }),
                          ],
                        }),
                      ],
                    }),
                  ...
                  ? (0, M.jsxs)(M.Fragment, {
                      children: [
                        (0, M.jsxs)(t, {
                          ...
                          children: [(0, M.jsx)(l, { className: `size-4` }), n(`common.dashboard`)],
                        }),
                        (0, M.jsx)(R, { session: r }),
                      ],
                    })
      ...
      (0, M.jsxs)(`footer`, {
        ...
        children: [
          ...
          (0, M.jsx)(`div`, {
            ...
            children: n(`nav.rights`, { year: new Date().getFullYear() }),
          }),
        ],
      }),
    ],
