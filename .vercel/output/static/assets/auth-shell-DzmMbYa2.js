...
import { t as o } from "./book-open-check-BWMykzZm.js";
import { t as s } from "./chart-line-C5wyEOtC.js";
import { t as c } from "./circle-x-Bx80P6i_.js";
import { n as l, t as u } from "./eye-CI3qPTRW.js";
import { R as d } from "./index-CUZEShOB.js";
import { r as f, t as p } from "./public-layout-BGA3sCZD.js";
var m = a(n()),
  h = t(),
  g = [
    { icon: o, ar: `مكتبة ذكية منظّمة حسب المنهاج`, en: `A smart library organized by curriculum` },
    { icon: s, ar: `متابعة تقدّم يومية بدون تعقيد`, en: `Simple daily progress tracking` },
    { icon: c, ar: `بنك أخطاء يذكّرك بنقاط ضعفك`, en: `A mistake bank that flags your weak spots` },
  ];
function _({ icon: t, title: n, subtitle: a, children: o, wide: s = !1 }) {
  let { t: c } = r(),
    l = i();
  return (0, h.jsxs)(`div`, {
        ...
        children: (0, h.jsxs)(`div`, {
          ...
          children: [
            (0, h.jsxs)(`div`, {
              ...
              children: [
                (0, h.jsx)(d, { className: `h-40 w-auto` }),
                (0, h.jsx)(`h2`, {
                      ...
                      `li`,
                      {
                        ...
                        children: [
                          (0, h.jsx)(`span`, {
                            ...
                            children: (0, h.jsx)(e.icon, { className: `size-4` }),
                          }),
                          (0, h.jsx)(`span`, {
                            className: `text-sm text-muted-foreground`,
                            children: l(e.ar, e.en),
                          }),
                        ],
                      },
                      e.ar,
            ...
            (0, h.jsxs)(`div`, {
              className: `shadow-elevation-2 mx-auto w-full rounded-2xl border border-border bg-card p-6 sm:p-8 ${s ? `max-w-md sm:max-w-2xl lg:max-w-none` : `max-w-md lg:max-w-md`}`,
              children: [
                (0, h.jsxs)(`div`, {
...
function v({
  ...
  let f = i(),
    [p, g] = (0, m.useState)(!1),
    _ = a === `password`,
    v = [c && `${e}-hint`, d && `${e}-error`].filter(Boolean).join(` `) || void 0;
  return (0, h.jsxs)(`div`, {
      ...
      (0, h.jsxs)(`div`, {
        ...
        children: [
          ...
          _ &&
            (0, h.jsx)(`button`, {
              type: `button`,
              "aria-label": f(`إظهار كلمة المرور`, `Show password`),
              title: f(`إظهار كلمة المرور`, `Show password`),
              onClick: () => g((e) => !e),
              ...
              children: p
                ? (0, h.jsx)(l, { "aria-hidden": `true`, className: `size-4` })
                : (0, h.jsx)(u, { "aria-hidden": `true`, className: `size-4` }),
            }),
        ],
      }),
      c &&
