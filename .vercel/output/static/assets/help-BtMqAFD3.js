...
import { t as a } from "./life-buoy-DX36YntD.js";
import { t as o } from "./search-CKHPlqGH.js";
import { n as s } from "./public-layout-BGA3sCZD.js";
var c = i(n()),
  l = t();
function u() {
  let { t } = r(),
    n = t(`help.topics`, { returnObjects: !0 }),
    [i, u] = (0, c.useState)(``),
    d = i.trim(),
    f = n
      .map((e) => ({
        ...e,
        items: d ? e.items.filter((e) => e.q.includes(d) || e.a.includes(d)) : e.items,
      }))
