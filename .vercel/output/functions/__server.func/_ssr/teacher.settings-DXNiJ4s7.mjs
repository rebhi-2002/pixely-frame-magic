...
import { c as QuickLinks, l as RowList, o as Panel, t as AppPage, u as StatGrid } from "./kit--a5tGQyM.mjs";
...
import { a as getTeacherSettings, f as saveTeacherSettings } from "./account-pages.functions-C_UOsBTW.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.settings-DXNiJ4s7.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "التسعير، أوقات التوفّر، بيانات الدفع، وتفضيلات الإشعارات.";
function PageRoute() {
