...
//#region node_modules/.nitro/vite/services/ssr/assets/route-B7KxppcB.js
...
function AppSidebar({ access, collapsed, onToggle, onClose, onNavigate }) {
  ...
  const activeModuleKeys = (0, import_react.useMemo)(
    () =>
      access.modules
  ...
  const effectiveOpenModules = Array.from(
    /* @__PURE__ */ new Set([...openModules, ...activeModuleKeys]),
        ...
        children: [
          ...
          onClose &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
              ...
              className:
                "text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-foreground md:hidden",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
            ...
            className:
              "hidden text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-foreground md:inline-flex",
            children: collapsed
              ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PanelRightOpen, { className: "size-5" })
              : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PanelRightClose, {
                  className: "size-5",
                }),
          }),
        ],
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, {
                  className:
                    "pointer-events-none absolute start-3 top-1/2 size-4 -translate-y-1/2 text-sidebar-foreground/50",
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
                  ...
                  className:
                    "h-9 border-sidebar-border bg-sidebar-accent ps-9 text-sidebar-foreground placeholder:text-sidebar-foreground/50",
                }),
              ],
            }),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "li",
                    {
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                        ...
                        onClick: () => setSearch(""),
                        className:
                          "block rounded-md px-2 py-1.5 text-xs hover:bg-sidebar-primary/20",
                        children: [
        ...
        children: [
          !collapsed &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
              className:
                "px-3 pb-1.5 text-[11px] font-bold tracking-wide text-sidebar-foreground/45",
                ...
                children: [
                  ...
                  collapsed &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
                      ...
                      children: collectLeaves(m.pages).map((p) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          "li",
                          {
                  ...
                  collapsed &&
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "panel-swap absolute top-0 z-50 w-56 rounded-xl border border-sidebar-border bg-sidebar p-2 shadow-xl ltr:left-full ltr:ml-2 rtl:right-full rtl:mr-2",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
          ...
          "li",
          {
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                ...
                className:
                  "flex w-full items-center gap-2 rounded-lg px-3 py-2 text-[13px] transition-colors hover:bg-sidebar-accent hover:text-sidebar-foreground",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DynamicIcon, {
                    name: p.icon,
                    className: "size-4 shrink-0",
                  ...
                  open
                    ...
                    : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeft, {
                        className: "size-3.5 rtl:rotate-0 ltr:rotate-180",
                      }),
                ],
              }),
              open &&
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "shadow-elevation-1 sticky top-0 z-30 flex h-12 items-center border-b border-border bg-background/90 px-3 backdrop-blur md:hidden",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                variant: "ghost",
                size: "icon",
