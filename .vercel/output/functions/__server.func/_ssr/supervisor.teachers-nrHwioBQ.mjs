...
import { f as description$11 } from "./router-ClmuBdEg.mjs";
...
import { i as EmptyState, n as Badge, o as Panel, r as DataTable, t as AppPage, u as StatGrid } from "./kit-CS2UTmaS.mjs";
...
import { c as listTeacherPerformance, d as saveTeacherPerformance, r as deleteTeacherPerformance } from "./supervisor-oversight.functions-B1x3Gg4c.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/supervisor.teachers-nrHwioBQ.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Presentation",
		subtitle: bi(description$11, "Per-teacher performance: response time, grading speed and student mastery."),
		children: [
