...
import {
  a as TEACHER_SETTINGS,
  i as TEACHER_PROFILE,
  n as NOTIFICATIONS,
  o as nextAccountId,
  r as PARENT_NOTIFICATION_PREFS,
  t as LINKED_CHILDREN,
} from "./account-pages-data-DAenjrEL.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/account-pages.functions-BSyaU1AF.js
...
var getTeacherSettings = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(getTeacherSettings_createServerFn_handler, async ({ context }) => {
...
var saveTeacherSettings = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  ...
  .handler(saveTeacherSettings_createServerFn_handler, async ({ data, context }) => {
...
var getTeacherProfile = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(getTeacherProfile_createServerFn_handler, async ({ context }) => {
...
var saveTeacherProfile = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
  ...
  .handler(saveTeacherProfile_createServerFn_handler, async ({ data, context }) => {
...
var listLinkedChildren = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listLinkedChildren_createServerFn_handler, async ({ context }) => {
...
var addLinkedChild = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
  ...
  .handler(addLinkedChild_createServerFn_handler, async ({ data, context }) => {
...
var unlinkChild = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(unlinkChild_createServerFn_handler, async ({ data, context }) => {
...
var getParentNotificationPrefs = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(getParentNotificationPrefs_createServerFn_handler, async ({ context }) => {
    await requirePageAction(context.userId, "parent_settings", "view_list");
...
var saveParentNotificationPrefs = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
  ...
  .handler(saveParentNotificationPrefs_createServerFn_handler, async ({ data, context }) => {
...
var listNotifications = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listNotifications_createServerFn_handler, async ({ context }) => {
...
var markNotificationRead = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(markNotificationRead_createServerFn_handler, async ({ data, context }) => {
...
var markAllNotificationsRead = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .handler(markAllNotificationsRead_createServerFn_handler, async ({ context }) => {
    await requirePageAction(context.userId, "notifications", "edit");
...
var deleteNotification = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteNotification_createServerFn_handler, async ({ data, context }) => {
...
//#endregion
export {
  addLinkedChild_createServerFn_handler,
  deleteNotification_createServerFn_handler,
  getParentNotificationPrefs_createServerFn_handler,
  getTeacherProfile_createServerFn_handler,
  getTeacherSettings_createServerFn_handler,
  listLinkedChildren_createServerFn_handler,
  ...
  saveParentNotificationPrefs_createServerFn_handler,
  saveTeacherProfile_createServerFn_handler,
  saveTeacherSettings_createServerFn_handler,
  unlinkChild_createServerFn_handler,
};
