...
import { c as saveContentItem, i as listContentItems, t as deleteContentItem } from "./teacher-teaching.functions-D_QDlVah.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.content-sCMVaxnt.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "دروسك وملفاتك: أضفها، رتّبها على شجرة المنهاج، وتابع حالة مراجعتها.";
function PageRoute() {
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "FileStack",
		subtitle: bi(description, "Your lessons and files: upload, place on the curriculum tree, submit for review."),
		children: [
