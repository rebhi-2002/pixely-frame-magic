...
import { d as saveBadge, o as listBadges, t as deleteBadge } from "./student-evaluation.functions-_PI2B2JK.mjs";
import { a as getStudyStats, c as listLibrarySubjects } from "./student-learning.functions-OnB3dj69.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/achievements-C-uJNqhD.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "تقدّمك يُقاس بالإتقان لا بالساعات: شارات، سلاسل أيام، ونسب إتقان لكل مادة.";
function PageRoute() {
