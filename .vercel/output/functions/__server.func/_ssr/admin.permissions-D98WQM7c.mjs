...
import { H as LoaderCircle, v as Settings2 } from "../_libs/lucide-react.mjs";
import { n as useServerFn } from "./createSsrRpc-Deneh4is.mjs";
import { a as listRoles } from "./use-access-BL6Bw5Ej.mjs";
import { n as Guard } from "./guard-Dpfucbbc.mjs";
import { t as PageHeader } from "./page-header-B-hD-LLI.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin.permissions-D98WQM7c.js
              ...
              children: (data ?? []).map((role) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  Link,
                  {
                    ...
                    className:
                      "hover-lift group rounded-2xl border border-border bg-card p-4 transition-colors hover:border-primary/50",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            className:
                              "grid size-9 place-items-center rounded-xl bg-primary/12 text-primary",
