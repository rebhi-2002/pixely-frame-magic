...
import { a as getCommunityStats, c as listCommunityQuestions, f as saveCommunityQuestion, n as deleteCommunityQuestion } from "./student-social.functions-u1FVOSpN.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/community-CgRAFu1t.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "سجّل أسئلتك بكل مادة، وتابع حالتها لحد ما توصلك إجابة.";
function PageRoute() {
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "MessagesSquare",
		subtitle: bi(description, "Log your questions per subject, and track their status until answered."),
		children: [
