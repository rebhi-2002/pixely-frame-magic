    ...
    children: blocks.map((block, i) => {
          ...
          "ul",
          {
            ...
            children: block.items.map((item) =>
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                ...
                {
                  className:
                    "flex items-start gap-2.5 text-[15px] leading-[1.9] text-foreground/90",
                  children: [
      ...
      if (block.type === "quote")
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          {
            className:
              "border-primary rounded-e-xl border-s-4 bg-primary/6 px-5 py-4 text-[15px] font-semibold leading-[1.9] text-foreground",
            children: block.text,
          },
          i,
        );
...
function BlogPostPage() {
  ...
  if (!post)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PublicLayout, {
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
            to: "/blog",
            className:
              "hover-press mt-7 inline-flex rounded-xl bg-primary px-6 py-3 text-sm font-bold text-primary-foreground",
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
          to: "/blog",
          className:
            "inline-flex items-center gap-1.5 text-sm font-semibold text-muted-foreground hover:text-primary",
          children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
              className:
                "mt-6 inline-block w-fit rounded-full bg-primary/12 px-3 py-1 text-xs font-bold text-primary",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            className: "mt-9",
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BlogRenderer, {
              blocks: post.body,
            }),
          }),
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "shadow-elevation-1 mt-12 rounded-2xl border border-border bg-card/60 p-6 text-center",
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SessionCta, {
                ...
                className:
                  "btn-shine hover-press mt-5 inline-flex rounded-xl bg-primary px-6 py-3 text-sm font-bold text-primary-foreground",
              }),
            ],
          }),
        }),
                ...
                children: others.map((o) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    Link,
                    {
                      ...
                      params: { slug: o.slug },
                      className:
                        "hover-lift shadow-elevation-1 rounded-2xl border border-border bg-card p-5",
