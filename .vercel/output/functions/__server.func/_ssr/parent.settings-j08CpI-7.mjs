...
import { F as Plus, tt as LoaderCircle, u as UserMinus } from "../_libs/lucide-react.mjs";
...
import { o as listLinkedChildren, p as unlinkChild, r as getParentNotificationPrefs, t as addLinkedChild, u as saveParentNotificationPrefs } from "./account-pages.functions-C_UOsBTW.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/parent.settings-j08CpI-7.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "الأبناء المرتبطون بحسابك، فك الربط، وتفضيلات الإشعارات والتقارير.";
function PageRoute() {
