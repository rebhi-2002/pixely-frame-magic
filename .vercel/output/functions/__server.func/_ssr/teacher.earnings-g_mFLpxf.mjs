...
import { o as description$5 } from "./router-B49B_5De.mjs";
...
import { a as getEarningsSettings, n as deleteEarningTransaction, s as listEarningTransactions, u as saveEarningTransaction } from "./teacher-followup.functions-BC5xPWOH.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.earnings-g_mFLpxf.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Wallet",
		subtitle: bi(description$5, "Your earnings, platform fee and payout requests — all transparent."),
		children: [
			isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				},
				{
					...
					value: settings.platformFeePercent != null ? `${settings.platformFeePercent}%` : bi("قيد التحديد", "TBD")
				},
				{
					icon: "Banknote",
