...
import { o as listLinkedChildren, p as unlinkChild, r as getParentNotificationPrefs, t as addLinkedChild, u as saveParentNotificationPrefs } from "./account-pages.functions-CjI_AaXK.mjs";
import { t as description } from "./parent.settings-CuHfWj6b.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/parent.settings-sf6kBN3G.js
...
function Body() {
	...
	const addMutation = useMutation({
		...
		onError: (e) => toast.error(e instanceof Error ? e.message : bi("تعذّر الربط", "Failed to link"))
	});
	const unlinkMutation = useMutation({
		...
		onError: (e) => toast.error(e instanceof Error ? e.message : bi("تعذّر فك الربط", "Failed to unlink"))
	});
