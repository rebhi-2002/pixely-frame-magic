...
import { c as description$7 } from "./router-D4MhNWYA.mjs";
...
import { r as deleteTeacherCourse, s as listTeacherCourses, u as saveTeacherCourse } from "./teacher-teaching.functions-_9XI7-2b.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.courses-DD0p8LhK.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "BookOpenCheck",
		subtitle: bi(description$7, "Your published courses: pricing, enrollments and upcoming sessions."),
		children: [
