...
import { Gt as BadgeCheck, Vt as BookOpen, a as Users, b as Star, tt as LoaderCircle } from "../_libs/lucide-react.mjs";
import { r as Route$34 } from "./router-6XTWAeEY.mjs";
...
import { n as listPublicCourses } from "./public-catalog.functions-DeHz7844.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher._id-ESwkHi6o.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PublicLayout, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: [
			...
			reviews.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				className: "mt-6 rounded-2xl border border-dashed border-border bg-card/40 p-6 text-center text-sm text-muted-foreground",
				children: t("teacherProfile.reviewsEmpty")
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
