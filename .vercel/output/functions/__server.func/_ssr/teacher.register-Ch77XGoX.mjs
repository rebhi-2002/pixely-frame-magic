      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
                htmlFor: "doc",
                className:
                  "flex cursor-pointer items-center gap-3 rounded-xl border border-dashed border-input bg-background px-3.5 py-4 text-sm text-muted-foreground transition-colors hover:border-primary",
                children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            ...
            disabled: loading,
            className:
              "sm:col-span-2 w-full rounded-xl bg-primary px-4 py-3 text-sm font-bold text-primary-foreground transition-opacity hover:opacity-90 disabled:opacity-60",
