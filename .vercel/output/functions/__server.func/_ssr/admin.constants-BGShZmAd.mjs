...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.constants-BGShZmAd.js
...
async function saveBackendConstant(form) {
	...
	if (form.id != null && form.parent_id === form.id) throw new Error("لا يمكن أن يكون الثابت أبًا لنفسه");
...
async function deleteBackendConstant(id) {
	...
	if (!result.success) throw new Error(result.message || "تعذر حذف الثابت");
}
var EMPTY_FORM = {
	name: "",
	comment: "",
