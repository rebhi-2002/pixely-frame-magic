...
import { K as KeyRound, z as MailCheck } from "../_libs/lucide-react.mjs";
import { s as stringType } from "../_libs/zod.mjs";
import { n as AuthShell, t as AuthField } from "./auth-shell-B7r5y7wC.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/forgot-password-C4JGVfbU.js
...
function ForgotPasswordPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AuthShell, {
    icon: sent
      ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MailCheck, { className: "size-5" })
