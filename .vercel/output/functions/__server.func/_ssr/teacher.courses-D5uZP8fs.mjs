...
import { r as deleteTeacherCourse, s as listTeacherCourses, u as saveTeacherCourse } from "./teacher-teaching.functions-D_QDlVah.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.courses-D5uZP8fs.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "كورساتك المنشورة: الأسعار، المشتركون، والحصص القادمة.";
function PageRoute() {
