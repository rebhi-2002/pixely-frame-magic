...
import { N as description$28 } from "./router-D9hWsH17.mjs";
...
import { d as saveBookmark, s as listBookmarks, t as deleteBookmark } from "./student-social.functions-jnV5Sf8I.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/bookmarks-8qDfc7I2.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Bookmark",
		subtitle: bi(description$28, "Everything you saved: lessons, questions and threads — in one quick-access place."),
		children: [
