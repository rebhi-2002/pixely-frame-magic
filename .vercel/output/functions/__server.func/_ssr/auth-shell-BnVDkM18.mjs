...
import { i as WelcomeIllustration } from "./illustrations-DxG8Himc.mjs";
import { dt as ChartLine, ht as BookOpenCheck, it as CircleX } from "../_libs/lucide-react.mjs";
import { n as PreferenceToggles, t as BrandMark } from "./public-layout-BxOOhUSq.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-shell-BnVDkM18.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						className: `shadow-elevation-2 mx-auto w-full rounded-2xl border border-border bg-card p-6 sm:p-8 ${wide ? "max-w-2xl lg:max-w-none" : "max-w-md lg:max-w-md"}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function AuthField({ id, label, value, onChange, type = "text", placeholder, autoComplete, hint }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
