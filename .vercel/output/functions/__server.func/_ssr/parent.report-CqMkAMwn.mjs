...
import { i as WelcomeBanner, r as TrendChart } from "./charts-BCp9Ywrh.mjs";
import { t as description } from "./parent.report-SJo4rcZh.mjs";
import { i as getChildReport } from "./supervisor-oversight.functions-Bmdyil0d.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/parent.report-CqMkAMwn.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		title: bi("تقرير الابن", "Child report"),
		icon: "FileBarChart",
		subtitle: bi(description, "A clear weekly report: consistency, mastery and weak spots — no vanity metrics."),
		children: [
