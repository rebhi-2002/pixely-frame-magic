...
import { a as getCommunityStats, c as listCommunityQuestions, f as saveCommunityQuestion, n as deleteCommunityQuestion } from "./student-social.functions-CiKrVgWv.mjs";
import { t as description } from "./community-DLwPdIiR.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/community-BVNAKTGM.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "MessagesSquare",
		subtitle: bi(description, "Ask in your subject community and answer classmates — teacher answers are highlighted."),
		children: [
