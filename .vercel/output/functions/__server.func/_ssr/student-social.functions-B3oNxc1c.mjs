...
import {
  a as REFERRAL_LINK,
  i as REFERRALS,
  n as COMMUNITY_QUESTIONS,
  o as SCHEDULE_EVENTS,
  r as COMMUNITY_STATS,
  s as nextSocialId,
  t as BOOKMARKS,
} from "./student-social-data-C82KUSRk.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/student-social.functions-B3oNxc1c.js
...
var listScheduleEvents = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listScheduleEvents_createServerFn_handler, async ({ context }) => {
...
var saveScheduleEvent = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      ...
      type: enumType(["حصة", "مراجعة", "امتحان", "واجب"]),
      hoursPlanned: numberType().min(0),
      reminderOn: booleanType(),
      overdue: booleanType(),
    }).parse(input),
  )
  .handler(saveScheduleEvent_createServerFn_handler, async ({ data, context }) => {
...
var deleteScheduleEvent = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteScheduleEvent_createServerFn_handler, async ({ data, context }) => {
...
var listCommunityQuestions = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listCommunityQuestions_createServerFn_handler, async ({ context }) => {
...
var saveCommunityQuestion = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
      ...
      status: enumType(["إجابة معلم", "مفتوح", "مُغلق"]),
    }).parse(input),
  )
  .handler(saveCommunityQuestion_createServerFn_handler, async ({ data, context }) => {
...
var deleteCommunityQuestion = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteCommunityQuestion_createServerFn_handler, async ({ data, context }) => {
...
var getCommunityStats = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(getCommunityStats_createServerFn_handler, async ({ context }) => {
    await requirePageAction(context.userId, "student_community", "view_list");
...
var saveCommunityStats = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
  ...
  .handler(saveCommunityStats_createServerFn_handler, async ({ data, context }) => {
...
var listBookmarks = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listBookmarks_createServerFn_handler, async ({ context }) => {
...
var saveBookmark = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
      ...
      type: enumType(["درس", "سؤال", "نقاش"]),
    }).parse(input),
  )
  .handler(saveBookmark_createServerFn_handler, async ({ data, context }) => {
...
var deleteBookmark = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteBookmark_createServerFn_handler, async ({ data, context }) => {
...
var listReferrals = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listReferrals_createServerFn_handler, async ({ context }) => {
...
var saveReferral = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
  ...
  .handler(saveReferral_createServerFn_handler, async ({ data, context }) => {
...
var deleteReferral = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteReferral_createServerFn_handler, async ({ data, context }) => {
...
var getReferralLink = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(getReferralLink_createServerFn_handler, async ({ context }) => {
    await requirePageAction(context.userId, "student_referrals", "view_list");
    return REFERRAL_LINK;
  });
//#endregion
export {
  deleteBookmark_createServerFn_handler,
  deleteCommunityQuestion_createServerFn_handler,
  deleteReferral_createServerFn_handler,
  deleteScheduleEvent_createServerFn_handler,
  getCommunityStats_createServerFn_handler,
  getReferralLink_createServerFn_handler,
  listBookmarks_createServerFn_handler,
  listCommunityQuestions_createServerFn_handler,
  listReferrals_createServerFn_handler,
  listScheduleEvents_createServerFn_handler,
  saveBookmark_createServerFn_handler,
  saveCommunityQuestion_createServerFn_handler,
  saveCommunityStats_createServerFn_handler,
  saveReferral_createServerFn_handler,
  saveScheduleEvent_createServerFn_handler,
};
