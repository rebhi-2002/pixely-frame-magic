...
import {
  ...
  r as EXAM_ATTEMPTS,
  t as BADGES,
} from "./student-evaluation-data-z7p3-_Ty.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/student-evaluation.functions-CjfWYUcM.js
...
var listMockExams = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listMockExams_createServerFn_handler, async ({ context }) => {
...
var saveMockExam = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  ...
  .handler(saveMockExam_createServerFn_handler, async ({ data, context }) => {
...
var deleteMockExam = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteMockExam_createServerFn_handler, async ({ data, context }) => {
...
var listExamAttempts = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listExamAttempts_createServerFn_handler, async ({ context }) => {
    await requirePageAction(context.userId, "student_exam", "view_list");
...
var saveExamAttempt = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
  ...
  .handler(saveExamAttempt_createServerFn_handler, async ({ data, context }) => {
    await requirePageAction(context.userId, "student_exam", data.id ? "edit" : "execute_add");
    if (data.id) {
...
var deleteExamAttempt = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteExamAttempt_createServerFn_handler, async ({ data, context }) => {
    await requirePageAction(context.userId, "student_exam", "delete");
...
var listMistakes = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listMistakes_createServerFn_handler, async ({ context }) => {
...
var saveMistake = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
      ...
      status: enumType(["أولوية", "مراجعة", "مُتقن"]),
    }).parse(input),
  )
  .handler(saveMistake_createServerFn_handler, async ({ data, context }) => {
...
var deleteMistake = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteMistake_createServerFn_handler, async ({ data, context }) => {
...
var listBadges = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listBadges_createServerFn_handler, async ({ context }) => {
...
var saveBadge = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
  ...
  .handler(saveBadge_createServerFn_handler, async ({ data, context }) => {
...
var deleteBadge = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteBadge_createServerFn_handler, async ({ data, context }) => {
...
var listCertificates = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listCertificates_createServerFn_handler, async ({ context }) => {
...
var saveCertificate = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
  ...
  .handler(saveCertificate_createServerFn_handler, async ({ data, context }) => {
    await requirePageAction(
      context.userId,
...
var deleteCertificate = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteCertificate_createServerFn_handler, async ({ data, context }) => {
...
//#endregion
export {
  deleteBadge_createServerFn_handler,
  deleteCertificate_createServerFn_handler,
  deleteExamAttempt_createServerFn_handler,
  deleteMistake_createServerFn_handler,
  deleteMockExam_createServerFn_handler,
  listBadges_createServerFn_handler,
  listCertificates_createServerFn_handler,
  listExamAttempts_createServerFn_handler,
  listMistakes_createServerFn_handler,
  listMockExams_createServerFn_handler,
  saveBadge_createServerFn_handler,
  saveCertificate_createServerFn_handler,
  saveExamAttempt_createServerFn_handler,
  saveMistake_createServerFn_handler,
  saveMockExam_createServerFn_handler,
};
