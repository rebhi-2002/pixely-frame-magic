...
//#region node_modules/.nitro/vite/services/ssr/assets/public-catalog.functions-BuFnnoPZ.js
var PUBLIC_COURSES = [
  {
    id: "math-tawjihi",
...
var listPublicCourses = createServerFn({ method: "GET" }).handler(
  listPublicCourses_createServerFn_handler,
  async () => {
...
var saveCourse = createServerFn({ method: "POST" })
  ...
  .handler(saveCourse_createServerFn_handler, async ({ data, context }) => {
...
var deleteCourse = createServerFn({ method: "POST" })
  ...
  .handler(deleteCourse_createServerFn_handler, async ({ data, context }) => {
