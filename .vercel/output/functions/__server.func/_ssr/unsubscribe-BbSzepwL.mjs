...
import { R as MailX } from "../_libs/lucide-react.mjs";
import { r as PublicLayout } from "./public-layout-CgDhl5-6.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/unsubscribe-BbSzepwL.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var OPTION_KEYS = ["weekly", "reminders", "community", "marketing"];
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                  ...
                  className:
                    "h-12 w-full rounded-xl border border-border bg-card px-4 text-sm text-foreground outline-none focus:border-primary",
                }),
              ],
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
                  className:
                    "mt-3 flex items-center gap-3 border-t border-border pt-3 text-sm font-bold text-foreground",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                      type: "checkbox",
                      checked: allOff,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
              type: "submit",
              className:
                "w-full rounded-xl bg-primary px-4 py-3 text-sm font-bold text-primary-foreground transition-opacity hover:opacity-90",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
            className:
              "mt-5 rounded-xl border border-success/40 bg-success/10 p-4 text-sm font-semibold text-success",
