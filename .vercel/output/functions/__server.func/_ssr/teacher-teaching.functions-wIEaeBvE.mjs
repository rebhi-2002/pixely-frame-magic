...
//#region node_modules/.nitro/vite/services/ssr/assets/teacher-teaching.functions-wIEaeBvE.js
var TEACHER_COURSES = [
  {
    id: "tc-1",
...
var listTeacherCourses = createServerFn({ method: "GET" })
  ...
  .handler(listTeacherCourses_createServerFn_handler, async ({ context }) => {
...
var saveTeacherCourse = createServerFn({ method: "POST" })
  ...
  .handler(saveTeacherCourse_createServerFn_handler, async ({ data, context }) => {
...
var deleteTeacherCourse = createServerFn({ method: "POST" })
  ...
  .handler(deleteTeacherCourse_createServerFn_handler, async ({ data, context }) => {
...
var listContentItems = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listContentItems_createServerFn_handler, async ({ context }) => {
...
var saveContentItem = createServerFn({ method: "POST" })
  ...
  .handler(saveContentItem_createServerFn_handler, async ({ data, context }) => {
...
var deleteContentItem = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteContentItem_createServerFn_handler, async ({ data, context }) => {
...
var listQuizItems = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listQuizItems_createServerFn_handler, async ({ context }) => {
...
var saveQuizItem = createServerFn({ method: "POST" })
  ...
  .handler(saveQuizItem_createServerFn_handler, async ({ data, context }) => {
...
var deleteQuizItem = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteQuizItem_createServerFn_handler, async ({ data, context }) => {
...
var listOpenClassQuestions = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listOpenClassQuestions_createServerFn_handler, async ({ context }) => {
...
export {
  ...
  deleteQuizItem_createServerFn_handler,
  deleteTeacherCourse_createServerFn_handler,
  listContentItems_createServerFn_handler,
  listOpenClassQuestions_createServerFn_handler,
  listQuizItems_createServerFn_handler,
  listTeacherCourses_createServerFn_handler,
  saveContentItem_createServerFn_handler,
  saveQuizItem_createServerFn_handler,
  saveTeacherCourse_createServerFn_handler,
};
