...
import { Ct as CircleX, Et as CircleCheck, x as ShieldQuestionMark } from "../_libs/lucide-react.mjs";
import { x as Route$36 } from "./router-D9kxMA2z.mjs";
import { r as PublicLayout } from "./public-layout-CjXUP782.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/certificate._id-BdOuZ85m.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
/** رقم صالح شكلياً: ACD-YYYY-NNNNN (سجل الشهادات الحقيقي يأتي مع مرحلة الباك-إند). */
var VALID = /^ACD-\d{4}-\d{5}$/i;
function CertificatePage() {
	const { id } = Route$36.useParams();
