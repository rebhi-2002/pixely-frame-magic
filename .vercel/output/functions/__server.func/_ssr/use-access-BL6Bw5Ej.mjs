...
import { n as useServerFn, t as createSsrRpc } from "./createSsrRpc-Deneh4is.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/use-access-BL6Bw5Ej.js
var getMyAccess = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(createSsrRpc("3b35a01bd5c939e1ccf817ef8e2d95da72450be263e4c90b0ec119cae61c4641"));
var listModules = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(createSsrRpc("43f41e9156f8f037555e9dde5fef858265ce8ecc9d8a8e424f7ceaa811d511d9"));
var setModuleEnabled = createServerFn({ method: "POST" })
  ...
  .handler(createSsrRpc("946dd497c24bf8d36254653c7f41eb3d5c7377b174d4b5fced729318b6d150b3"));
var listRoles = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(createSsrRpc("b3e7240a64b294422dcd5dc2f87014a45ea44a13d7c9e4717eb196e88a6389d0"));
var saveRole = createServerFn({ method: "POST" })
  ...
  .handler(createSsrRpc("79443092956277e07f294e87b21a2dc66b35872b2a71ae0752e0d3e8b9670af7"));
var deleteRole = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(createSsrRpc("68aa14d1b8034aca3740719a1ab75f8f755273a3c48e773af9075eae27b70a63"));
var getPermissionMatrix = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ roleId: stringType() }).parse(input))
  .handler(createSsrRpc("b96d976207999c28e41d8af45ef68eaa7e9d2d837ff307cca736138c69ef0afe"));
var saveRolePermissions = createServerFn({ method: "POST" })
  ...
  .handler(createSsrRpc("91fba1d53d7effe772a1fa2acf1f20d3554f899c639ea07320f087ddb255d93f"));
var listUsers = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(createSsrRpc("aa03dc8fb833649809fc141180e8f16874028bb0aadb8fd3c37e781f5def72bd"));
createServerFn({ method: "POST" })
  ...
  .handler(createSsrRpc("9a293f22c1bb39dae946a749d672812445a9e07dd3f6db07865944bcf6a30ad0"));
createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
  ...
  .handler(createSsrRpc("fb205e7a8e34b724348b4faafceec9ce36f492599bcf26b52c047b11a927ad9b"));
createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(createSsrRpc("8f956e8410d327174a5b573b64cfb8eb2c059f590228898ac9af3f642e4c773c"));
createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
  ...
  .handler(createSsrRpc("7f66dcc378b0c1dafb40cfa8380bc2b145f6c0b5ae45591233e0d87fbd6136ca"));
/**
...
var updateOwnProfile = createServerFn({ method: "POST" })
  ...
  .handler(createSsrRpc("64a40ba867066efd81962cdda0cf7c813fff4f2a9c51dfba7bfd567879f32599"));
...
export {
  listRoles as a,
  saveRolePermissions as c,
  useAccess as d,
  useInvalidateAccess as f,
  listModules as i,
  setModuleEnabled as l,
  deleteRole as n,
  listUsers as o,
  getPermissionMatrix as r,
  saveRole as s,
  ACCESS_QUERY_KEY as t,
  updateOwnProfile as u,
};
