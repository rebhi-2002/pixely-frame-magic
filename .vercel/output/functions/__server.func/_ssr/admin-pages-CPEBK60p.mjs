import { O as throwBilingual, d as apiClient } from "./rbac-static-data-Bv6QEjHq.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin-pages-CPEBK60p.js
function mapPage(p) {
  return {
    id: p.id ?? 0,
    name: p.name ?? "",
...
async function listBackendPages() {
  return (
    (
      await apiClient.post("/api/Page/GetAll", {
        searchValue: "",
        sortColumn: "",
        sortColumnDirection: "",
        pageSize: 1e3,
...
//#endregion
export {
  saveBackendPage as i,
  listBackendPages as n,
  loadBackendPageOptions as r,
  deleteBackendPage as t,
};
