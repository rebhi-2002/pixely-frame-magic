...
import { A as useBi, N as wasJustRegistered, g as getStoredUserId, p as getErrorMessage } from "./rbac-static-data-DgiM51a_.mjs";
import { y as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { v as require_jsx_runtime } from "../_libs/@radix-ui/react-accordion+[...].mjs";
import { i as useQueryClient, n as useQuery, t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { F as Pencil, P as Plus, p as Trash2, w as Settings2 } from "../_libs/lucide-react.mjs";
import { M as description$27 } from "./router-B2E04MFx.mjs";
...
import { c as QuickLinks, i as EmptyState, l as RowList, o as Panel, s as Progress, t as AppPage, u as StatGrid } from "./kit-Ctaz_npe.mjs";
...
import { a as getStudyStats, c as listLibrarySubjects, g as updateWeeklyStudyMinutes, h as saveUpcomingTask, i as deleteUpcomingTask, l as listUpcomingTasks, m as saveStudyStats, u as listWeeklyStudyLog } from "./student-learning.functions-DB5nQVh4.mjs";
...
import { i as WelcomeBanner, r as TrendChart } from "./charts-lcdbpCOl.mjs";
import { i as getMyWallet } from "./wallet-CJvVivC2.mjs";
import { t as OnboardingChecklist } from "./onboarding-checklist-CwG01ZsZ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/dashboard-kWsjTMWK.js
...
function Body() {
	...
	const log = (0, import_react.useMemo)(() => logQuery.data ?? [], [logQuery.data]);
	const tasks = (0, import_react.useMemo)(() => tasksQuery.data ?? [], [tasksQuery.data]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		subtitle: bi(description$27, "Everything in one place: today's progress, upcoming tasks, and subjects that need review."),
		children: [
			...
			userId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OnboardingChecklist, {
				userId,
				roleKey: "student",
			...
			isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoadingState, { label: bi("عم نجهّز لوحتك…", "Preparing your dashboard…") }) : hasError ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorState, {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
					title: bi("خطوتك التالية", "Your next step"),
					icon: "Zap",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
					title: bi("إيقاع دراستك", "Your study rhythm"),
					icon: "ChartSpline",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
					title: bi("أين تحتاج إلى المراجعة؟", "Where to review next"),
					icon: "LineChart",
