...
import { i as deleteMistake, l as listMistakes, m as saveMistake } from "./student-evaluation.functions-_PI2B2JK.mjs";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-CbSL31Oe.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/mistakes-bank-DbFouBQF.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "سجّل الأسئلة يلي بتخطئ فيها بنفسك، وتابع تكرارها لحد ما تتقنها.";
function PageRoute() {
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "XCircle",
		subtitle: bi(description, "Log the questions you get wrong yourself, and track them until you master them."),
		children: [
