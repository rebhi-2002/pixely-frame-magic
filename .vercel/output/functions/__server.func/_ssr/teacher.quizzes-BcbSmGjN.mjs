...
import { t as description } from "./teacher.quizzes-B4Kz1-XZ.mjs";
import { l as saveQuizItem, n as deleteQuizItem, o as listQuizItems } from "./teacher-teaching.functions-DD6kcMuJ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.quizzes-BcbSmGjN.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "ListChecks",
		subtitle: bi(description, "Your question bank and quizzes: MCQ, true/false and essay — auto-graded where possible."),
		children: [
