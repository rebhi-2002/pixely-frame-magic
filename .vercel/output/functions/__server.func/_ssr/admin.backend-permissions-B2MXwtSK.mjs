...
import { d as apiClient, f as getErrorMessage, k as useBi } from "./rbac-static-data-JRz-nJtL.mjs";
import { i as useQueryClient, n as useQuery, t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { E as Save } from "../_libs/lucide-react.mjs";
...
import { n as listBackendPages } from "./admin-pages-D5cQf2YU.mjs";
import { n as LoadingState, r as RetryButton, t as ErrorState } from "./feedback-states-DOqHvyO5.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin.backend-permissions-B2MXwtSK.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: bi("الباك اند حاليًا فيه نوعين مستخدم ثابتين فقط (بدون إمكانية إضافة نوع جديد). حدد أي صفحات يقدر هذا النوع يوصلها.", "The backend currently has only two fixed user types (no way to add more). Choose which pages this type can access.")
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mb-5 flex flex-wrap gap-2",
					children: BACKEND_USER_TYPES.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
