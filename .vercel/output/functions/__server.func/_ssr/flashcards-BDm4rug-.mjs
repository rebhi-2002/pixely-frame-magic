...
import { F as Plus, I as Pencil, Nt as ChevronRight, Pt as ChevronLeft, j as RotateCw, m as Trash2, tt as LoaderCircle } from "../_libs/lucide-react.mjs";
...
import { f as saveFlashcardDeck, n as deleteFlashcardDeck, s as listFlashcardDecks } from "./student-learning.functions-OnB3dj69.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/flashcards-BDm4rug-.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "دفتر متابعة مجموعات بطاقاتك: كم بطاقة عندك، كم مستحقة، وكم أتقنتها.";
function PageRoute() {
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Layers",
		subtitle: bi(description, "A tracker for your card decks: how many cards, how many due, how many mastered."),
		children: [
