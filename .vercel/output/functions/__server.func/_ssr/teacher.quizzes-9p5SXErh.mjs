...
import { i as description$3 } from "./router-D4MhNWYA.mjs";
...
import { l as saveQuizItem, n as deleteQuizItem, o as listQuizItems } from "./teacher-teaching.functions-_9XI7-2b.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.quizzes-9p5SXErh.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "ListChecks",
		subtitle: bi(description$3, "Your question bank and quizzes: MCQ, true/false and essay."),
		children: [
