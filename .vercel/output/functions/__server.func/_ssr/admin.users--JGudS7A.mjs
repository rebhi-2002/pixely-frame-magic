...
async function listBackendUsers() {
  return (
    (
      await apiClient.post("/api/User/GetAll", {
        searchValue: "",
        sortColumn: "",
        sortColumnDirection: "",
        pageSize: 1e3,
  ...
  const filtered = (0, import_react.useMemo)(() => {
    return (users ?? []).filter((u) => {
      ...
      if (search.trim()) {
        ...
        if (!`${u.full_name} ${u.email ?? ""} ${u.phone ?? ""}`.toLowerCase().includes(q))
          return false;
      }
      return true;
    });
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: isLoading
              ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoadingState, {
                  label: bi("عم نحمّل المستخدمين…", "Loading users…"),
                })
              : isError
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {
                            placeholder: bi("اختر الجنس", "Select gender"),
                          }),
                        }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
                      children: bi("نوع المستخدم", "User type"),
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogHeader, {
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogTitle, {
                  children: bi(
                    `حذف «${pendingDelete?.full_name}»؟`,
                    `Delete "${pendingDelete?.full_name}"?`,
                  ),
                }),
