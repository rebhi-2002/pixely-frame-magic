...
import {
  ...
  m as createRouter,
  u as HeadContent,
  v as createRootRouteWithContext,
  x as useRouter,
  y as Link,
  z as redirect,
...
import {
  ...
  E as roleHome,
  S as logout,
  T as preferencesBootScript,
  _ as isAuthenticated,
  g as i18n_default,
  h as getStoredUserId,
  j as verifyServerSession,
  l as USERS,
  m as getStoredProfile,
  o as PreferencesProvider,
  s as ROLES,
  t as AUTH_EVENT,
  v as isDemoSession,
...
function getSeoForPath(pathname, locale) {
  ...
  const blogSlug = normalizedPath.startsWith("/blog/")
    ? decodeURIComponent(normalizedPath.slice(6))
    : null;
...
var ACTIVITY_EVENTS = ["pointerdown", "keydown", "scroll", "touchstart", "visibilitychange"];
/**
...
function CookieConsent() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    ...
    className:
      "fixed inset-x-3 bottom-[calc(0.75rem+env(safe-area-inset-bottom))] z-[60] mx-auto max-h-[calc(100dvh-1.5rem)] max-w-3xl overflow-y-auto rounded-2xl border border-border bg-card/95 p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] shadow-lg backdrop-blur md:inset-x-6 md:bottom-6 md:pb-4",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
              ...
              className:
                "rounded-xl border border-border px-3 py-2 text-xs font-bold text-muted-foreground transition-colors hover:text-foreground",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
              ...
              className:
                "rounded-xl bg-primary px-4 py-2 text-xs font-bold text-primary-foreground transition-opacity hover:opacity-90",
...
function NotFoundComponent() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      className:
        "shadow-elevation-2 max-w-md rounded-3xl border border-border bg-card p-8 text-center",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NotFoundIllustration, {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
            href: home,
            className:
              "btn-shine hover-press inline-flex items-center justify-center rounded-xl bg-primary px-6 py-3 text-sm font-bold text-primary-foreground",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
          className:
            "mx-auto flex size-14 items-center justify-center rounded-full bg-destructive/12 text-destructive",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
              ...
              className:
                "hover-press inline-flex items-center justify-center rounded-xl bg-primary px-6 py-3 text-sm font-bold text-primary-foreground",
              children: t("errors.retry"),
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
              href: "/",
              className:
                "hover-press inline-flex items-center justify-center rounded-xl border border-border bg-background px-6 py-3 text-sm font-bold text-foreground hover:bg-secondary",
              children: t("errors.backHome"),
            }),
          ],
        }),
...
function RootComponent() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientProvider, {
    client: queryClient,
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PreferencesProvider, {
      children: [
...
var description$1 =
  "الدرس: ملف مرتّب + أسئلة تفاعلية + بطاقات مراجعة + إضافة أخطائك إلى بنك الأخطاء.";
...
var AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedLibraryRoute: AuthenticatedLibraryRoute._addFileChildren(
    AuthenticatedLibraryRouteChildren,
  ),
...
var AuthenticatedRouteRouteWithChildren = AuthenticatedRouteRoute._addFileChildren(
...
export {
  ...
  description$21 as E,
  Route$52 as F,
  currentUserHome as I,
  EmptyIllustration as L,
  description$27 as M,
  description$28 as N,
  description$23 as O,
  description$29 as P,
  ForbiddenIllustration as R,
  Route$36 as S,
  description$20 as T,
  getBlogPost as V,
  description$15 as _,
