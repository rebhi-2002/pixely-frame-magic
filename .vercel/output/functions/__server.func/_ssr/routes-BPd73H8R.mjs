...
import { k as useBi, u as allowedPublicPaths } from "./rbac-static-data-Bv6QEjHq.mjs";
import {
  N as MessagesSquare,
  Q as Flame,
  St as Bell,
...
import { B as blogPosts } from "./router-D9hWsH17.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BPd73H8R.js
...
var weekBars = [22, 34, 18, 40, 28, 46, 32];
/**
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "glass-surface shadow-elevation-3 relative mx-auto w-full max-w-md rounded-3xl p-4 [transform:perspective(1400px)_rotateY(-8deg)_rotateX(3deg)] transition-transform duration-700 hover:[transform:perspective(1400px)_rotateY(-3deg)_rotateX(1deg)]",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                className:
                  "ms-3 flex-1 truncate rounded-full bg-background/70 px-3 py-1 text-[11px] text-muted-foreground",
                children: "academia.app/dashboard",
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                className:
                  "shrink-0 rounded-full bg-primary/12 px-2 py-1 text-[9px] font-bold text-primary",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, {
                        className: "mx-auto size-3.5 text-info",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                        className: "mt-1 font-display text-sm font-bold text-foreground",
                        children: "24",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "flex h-14 items-end justify-between gap-1.5 border-t border-border pt-3",
                children: weekBars.map((h, i) =>
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "glass-surface shadow-elevation-2 animate-float absolute -end-6 -top-6 flex items-center gap-2 rounded-2xl px-3.5 py-2.5",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
            className:
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "glass-surface shadow-elevation-2 animate-float absolute -bottom-5 -start-8 flex items-center gap-2 rounded-2xl px-3.5 py-2.5",
        style: { animationDelay: "1.2s" },
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
            className:
              "flex size-7 items-center justify-center rounded-full bg-primary/15 text-primary",
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                    className:
                      "glass-surface inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm font-semibold text-primary shadow-elevation-1",
                    children: [
                    ...
                    ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
                            className:
                              "mt-6 text-4xl font-bold leading-[1.25] text-foreground sm:text-5xl md:text-6xl",
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                                to: session.home,
                                className:
                                  "glow-primary hover-press inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-7 py-3.5 text-sm font-bold text-primary-foreground",
                                children: [
                              ...
                              canBrowseCourses &&
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                                  to: "/courses",
                                  className:
                                    "hover-press inline-flex items-center justify-center rounded-xl border border-border bg-card px-7 py-3.5 text-sm font-bold text-foreground hover:bg-secondary",
                    ...
                    : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
                            className:
                              "mt-6 text-4xl font-bold leading-[1.2] text-foreground sm:text-5xl md:text-6xl",
                            children: [
                              t("home.h1a"),
                              " ",
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                                to: "/signup",
                                className:
                                  "btn-shine glow-primary hover-press inline-flex items-center justify-center rounded-xl bg-primary px-7 py-3.5 text-sm font-bold text-primary-foreground",
                    ...
                    children: stats.map((s, i) =>
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                        Reveal,
                        {
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className:
                              "hover-lift shadow-elevation-1 flex h-full flex-col justify-center rounded-2xl border border-border bg-card p-5",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
          ...
          children: roles.map((r) =>
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(r.icon, {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                to: "/blog",
                className:
                  "hover-press inline-flex items-center rounded-xl border border-border bg-card px-5 py-2.5 text-sm font-bold text-foreground hover:bg-secondary",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: latestPosts.map((post, i) =>
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                Reveal,
                {
                  delay: i * 0.08,
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                    ...
                    className:
                      "hover-lift shadow-elevation-1 flex h-full flex-col rounded-2xl border border-border bg-card p-6",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className:
                          "w-fit rounded-full bg-primary/12 px-3 py-1 text-xs font-bold text-primary",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SessionCta, {
            ...
            className:
              "btn-shine glow-primary hover-press mt-7 inline-flex items-center justify-center rounded-xl bg-primary px-8 py-3.5 text-sm font-bold text-primary-foreground",
          }),
        ],
      }),
