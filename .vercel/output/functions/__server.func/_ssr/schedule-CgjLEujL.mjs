...
import { i as deleteScheduleEvent, m as saveScheduleEvent, u as listScheduleEvents } from "./student-social.functions-u1FVOSpN.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/schedule-CgjLEujL.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "جدول دراسي بمكان واحد: حصص، واجبات، امتحانات، وجلسات مراجعة.";
function PageRoute() {
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "CalendarDays",
		subtitle: bi(description, "A schedule that reminds you: classes, homework, exams and review sessions."),
		children: [
