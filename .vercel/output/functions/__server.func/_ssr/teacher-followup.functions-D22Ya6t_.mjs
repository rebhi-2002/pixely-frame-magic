...
import { n as COMMUNITY_QUESTIONS } from "./student-social-data-C82KUSRk.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher-followup.functions-D22Ya6t_.js
var GRADING_ITEMS = [
  {
    id: "gr-1",
    studentName: "أحمد ع.",
...
var MISSED_QUESTIONS = [
  {
    id: "mq-1",
    questionTitle: "تكامل بالتجزيء — سؤال 7",
    wrongPercent: 68,
    priority: "أولوية",
  },
  {
    id: "mq-2",
    questionTitle: "قاعدة السلسلة — سؤال 3",
    wrongPercent: 54,
    priority: "مراجعة",
  },
  {
...
var EARNING_TRANSACTIONS = [
  ...
  },
  {
    ...
    description: "اشتراك مراجعة",
    amount: 15,
    status: "مؤكد",
  },
];
var EARNINGS_SETTINGS = { platformFeePercent: 15 };
...
var listGradingItems = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listGradingItems_createServerFn_handler, async ({ context }) => {
...
var saveGradingItem = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  ...
  .handler(saveGradingItem_createServerFn_handler, async ({ data, context }) => {
...
var deleteGradingItem = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteGradingItem_createServerFn_handler, async ({ data, context }) => {
...
var listMissedQuestions = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listMissedQuestions_createServerFn_handler, async ({ context }) => {
...
var saveMissedQuestion = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
  ...
  .handler(saveMissedQuestion_createServerFn_handler, async ({ data, context }) => {
...
var deleteMissedQuestion = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteMissedQuestion_createServerFn_handler, async ({ data, context }) => {
...
var listEarningTransactions = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listEarningTransactions_createServerFn_handler, async ({ context }) => {
...
var saveEarningTransaction = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
  ...
  .handler(saveEarningTransaction_createServerFn_handler, async ({ data, context }) => {
...
var deleteEarningTransaction = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteEarningTransaction_createServerFn_handler, async ({ data, context }) => {
...
var getEarningsSettings = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(getEarningsSettings_createServerFn_handler, async ({ context }) => {
    await requirePageAction(context.userId, "teacher_earnings", "view_list");
...
var listClassQuestions = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listClassQuestions_createServerFn_handler, async ({ context }) => {
...
var answerClassQuestion = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(answerClassQuestion_createServerFn_handler, async ({ data, context }) => {
...
//#endregion
export {
  answerClassQuestion_createServerFn_handler,
  deleteEarningTransaction_createServerFn_handler,
  deleteGradingItem_createServerFn_handler,
  deleteMissedQuestion_createServerFn_handler,
  getEarningsSettings_createServerFn_handler,
  listClassQuestions_createServerFn_handler,
  listEarningTransactions_createServerFn_handler,
  listGradingItems_createServerFn_handler,
  listMissedQuestions_createServerFn_handler,
  saveEarningTransaction_createServerFn_handler,
  saveGradingItem_createServerFn_handler,
