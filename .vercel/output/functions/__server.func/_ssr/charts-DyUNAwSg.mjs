...
//#region node_modules/.nitro/vite/services/ssr/assets/charts-DyUNAwSg.js
...
function WelcomeBanner({ subtitle, tip, action }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
      className:
        "surface-mesh shadow-elevation-1 relative overflow-hidden rounded-2xl border border-border",
            ...
            children: [
              ...
              tip &&
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                  className:
                    "mt-3 inline-flex items-center gap-1.5 rounded-full bg-primary/12 px-3 py-1 text-xs font-semibold text-primary",
                  children: bi(...tip),
                }),
              action &&
