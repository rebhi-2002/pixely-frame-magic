...
import { l as trackEvent } from "./router-6XTWAeEY.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/sign-out-overlay-CCG787W3.js
...
function BrandLockup({ className = "" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BrandLogo, { className: "size-9 lg:size-8" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
