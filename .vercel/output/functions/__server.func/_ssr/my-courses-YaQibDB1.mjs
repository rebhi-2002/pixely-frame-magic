...
import { T as description$20 } from "./router-D9hWsH17.mjs";
...
import { d as saveEnrollment, o as listEnrollments, t as deleteEnrollment } from "./student-learning.functions-BZT1Glc7.mjs";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-CbSL31Oe.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/my-courses-YaQibDB1.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "BookOpenCheck",
		subtitle: bi(description$20, "Courses you actually enrolled in — progress, next session and completion certificate."),
		children: [
