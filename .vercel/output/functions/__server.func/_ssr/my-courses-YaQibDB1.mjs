...
import {
  d as saveEnrollment,
  o as listEnrollments,
  t as deleteEnrollment,
...
function Body() {
  ...
  const active = (0, import_react.useMemo)(
    () => (rows ?? []).filter((r) => r.status === "قيد الدراسة"),
    [rows],
  );
  const completed = (0, import_react.useMemo)(
    () => (rows ?? []).filter((r) => r.status === "مكتمل"),
    [rows],
  );
  const watchHours = (0, import_react.useMemo)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
        ...
        icon: "BookOpenCheck",
        action: can("student_my_courses", "show_add_form")
