...
import { Z as Gift, gt as Check } from "../_libs/lucide-react.mjs";
import { b as Route$34 } from "./router-D9hWsH17.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/invite._code-BZi6CR5p.js
var import_jsx_runtime = require_jsx_runtime();
function InvitePage() {
  const { code } = Route$34.useParams();
          ...
          children: [
            ...
            !isSignedIn &&
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                to: "/login",
                className:
                  "inline-flex rounded-xl border border-border bg-card px-7 py-3.5 text-sm font-bold text-foreground transition-colors hover:bg-secondary",
