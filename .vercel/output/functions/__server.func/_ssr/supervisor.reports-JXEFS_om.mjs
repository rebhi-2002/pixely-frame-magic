...
import { a as getSupervisionSettings, l as recordReportDownload, n as deleteSupervisionReport, s as listSupervisionReports } from "./supervisor-oversight.functions-Bmdyil0d.mjs";
import { t as description } from "./supervisor.reports-CWRVNqJW.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/supervisor.reports-JXEFS_om.js
...
function Body() {
	...
	const downloadMutation = useMutation({
		...
		onError: (e) => toast.error(e instanceof Error ? e.message : bi("تعذّر التنزيل", "Failed to download"))
	});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppPage, {
		...
		icon: "FileBarChart",
		subtitle: bi(description, "Periodic exportable reports: teaching quality, mastery and consistency."),
		children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: reports.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RowList, { rows: reports.map((r) => ({
				title: r.title,
				meta: bi(`${r.formatLabel} · ${r.downloadsCount} تنزيل`, `${r.formatLabel} · ${r.downloadsCount} downloads`),
				tone: "primary",
				actions: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [can("supervisor_reports", "edit") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Download, { className: "size-4" }), bi("تنزيل", "Download")]
