...
import { u as description$9 } from "./router-D9hWsH17.mjs";
...
import { o as listClassQuestions, t as answerClassQuestion } from "./teacher-followup.functions-DzYo1CG_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.community-Bs6m5_-R.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppPage, {
		...
		icon: "MessagesSquare",
		subtitle: bi(description$9, "Your students' questions in one place; your answer is marked as verified automatically."),
