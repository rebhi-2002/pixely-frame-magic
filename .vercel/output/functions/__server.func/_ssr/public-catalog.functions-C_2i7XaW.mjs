...
//#region node_modules/.nitro/vite/services/ssr/assets/public-catalog.functions-C_2i7XaW.js
/** قراءة عامة — بدون تسجيل دخول، تُستخدم بصفحة /courses قبل الاشتراك. */
var listPublicCourses = createServerFn({ method: "GET" }).handler(
  createSsrRpc("3f055e19d59ef7ee3242d2528d082d04ec25586910b3058202e18d231eee5275"),
);
var saveCourse = createServerFn({ method: "POST" })
  ...
  .handler(createSsrRpc("771723592d3a8f99cc3b54154ca1f08f067cd1830410556fb9a97d7e25e2420d"));
var deleteCourse = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(createSsrRpc("87f7c469a8296891751747f5b6e157ce2457564493c974dcf0aa78d1d8153ba8"));
//#endregion
