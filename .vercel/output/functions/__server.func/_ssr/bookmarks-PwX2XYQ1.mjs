...
import { d as saveBookmark, s as listBookmarks, t as deleteBookmark } from "./student-social.functions-u1FVOSpN.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/bookmarks-PwX2XYQ1.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "كل ما حفظته: دروس، أسئلة، ونقاشات — بمكان واحد للرجوع السريع.";
function PageRoute() {
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Bookmark",
		subtitle: bi(description, "Everything you saved: lessons, questions and threads — in one quick-access place."),
		children: [
