...
import { d as description$10 } from "./router-B49B_5De.mjs";
...
import { a as Panel, c as RowList, i as EmptyState, l as StatGrid, o as Progress, t as AppPage } from "./kit-BNtAyy6W.mjs";
...
import { o as listQuizItems, s as listTeacherCourses } from "./teacher-teaching.functions-BLTg4uZU.mjs";
import { f as saveMissedQuestion, i as deleteMissedQuestion, l as listMissedQuestions } from "./teacher-followup.functions-BC5xPWOH.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.analytics-j3eg_pLS.js
...
function Body() {
	...
	const activeStudents = (coursesQuery.data ?? []).reduce((s, c) => s + c.enrolledCount, 0);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "LineChart",
		subtitle: bi(description$10, "Exactly where students struggle: most-missed questions and per-quiz mastery."),
		children: [
