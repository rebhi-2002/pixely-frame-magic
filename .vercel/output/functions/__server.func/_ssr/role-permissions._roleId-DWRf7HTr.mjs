...
import { H as LoaderCircle, ht as ChevronDown, x as Save } from "../_libs/lucide-react.mjs";
import { g as Route$15 } from "./router-D9hWsH17.mjs";
import { n as useServerFn } from "./createSsrRpc-Deneh4is.mjs";
import {
  c as saveRolePermissions,
  r as getPermissionMatrix,
  t as ACCESS_QUERY_KEY,
...
//#region node_modules/.nitro/vite/services/ssr/assets/role-permissions._roleId-DWRf7HTr.js
...
function RolePermissionsPage() {
  const { roleId } = Route$15.useParams();
  const bi = useBi();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
        ...
        children: [
          ...
          data.modules.map((mod) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              ...
              {
                className:
                  "shadow-elevation-1 overflow-hidden rounded-2xl border border-border bg-card",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        className:
          "fixed bottom-0 left-0 right-0 border-t border-border bg-card/95 p-4 backdrop-blur",
