...
import {
  a as listOpenClassQuestions,
  i as listContentItems,
  o as listQuizItems,
  s as listTeacherCourses,
} from "./teacher-teaching.functions-Sdo5Rlld.mjs";
        ...
        : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
                ...
                icon: "ChartSpline",
                children: bySubject.length
                  ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ComparisonChart, {
                      data: bySubject,
                    })
                  : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
                      icon: "ChartSpline",
                      text: bi(
                        "أضف محتوى عشان تظهر البيانات هون.",
                        "Add content to see data here.",
                      ),
                    }),
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
