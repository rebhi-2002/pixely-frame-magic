...
import { c as USERS, m as loginAsDemo, p as login, x as useBi, y as roleHome } from "./rbac-static-data-BkN8GGlQ.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/login-CTymI_o4.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: loading ? t("common.loading") : t("authPages.login.submit")
					})
				]
			}),
