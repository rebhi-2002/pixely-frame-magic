...
import { _t as BadgeCheck, f as Star, mt as BookOpen, r as Users } from "../_libs/lucide-react.mjs";
import { r as PublicLayout } from "./public-layout-BxOOhUSq.mjs";
import { t as SessionCta } from "./session-cta-CkJWvVL3.mjs";
import { t as Route } from "./teacher._id-Dh3X0oij.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher._id-CHpg0k1g.js
var import_jsx_runtime = require_jsx_runtime();
function TeacherProfilePage() {
	const { id } = Route.useParams();
	const { t } = useTranslation();
	const courses = t("courses.items", { returnObjects: true }).filter((c) => c.teacherId === id);
