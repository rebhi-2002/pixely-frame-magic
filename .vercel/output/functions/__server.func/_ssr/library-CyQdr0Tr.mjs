...
import { O as description$23 } from "./router-B49B_5De.mjs";
...
import { c as listLibrarySubjects, p as saveLibrarySubject, r as deleteLibrarySubject } from "./student-learning.functions-CV2mHTOR.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/library-CyQdr0Tr.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Library",
		subtitle: bi(description$23, "A tidy library: term → subject → unit → lesson, so you can track every subject in one place."),
		children: [
