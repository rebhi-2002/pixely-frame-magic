...
import { M as RefreshCw, jt as CircleAlert, tt as LoaderCircle } from "../_libs/lucide-react.mjs";
import { t as cn } from "./utils-C_uf36nf.mjs";
import { t as Button } from "./button-DfTXnEII.mjs";
import { t as DynamicIcon } from "./dynamic-icon-Cf94UsPA.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/feedback-states-ZdZSGCTQ.js
...
function FeatureStatus({ title, description, icon = "Sparkles", action, className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("flex min-h-40 flex-col items-center justify-center gap-2 rounded-2xl border border-dashed border-border bg-secondary/20 p-6 text-center", className),
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
//#endregion
export { RetryButton as i, FeatureStatus as n, LoadingState as r, ErrorState as t };
