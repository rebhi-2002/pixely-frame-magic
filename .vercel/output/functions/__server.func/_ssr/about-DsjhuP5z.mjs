...
//#region node_modules/.nitro/vite/services/ssr/assets/about-DsjhuP5z.js
var import_jsx_runtime = require_jsx_runtime();
var valueIcons = [Compass, HeartHandshake, Languages, Target];
function AboutPage() {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                Reveal,
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
                    className:
                      "hover-lift shadow-elevation-1 h-full rounded-2xl border border-border bg-card p-6",
                    children: [
              ...
              children: team.map((m, i) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  Reveal,
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "shadow-elevation-1 h-full rounded-2xl border border-border bg-background p-6",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
