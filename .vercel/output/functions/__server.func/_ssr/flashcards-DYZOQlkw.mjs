...
import { k as description$24 } from "./router-D9hWsH17.mjs";
...
import { f as saveFlashcardDeck, n as deleteFlashcardDeck, s as listFlashcardDecks } from "./student-learning.functions-BZT1Glc7.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/flashcards-DYZOQlkw.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Layers",
		subtitle: bi(description$24, "Spaced repetition: each card returns exactly when you're about to forget it."),
		children: [
