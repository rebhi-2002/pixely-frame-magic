...
import {
  f as saveFlashcardDeck,
  n as deleteFlashcardDeck,
  s as listFlashcardDecks,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
        ...
        icon: "Layers",
        action: can("student_flashcards", "show_add_form")
