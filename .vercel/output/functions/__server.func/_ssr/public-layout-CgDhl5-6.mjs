...
import { A as usePreferences, u as allowedPublicPaths } from "./rbac-static-data-Bv6QEjHq.mjs";
import {
  B as LogOut,
  G as Languages,
  I as Menu,
  W as LayoutDashboard,
  _ as Settings,
  f as Sun,
  ht as ChevronDown,
  j as Moon,
...
import { t as useSession } from "./use-session-D9w0Q2fu.mjs";
import {
  n as SignOutOverlay,
  r as useSignOut,
  t as BrandLockup,
} from "./use-sign-out-B7TPwA9D.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/public-layout-CgDhl5-6.js
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
        ...
        className:
          "flex items-center gap-2 rounded-xl border border-border bg-card px-2 py-1.5 text-sm font-bold text-foreground transition-all duration-200 hover:border-primary/50 hover:shadow-sm",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
            className:
              "grid size-7 place-items-center rounded-lg bg-primary/15 text-xs font-black text-primary",
            children: initial,
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
      ...
      open &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "animate-in fade-in slide-in-from-top-1 absolute end-0 top-full z-50 mt-2 w-60 rounded-2xl border border-border bg-popover p-2 shadow-xl duration-200",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                  ...
                  className: item,
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Settings, { className: "size-4" }),
                    t("common.settings"),
                  ],
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
...
var SheetContent = import_react.forwardRef(({ side = "end", className, children, ...props }, ref) =>
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogClose, {
            className:
              "absolute end-4 top-4 rounded-lg opacity-70 ring-offset-background cursor-pointer transition-[background-color,opacity] hover:bg-secondary hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none",
            children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
        href: "#main",
        className:
          "sr-only focus:not-sr-only focus:absolute focus:start-4 focus:top-4 focus:z-50 focus:rounded-lg focus:bg-primary focus:px-4 focus:py-2 focus:text-sm focus:font-bold focus:text-primary-foreground",
              ...
              children: nav.map((item) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  Link,
                  {
                    ...
                    className:
                      "nav-underline rounded-lg px-3 py-2 text-sm font-semibold text-muted-foreground hover:text-foreground",
                    children: t(item.key),
                  },
                  item.to,
                ),
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTrigger, {
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                        ...
                        className:
                          "inline-flex size-10 items-center justify-center rounded-xl border border-border bg-card text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground lg:hidden",
                          ...
                          children: nav.map((item) =>
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              Link,
                              {
                                ...
                                className:
                                  "rounded-xl px-3 py-3 text-sm font-bold text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground",
                                children: t(item.key),
                              },
                              item.to,
                            ),
                          ...
                          children: [
                            isSignedIn && session
                              ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                                  ...
                                  onClick: () => setMobileMenuOpen(false),
                                  className:
                                    "inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-bold text-primary-foreground",
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LayoutDashboard, {
                                      "aria-hidden": "true",
                                      className: "size-4",
                                  ...
                                  import_jsx_runtime.Fragment,
                                  {
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                                        ...
                                        onClick: () => setMobileMenuOpen(false),
                                        className:
                                          "inline-flex items-center justify-center rounded-xl border border-border px-4 py-3 text-sm font-bold text-foreground hover:bg-secondary",
                                      ...
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                                        ...
                                        onClick: () => setMobileMenuOpen(false),
                                        className:
                                          "inline-flex items-center justify-center rounded-xl bg-primary px-4 py-3 text-sm font-bold text-primary-foreground",
                  ...
                  ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                          to: session.home,
                          className:
                            "hover-press hidden items-center gap-2 rounded-xl bg-primary px-3 py-2 text-sm font-bold whitespace-nowrap text-primary-foreground sm:inline-flex",
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LayoutDashboard, {
                              className: "size-4",
                            }),
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserMenu, { session }),
                      ],
                    })
                  : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                          to: "/login",
                          className:
                            "hidden rounded-lg px-3 py-2 text-sm font-semibold whitespace-nowrap text-muted-foreground hover:text-foreground sm:inline-flex",
                          children: t("common.signIn"),
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                          to: "/signup",
                          className:
                            "hover-press rounded-xl bg-primary px-3 py-2 text-sm font-bold whitespace-nowrap text-primary-foreground sm:px-4",
                          children: t("common.startFree"),
                        }),
                      ],
                    }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "mx-auto flex max-w-6xl flex-col gap-6 px-5 py-10 md:flex-row md:items-start md:justify-between",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      visible(footerPlatform).map((i) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          Link,
                          {
                            to: i.to,
                            className:
                              "block text-muted-foreground transition-transform duration-200 hover:text-primary rtl:hover:-translate-x-1 ltr:hover:translate-x-1",
                            children: t(i.key),
                          },
                          i.to,
                        ),
                      ...
                      footerLegal.map((i) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          Link,
                          {
                            to: i.to,
                            className:
                              "block text-muted-foreground hover:text-primary rtl:hover:-translate-x-1 ltr:hover:translate-x-1",
                            children: t(i.key),
                          },
                          i.to,
                        ),
