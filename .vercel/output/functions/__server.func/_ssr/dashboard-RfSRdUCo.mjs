...
import { j as description$26 } from "./router-D9hWsH17.mjs";
...
import {
  a as getStudyStats,
  c as listLibrarySubjects,
  g as updateWeeklyStudyMinutes,
  h as saveUpcomingTask,
  i as deleteUpcomingTask,
  l as listUpcomingTasks,
  m as saveStudyStats,
  u as listWeeklyStudyLog,
} from "./student-learning.functions-BZT1Glc7.mjs";
import {
  i as RetryButton,
  r as LoadingState,
  t as ErrorState,
...
//#region node_modules/.nitro/vite/services/ssr/assets/dashboard-RfSRdUCo.js
    ...
    children: [
      ...
      isLoading
        ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoadingState, {
            label: bi("عم نجهّز لوحتك…", "Preparing your dashboard…"),
          })
        : hasError
          ...
          : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
                  ...
                  icon: "Zap",
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QuickLinks, {
                    items: [
                      {
                        to: "/library",
                        ...
                        children: log.map((d) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            "button",
                            {
                              ...
                              className:
                                "rounded-lg border border-border px-2.5 py-1 text-xs text-muted-foreground transition-colors hover:border-primary/50 hover:text-primary",
                              children: [
                                bi(...d.day),
                                ": ",
                                d.minutes,
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
                  ...
                  icon: "CalendarClock",
                  action: can("student_dashboard", "show_add_form")
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, {
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
                children: minuteEdit ? bi(...minuteEdit.dayLabel) : "",
              }),
            }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, {
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
                children: bi("تعديل إحصاءاتي", "Edit my stats"),
              }),
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, {
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
                children: editingTaskId
                  ? bi("تعديل مهمة", "Edit task")
                  : bi("إضافة مهمة", "Add task"),
              }),
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogHeader, {
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogTitle, {
                  children: bi(
                    `حذف «${pendingDeleteTask?.title}»؟`,
                    `Delete "${pendingDeleteTask?.title}"?`,
                  ),
                }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogFooter, {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogAction, {
                  onClick: () =>
                    pendingDeleteTask && taskDeleteMutation.mutate(pendingDeleteTask.id),
