...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BDuAh1xq.mjs");
...
var manifest = {
	...
	"17c7cbcadacddb13cfafcc34b88860581e6f1fc69fe080f1de912d31a302243e": {
		...
		importer: () => import("./student-learning.functions-DGPn5Yxg.mjs")
	},
	...
	"32fa234b43f653a6f6f6fdb24dfba669ef2d49febce159afc7d77882cdaa6fdc": {
		...
		importer: () => import("./supervisor-oversight.functions-CGfaTx9Y.mjs")
	},
	...
	"3f055e19d59ef7ee3242d2528d082d04ec25586910b3058202e18d231eee5275": {
		...
		importer: () => import("./public-catalog.functions-DsS8doV7.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B49B_5De.mjs").then((n) => n.t),
		import("./start-C-X0FkxM.mjs"),
