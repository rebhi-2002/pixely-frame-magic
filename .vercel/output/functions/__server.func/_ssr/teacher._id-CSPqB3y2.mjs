...
import { y as Route$33 } from "./router-D9hWsH17.mjs";
...
import { n as listPublicCourses } from "./public-catalog.functions-C_2i7XaW.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher._id-CSPqB3y2.js
var import_jsx_runtime = require_jsx_runtime();
function TeacherProfilePage() {
  const { id } = Route$33.useParams();
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
            to: "/courses",
            className:
              "mt-6 inline-flex rounded-xl bg-primary px-6 py-3 text-sm font-bold text-primary-foreground",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                  className:
                    "flex size-16 items-center justify-center rounded-2xl bg-primary/15 font-display text-2xl font-bold text-primary",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                      className:
                        "mt-1.5 inline-flex items-center gap-1.5 text-sm font-semibold text-success",
                      children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
            ...
            children: [lessons, " ", t("courses.lessons")],
          }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "article",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                      className:
                        "rounded-lg bg-primary/12 px-2.5 py-1 text-xs font-bold text-primary",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SessionCta, {
              ...
              className:
                "glow-primary inline-flex rounded-xl bg-primary px-7 py-3.5 text-sm font-bold text-primary-foreground transition-opacity hover:opacity-90",
            }),
          }),
        ],
      }),
