...
import { D as description$22 } from "./router-B49B_5De.mjs";
...
import { i as deleteMistake, l as listMistakes, m as saveMistake } from "./student-evaluation.functions-BvZ2alR-.mjs";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-CbSL31Oe.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/mistakes-bank-xSxqUR7a.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "XCircle",
		subtitle: bi(description$22, "Log the questions you get wrong yourself, and track them until you master them."),
		children: [
