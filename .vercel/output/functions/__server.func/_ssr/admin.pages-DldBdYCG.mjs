...
import {
  i as saveBackendPage,
  n as listBackendPages,
  r as loadBackendPageOptions,
  t as deleteBackendPage,
} from "./admin-pages-CPEBK60p.mjs";
import {
  i as RetryButton,
  r as LoadingState,
  t as ErrorState,
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.pages-DldBdYCG.js
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: isLoading
              ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoadingState, {
                  label: bi("عم نحمّل الصفحات…", "Loading pages…"),
                })
              : isError
                                    ...
                                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                      ...
                                      children: [
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                          ...
                                          children: p.is_active
                                            ? bi("نشطة", "Active")
                                            : bi("غير نشطة", "Inactive"),
                                        }),
                                        p.in_menu &&
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                            className:
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, {
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
                children: editingId ? bi("تعديل صفحة", "Edit page") : bi("إضافة صفحة", "Add page"),
              }),
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {
                            placeholder: bi("اختر الفئة", "Select category"),
                          }),
                        }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
                      children: bi("الوحدة (اختياري)", "Module (optional)"),
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {
                            placeholder: bi("بدون وحدة", "No module"),
                          }),
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, {
                          children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
                      children: bi("الصفحة الأب (اختياري)", "Parent page (optional)"),
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {
                            placeholder: bi("بدون أب", "No parent"),
                          }),
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, {
                          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogHeader, {
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogTitle, {
                  children: bi(`حذف «${pendingDelete?.name}»؟`, `Delete "${pendingDelete?.name}"?`),
                }),
