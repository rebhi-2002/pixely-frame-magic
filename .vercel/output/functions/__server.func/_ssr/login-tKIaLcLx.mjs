...
import { _ as login, l as USERS, w as useBi } from "./rbac-static-data-g2eybyR5.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/login-tKIaLcLx.js
...
function LoginPage() {
	...
	async function submit(e) {
		...
		try {
			...
			const message = err instanceof Error ? err.message : bi("تعذّر تسجيل الدخول", "Sign in failed");
