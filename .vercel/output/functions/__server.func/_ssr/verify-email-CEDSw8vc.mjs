...
import { z as MailCheck } from "../_libs/lucide-react.mjs";
import { F as Route$52, I as currentUserHome } from "./router-D9hWsH17.mjs";
import { s as stringType } from "../_libs/zod.mjs";
import { n as AuthShell, t as AuthField } from "./auth-shell-B7r5y7wC.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/verify-email-CEDSw8vc.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function VerifyEmailPage() {
  const { t } = useTranslation();
  const navigate = useNavigate();
  const { email: initialEmail } = Route$52.useSearch();
    ...
    children: [
      verified
        ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            ...
            className:
              "inline-flex w-full items-center justify-center rounded-xl bg-primary px-4 py-3 text-sm font-bold text-primary-foreground transition-opacity hover:opacity-90",
        ...
        : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                ...
                disabled: loading,
                className:
                  "w-full rounded-xl bg-primary px-4 py-3 text-sm font-bold text-primary-foreground transition-opacity hover:opacity-90 disabled:opacity-60",
