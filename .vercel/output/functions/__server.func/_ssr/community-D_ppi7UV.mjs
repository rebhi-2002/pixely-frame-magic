...
import { M as description$27 } from "./router-D9hWsH17.mjs";
...
import { a as getCommunityStats, c as listCommunityQuestions, f as saveCommunityQuestion, n as deleteCommunityQuestion } from "./student-social.functions-jnV5Sf8I.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/community-D_ppi7UV.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "MessagesSquare",
		subtitle: bi(description$27, "Ask in your subject community and answer classmates — teacher answers are highlighted."),
		children: [
