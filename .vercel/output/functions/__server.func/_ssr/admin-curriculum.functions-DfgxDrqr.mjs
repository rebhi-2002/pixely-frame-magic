...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-curriculum.functions-DfgxDrqr.js
var PAYMENTS = [
  {
    id: "pay-1",
    code: "#PAY-9281",
...
var listPayments = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listPayments_createServerFn_handler, async ({ context }) => {
...
var savePayment = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      ...
      status: enumType(["ناجحة", "قيد المعالجة", "مستردة", "فاشلة"]),
    }).parse(input),
  )
  .handler(savePayment_createServerFn_handler, async ({ data, context }) => {
...
var deletePayment = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deletePayment_createServerFn_handler, async ({ data, context }) => {
...
var listCurriculumSubjects = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listCurriculumSubjects_createServerFn_handler, async ({ context }) => {
...
var saveCurriculumSubject = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
  ...
  .handler(saveCurriculumSubject_createServerFn_handler, async ({ data, context }) => {
...
var deleteCurriculumSubject = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteCurriculumSubject_createServerFn_handler, async ({ data, context }) => {
...
var listCurriculumRequests = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listCurriculumRequests_createServerFn_handler, async ({ context }) => {
...
var saveCurriculumRequest = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
      ...
      entityType: enumType(["وحدة", "مادة", "مجموعة", "صف", "كورس"]),
      status: enumType(["جديد", "قيد الدراسة", "جاهز للاعتماد", "معتمد", "مرفوض"]),
    }).parse(input),
  )
  .handler(saveCurriculumRequest_createServerFn_handler, async ({ data, context }) => {
...
var deleteCurriculumRequest = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteCurriculumRequest_createServerFn_handler, async ({ data, context }) => {
...
//#endregion
export {
  deleteCurriculumRequest_createServerFn_handler,
  deleteCurriculumSubject_createServerFn_handler,
  deletePayment_createServerFn_handler,
  listCurriculumRequests_createServerFn_handler,
  listCurriculumSubjects_createServerFn_handler,
  listPayments_createServerFn_handler,
  saveCurriculumRequest_createServerFn_handler,
  saveCurriculumSubject_createServerFn_handler,
  savePayment_createServerFn_handler,
};
