...
import { w as description$19 } from "./router-ClmuBdEg.mjs";
...
import { i as deleteScheduleEvent, m as saveScheduleEvent, u as listScheduleEvents } from "./student-social.functions-BuOgRMKS.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/schedule-CyJocTlu.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "CalendarDays",
		subtitle: bi(description$19, "A schedule that reminds you: classes, homework, exams and review sessions."),
		children: [
