...
import { M as useBi, N as usePreferences } from "./rbac-static-data-6lJhuenE.mjs";
import { Dt as ChevronDown, E as Search, Et as ChevronLeft, F as PanelRightClose, P as PanelRightOpen, R as Moon, S as Settings, U as Menu, _ as Sun, et as Languages, n as X, q as LogOut, rt as House } from "../_libs/lucide-react.mjs";
...
import { n as SignOutOverlay, r as useSignOut, t as BrandLockup } from "./use-sign-out-D_PN5UY0.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/route-BhfG-Dou.js
...
function AppSidebar({ access, collapsed, onToggle, onClose, onNavigate }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
		className: cn("shadow-elevation-2 flex h-full shrink-0 flex-col border-e border-sidebar-border bg-sidebar text-sidebar-foreground transition-[width] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]", collapsed ? "w-[76px]" : "w-72"),
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SignOutOverlay, { pending: signingOut }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center justify-between gap-2 border-b border-sidebar-border px-3 py-4",
				children: [
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									className: cn("flex min-h-11 w-full items-center gap-2.5 rounded-xl border-s-2 border-transparent px-3 py-2.5 text-sm font-semibold transition-all duration-200", "hover:bg-sidebar-accent", open && !collapsed && "border-sidebar-primary bg-sidebar-accent", collapsed && "justify-center px-0"),
								...
								collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
									...
									children: collectLeaves(m.pages).map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
										...
										title: label(p),
										"aria-label": label(p),
										"aria-current": isActive(p.path) ? "page" : void 0,
