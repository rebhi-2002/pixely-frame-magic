...
import {
  a as deleteMockExam,
  c as listExamAttempts,
  h as saveMockExam,
  p as saveExamAttempt,
  r as deleteExamAttempt,
  u as listMockExams,
} from "./student-evaluation.functions-3Zz7sFfU.mjs";
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
        ...
        icon: "FileText",
        action: can("student_exam", "show_add_form")
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
        ...
        action: can("student_exam", "show_add_form")
          ...
          : void 0,
        children: attemptsQuery.isLoading
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className: "flex justify-center py-8",
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, {
                className: "size-5 animate-spin text-primary",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, {
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
                children: editingExamId
                  ? bi("تعديل امتحان", "Edit exam")
                  : bi("إضافة امتحان", "Add exam"),
              }),
            }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogHeader, {
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogTitle, {
                  children: bi(
                    `حذف «${pendingDeleteExam?.title}»؟`,
                    `Delete "${pendingDeleteExam?.title}"?`,
                  ),
                }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogFooter, {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogAction, {
                  onClick: () =>
                    pendingDeleteExam && examDeleteMutation.mutate(pendingDeleteExam.id),
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogContent, {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogHeader, {
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogTitle, {
                  children: bi("حذف هذه النتيجة؟", "Delete this result?"),
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogDescription, {
                  children: bi("لا يمكن التراجع عن هذا الإجراء.", "This action cannot be undone."),
                }),
