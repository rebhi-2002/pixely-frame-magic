...
import {
  c as markAllNotificationsRead,
  l as markNotificationRead,
  n as deleteNotification,
  s as listNotifications,
} from "./account-pages.functions-DYFg9M0e.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/notifications-CkChrovt.js
...
function Body() {
  ...
  const earlier = (0, import_react.useMemo)(
    () => list.filter((r) => r.category === "سابقاً"),
    [list],
  );
