...
import { w as description$19 } from "./router-D9hWsH17.mjs";
...
import { l as listReferrals, o as getReferralLink, p as saveReferral, r as deleteReferral } from "./student-social.functions-jnV5Sf8I.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/referrals-BJmuPEGS.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Gift",
		subtitle: bi(description$19, "Invite friends with your own link, and track who joined and what you earned."),
		children: [
