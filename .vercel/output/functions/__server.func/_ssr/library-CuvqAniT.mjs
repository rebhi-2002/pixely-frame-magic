...
import { O as description$23 } from "./router-D9hWsH17.mjs";
...
import { c as listLibrarySubjects, p as saveLibrarySubject, r as deleteLibrarySubject } from "./student-learning.functions-BZT1Glc7.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/library-CuvqAniT.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Library",
		subtitle: bi(description$23, "A tidy library: term → subject → unit → lesson. No more files lost in WhatsApp."),
		children: [
