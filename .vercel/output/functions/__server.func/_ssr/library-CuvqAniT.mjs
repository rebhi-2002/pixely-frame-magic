...
import {
  ...
  p as saveLibrarySubject,
  r as deleteLibrarySubject,
...
function Body() {
  ...
  const continueList = (0, import_react.useMemo)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
        ...
        icon: "Book",
        action: can("student_library", "show_add_form")
