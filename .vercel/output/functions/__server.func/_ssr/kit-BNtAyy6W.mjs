...
import { R as EmptyIllustration } from "./router-B49B_5De.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/kit-BNtAyy6W.js
		...
		children: items.map((s, i) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "shadow-elevation-1 h-full rounded-2xl border border-border bg-card p-4",
					children: [
