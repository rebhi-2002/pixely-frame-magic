...
import {
  n as useTranslation,
  r as initReactI18next,
  t as I18nextProvider,
} from "../_libs/react-i18next.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/rbac-static-data-Bv6QEjHq.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var API_BASE_URL =
  "https://ziadkamalaln2842-001-site1.etempurl.com".replace(/\/+$/, "") ?? "https://localhost:7176";
...
async function request(path, init = {}) {
  ...
  if (!res.ok) {
    const backendMessage =
      data && typeof data === "object" && "message" in data ? data.message : void 0;
...
var ar_default = {
  ...
  nav: {
    ...
    tagline:
      "منصة عربية تساعد طلاب الثانوية ينظّموا موادهم، يتابعوا إنجازهم، ويجهّزوا للامتحان الوزاري بثقة.",
  ...
  pricing: {
    meta: {
      ...
      description:
        "خطة مجانية كاملة للبداية، وخطة مميزة لمحاكي الامتحان وبنك الأخطاء والتقارير المتقدمة.",
    },
  ...
  forTeachers: {
    meta: {
      ...
      description:
        "ارفع محتواك مرة واحدة، جهّز Quizzes تُصحَّح تلقائياً، وتابع أداء طلابك بتقارير واضحة.",
    },
  ...
  privacy: {
    h1: "سياسة الخصوصية",
    intro:
      "مسودة أولية بانتظار المراجعة القانونية النهائية — نكتبها بلغة مفهومة لأنها تخصّك فعلاً.",
    sections: [
      {
  ...
  terms: {
    h1: "شروط الاستخدام",
    intro:
      "باستخدامك منصة أكاديميا (والتطبيقات المرتبطة بها)، فإنك توافق على الشروط التالية. مسودة أولية بانتظار المراجعة القانونية النهائية — قابلة للتحديث.",
    sections: [
      {
        t: "القبول بالشروط",
...
var en_default = {
  ...
  nav: {
    ...
    terms: "Terms of use",
    tagline:
      "An Arabic-first platform helping high-school students organize their subjects, track achievement, and prepare for the national exam with confidence.",
  ...
  home: {
    meta: {
      ...
      description:
        "Academia: an organized smart library, subject communities, achievement tracking, a mistake bank and a national-exam simulator — all your studying in one place.",
    },
    ...
    featuresSub:
      "Not a file archive — real tools that help you finish and master, built around how you actually study.",
    features: {
      library: {
        title: "Smart library",
    ...
    ctaSub:
      "Sign up in a minute, pick your subjects, set your first weekly goal — we handle the rest.",
  ...
  howItWorks: {
    meta: {
      ...
      description:
        "Four steps only: sign up and pick your role, set your system, grade and subjects, start from the organized library, and track your progress weekly.",
    },
  ...
  pricing: {
    meta: {
      ...
      description:
        "A fully free plan to start, and a premium plan for the exam simulator, mistake bank and advanced reports.",
    },
  ...
  forTeachers: {
    meta: {
      ...
      description:
        "Upload your content once, build auto-graded Quizzes, and track your students with clear reports.",
    },
  ...
  privacy: {
    h1: "Privacy Policy",
    intro:
      "Initial draft pending final legal review — written in plain language because it's genuinely about you.",
    sections: [
      {
        t: "Data We Collect",
  ...
  terms: {
    h1: "Terms of Service",
    intro:
      "By using Academia (and its related apps), you agree to the following terms. Initial draft pending final legal review — subject to updates.",
    sections: [
      {
...
var ar_pages_default = {
  ...
  teacherProfile: {
    ...
    aboutTitle: "نبذة",
    about:
      "معلّم على منصة أكاديميا، يرفع محتواه مصنّفاً حسب الفصل والمادة والوحدة والدرس، ويتابع أداء طلابه عبر Quizzes وتقارير دورية.",
  ...
  blog: {
    meta: {
      ...
      description:
        "مقالات عملية عن تنظيم المذاكرة والتعلّم والتحضير للامتحان الوزاري لطلاب المرحلة الثانوية.",
    },
    h1: "مدونة أكاديميا",
...
var en_pages_default = {
  ...
  authPages: {
    login: {
      meta: {
        title: "Sign in | Academia",
        description:
          "Sign in to your Academia account and pick up your studying where you left off.",
      },
      h1: "Welcome back",
    ...
    signup: {
      meta: {
        ...
        description:
          "Create your Academia account and pick your role: student, parent, or teacher.",
      },
    ...
    teacherRegister: {
      meta: {
        ...
        description:
          "Register as a teacher on Academia and upload your verification document for review.",
      },
  ...
  about: {
    meta: {
      ...
      description:
        "The Academia story: an Arabic-first team building an organization and achievement platform for high-school students.",
    },
    ...
    mission:
      "Help every Arabic-speaking student turn a pile of files into a clear plan they can actually finish, step by step.",
    values: [
      {
    ...
    teamTitle: "The team",
    teamSub:
      "A small team of engineers, teachers and designers working close to students and schools.",
    team: [
      {
        t: "Product & design",
  ...
  courses: {
    meta: {
      ...
      description:
        "Browse courses from verified Academia teachers by subject and level before creating an account.",
    },
  ...
  teacherProfile: {
    ...
    aboutTitle: "About",
    about:
      "An Academia teacher who uploads content classified by term, subject, unit and lesson, and tracks student performance through quizzes and periodic reports.",
  ...
  certificate: {
    meta: {
      ...
      description:
        "Verify the authenticity of a digital certificate issued by Academia using its ID.",
    },
  ...
  help: {
    meta: {
      ...
      description:
        "Quick answers about accounts, subscriptions, the library, and privacy on Academia.",
    },
    h1: "Help center",
  ...
  contact: {
    meta: {
      ...
      description:
        "Have a question, a suggestion, or want a school partnership? The Academia team is ready to listen.",
    },
    h1: "Contact us",
  ...
  blog: {
    meta: {
      ...
      description:
        "Practical study organization, learning and national-exam preparation articles for high-school students.",
    },
    h1: "Academia Blog",
    ...
    ctaSub:
      "Academia has a study schedule, a mistake bank, and an exam simulator to help you apply all this daily.",
    ...
    children: [
      ...
      switchingLocale &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          "aria-hidden": "true",
          className:
            "pointer-events-none fixed inset-0 z-[80] flex items-center justify-center bg-background/45 backdrop-blur-[2px]",
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
            className:
              "size-6 animate-spin rounded-full border-2 border-primary/30 border-t-primary",
          }),
        }),
    ],
  });
...
export {
  usePreferences as A,
  nextId as C,
  roleKeyFromName as D,
  roleHome as E,
  throwBilingual as O,
  logout as S,
  preferencesBootScript as T,
  isAuthenticated as _,
  PERMISSION_KEYS as a,
  login as b,
  ROLE_PERMISSION_GRANTS as c,
  apiClient as d,
  getErrorMessage as f,
  i18n_default as g,
  getStoredUserId as h,
  PAGES as i,
  verifyServerSession as j,
  useBi as k,
  USERS as l,
  getStoredProfile as m,
  DEMO_USER_COOKIE as n,
  PreferencesProvider as o,
  getStoredEmail as p,
  MODULES as r,
  ROLES as s,
  AUTH_EVENT as t,
  allowedPublicPaths as u,
  isDemoSession as v,
  pageMatchesRole as w,
  loginAsDemo as x,
  isRealAdmin as y,
};
