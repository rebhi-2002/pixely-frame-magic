...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-curriculum.functions-eb1RYtX0.js
...
createServerFn({ method: "POST" }).middleware([requireAuth]).inputValidator((input) => objectType({ id: stringType() }).parse(input)).handler(createSsrRpc("034b2c7e0457f7f9fe084fe9c10a268ed12ece6f6759483be1d0fb7626214e9e"));
...
//#endregion
export { listPayments as a, listCurriculumSubjects as i, deleteCurriculumSubject as n, saveCurriculumRequest as o, listCurriculumRequests as r, saveCurriculumSubject as s, deleteCurriculumRequest as t };
