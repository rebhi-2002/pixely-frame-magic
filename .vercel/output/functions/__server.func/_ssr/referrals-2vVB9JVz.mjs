...
import { l as listReferrals, o as getReferralLink, p as saveReferral, r as deleteReferral } from "./student-social.functions-u1FVOSpN.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/referrals-2vVB9JVz.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "ادعُ أصدقاءك برابطك الخاص، وتابع كم صديق سجّل فعلياً ومكافآتك.";
function PageRoute() {
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Gift",
		subtitle: bi(description, "Invite friends with your own link, and track who joined and what you earned."),
		children: [
