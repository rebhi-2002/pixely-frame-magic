...
import { k as description$24 } from "./router-D9kxMA2z.mjs";
...
import { c as listLibrarySubjects, p as saveLibrarySubject, r as deleteLibrarySubject } from "./student-learning.functions-B92PisyR.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/library-CkYF2BQo.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Library",
		subtitle: bi(description$24, "A tidy library: term → subject → unit → lesson, so you can track every subject in one place."),
		children: [
