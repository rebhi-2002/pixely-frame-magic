...
import { A as useBi, N as wasJustRegistered, g as getStoredUserId } from "./rbac-static-data-DgiM51a_.mjs";
import { v as require_jsx_runtime } from "../_libs/@radix-ui/react-accordion+[...].mjs";
import { n as useQuery } from "../_libs/tanstack__react-query.mjs";
import { $ as LoaderCircle } from "../_libs/lucide-react.mjs";
import { s as description$6 } from "./router-D4MhNWYA.mjs";
import { n as useServerFn } from "./createSsrRpc-UbjxkEih.mjs";
import { n as Guard } from "./guard-BxeumIGg.mjs";
import { c as QuickLinks, i as EmptyState, l as RowList, o as Panel, t as AppPage, u as StatGrid } from "./kit-Dw-xVBiN.mjs";
import { i as WelcomeBanner, t as ComparisonChart } from "./charts-D6Mk3eBt.mjs";
import { t as OnboardingChecklist } from "./onboarding-checklist-CwG01ZsZ.mjs";
import { a as listOpenClassQuestions, i as listContentItems, o as listQuizItems, s as listTeacherCourses } from "./teacher-teaching.functions-_9XI7-2b.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.dashboard-DeFQ3PkM.js
...
function Body() {
	...
	const courses = (0, import_react.useMemo)(() => coursesQuery.data ?? [], [coursesQuery.data]);
	const content = (0, import_react.useMemo)(() => contentQuery.data ?? [], [contentQuery.data]);
	const quizzes = (0, import_react.useMemo)(() => quizzesQuery.data ?? [], [quizzesQuery.data]);
	const openQuestions = (0, import_react.useMemo)(() => questionsQuery.data ?? [], [questionsQuery.data]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		subtitle: bi(description$6, "Your classes today: what needs grading, questions awaiting you, and student performance."),
		children: [
