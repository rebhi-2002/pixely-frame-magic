...
import { a as Panel, c as RowList, i as EmptyState, l as StatGrid, t as AppPage } from "./kit-DhXVWrh8.mjs";
import { a as getSupervisionSettings, l as recordReportDownload, n as deleteSupervisionReport, s as listSupervisionReports } from "./supervisor-oversight.functions-BQYJ6ek4.mjs";
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppPage, {
		...
		icon: "FileBarChart",
		subtitle: bi(description$13, "Periodic exportable reports: teaching quality, mastery and consistency."),
