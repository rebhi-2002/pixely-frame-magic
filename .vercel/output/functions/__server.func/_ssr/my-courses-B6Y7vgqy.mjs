...
import { E as description$21 } from "./router-D9kxMA2z.mjs";
...
import { d as saveEnrollment, o as listEnrollments, t as deleteEnrollment } from "./student-learning.functions-B92PisyR.mjs";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-CbSL31Oe.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/my-courses-B6Y7vgqy.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "BookOpenCheck",
		subtitle: bi(description$21, "Courses you actually enrolled in — progress, next session and completion certificate."),
		children: [
