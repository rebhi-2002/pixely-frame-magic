...
import { c as listTeacherPerformance, o as listStudentRisk, s as listSupervisionReports } from "./supervisor-oversight.functions-Beyn8Pa2.mjs";
import { i as listContentItems } from "./teacher-teaching.functions-D_QDlVah.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/supervisor.dashboard-yq6IjAHI.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "جودة التعليم عبر المعلمين والصفوف: تنبيهات، متابعات، ومؤشرات إتقان.";
function PageRoute() {
...
function Body() {
	...
	const teachers = (0, import_react.useMemo)(() => teachersQuery.data ?? [], [teachersQuery.data]);
	const students = (0, import_react.useMemo)(() => studentsQuery.data ?? [], [studentsQuery.data]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		subtitle: bi(description, "Teaching quality across teachers and classes: alerts, follow-ups and mastery signals."),
