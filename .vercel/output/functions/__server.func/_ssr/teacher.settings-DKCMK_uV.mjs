...
import { a as Panel, c as RowList, l as StatGrid, s as QuickLinks, t as AppPage } from "./kit-DDkPK7fJ.mjs";
...
import { a as getTeacherSettings, f as saveTeacherSettings } from "./account-pages.functions-HkQ4VxLi.mjs";
import { t as description } from "./teacher.settings-D8bydaMM.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.settings-DKCMK_uV.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Settings",
		subtitle: bi(description, "Pricing, availability, payout details and notification preferences."),
