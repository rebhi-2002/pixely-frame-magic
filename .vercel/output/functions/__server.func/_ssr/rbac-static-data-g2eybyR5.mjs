...
//#region node_modules/.nitro/vite/services/ssr/assets/rbac-static-data-g2eybyR5.js
...
async function login(email, password) {
	...
	if (!profile) throw new Error("تم تسجيل الدخول، لكن تعذّر التحقق من الملف الشخصي");
	writeStoredSession({
		email: profile.email,
		loggedInAt: Date.now(),
		userId: profile.id,
...
//#endregion
export { roleKeyFromName as C, verifyServerSession as E, roleHome as S, usePreferences as T, login as _, PERMISSION_KEYS as a, pageMatchesRole as b, ROLE_PERMISSION_GRANTS as c, apiClient as d, getStoredEmail as f, isAuthenticated as g, i18n_default as h, PAGES as i, USERS as l, getStoredUserId as m, DEMO_USER_COOKIE as n, PreferencesProvider as o, getStoredProfile as p, MODULES as r, ROLES as s, AUTH_EVENT as t, allowedPublicPaths as u, logout as v, useBi as w, preferencesBootScript as x, nextId as y };
