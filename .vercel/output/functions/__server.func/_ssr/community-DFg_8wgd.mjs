...
import { N as description$28 } from "./router-D9kxMA2z.mjs";
...
import { a as getCommunityStats, c as listCommunityQuestions, f as saveCommunityQuestion, n as deleteCommunityQuestion } from "./student-social.functions-CSIreZkV.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/community-DFg_8wgd.js
...
function Body() {
	...
	const questions = (0, import_react.useMemo)(() => questionsQuery.data ?? [], [questionsQuery.data]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "MessagesSquare",
		subtitle: bi(description$28, "Log your questions per subject, and track their status until answered."),
		children: [
