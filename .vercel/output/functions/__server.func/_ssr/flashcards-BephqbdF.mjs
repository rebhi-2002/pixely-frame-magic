...
import { D as RotateCw, M as Pencil, St as ChevronLeft, Y as LoaderCircle, j as Plus, p as Trash2, xt as ChevronRight } from "../_libs/lucide-react.mjs";
import { k as description$24 } from "./router-B49B_5De.mjs";
...
import { f as saveFlashcardDeck, n as deleteFlashcardDeck, s as listFlashcardDecks } from "./student-learning.functions-CV2mHTOR.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/flashcards-BephqbdF.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Layers",
		subtitle: bi(description$24, "A tracker for your card decks: how many cards, how many due, how many mastered."),
		children: [
