...
import { z as WelcomeIllustration } from "./router-D9hWsH17.mjs";
import { n as PreferenceToggles, t as BrandMark } from "./public-layout-CgDhl5-6.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-shell-B7r5y7wC.js
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WelcomeIllustration, {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    icon &&
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className:
                          "flex size-11 shrink-0 items-center justify-center rounded-xl bg-primary/12 text-primary",
                        children: icon,
                      }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className: "min-w-0",
...
function AuthField({
  ...
  const describedBy =
    [hint && `${id}-hint`, error && `${id}-error`].filter(Boolean).join(" ") || void 0;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          isPassword &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
              ...
              className:
                "absolute end-2 top-1/2 inline-flex size-8 -translate-y-1/2 items-center justify-center rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground focus-visible:outline-none",
              children: visible
