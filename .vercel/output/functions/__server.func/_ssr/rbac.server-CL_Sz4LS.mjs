...
import { i as TSS_SERVER_FUNCTION } from "./server-EBKWEHZn.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/rbac.server-CL_Sz4LS.js
...
async function loadAccess(userId) {
  ...
  const grantedSet = isAdmin
    ? null
    : (ROLE_PERMISSION_GRANTS[role?.id ?? ""] ?? /* @__PURE__ */ new Set());
...
export {
  ...
  loadUsers as i,
  loadAccess as n,
  requirePageAction as o,
  loadPermissionMatrix as r,
  requirePermission as s,
  createServerRpc as t,
};
