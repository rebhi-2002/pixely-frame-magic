...
//#region node_modules/.nitro/vite/services/ssr/assets/courses-DuUu__F1.js
...
function CoursesPage() {
  ...
  const filtered = items.filter((i) => {
    ...
    return (
      (!q || title.includes(q) || teacher.includes(q)) &&
      (subject === "__all" || subjectLabel === subject)
    );
  });
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                      ...
                      className:
                        "h-11 w-full rounded-xl border border-border bg-card ps-9 pe-3 text-sm text-foreground outline-none placeholder:text-muted-foreground focus:border-primary",
                    }),
                  ],
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className: "flex flex-wrap gap-2",
                  children: ["__all", ...subjects].map((s) =>
                    ...
                    : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        children: filtered.map((c) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            ...
                            {
                              className:
                                "hover-lift flex flex-col rounded-2xl border border-border bg-card p-6",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                                  ...
                                  className:
                                    "hover-press mt-5 inline-flex items-center justify-center rounded-xl bg-primary px-4 py-2.5 text-sm font-bold text-primary-foreground hover:opacity-90",
