...
import { c as listLibrarySubjects, p as saveLibrarySubject, r as deleteLibrarySubject } from "./student-learning.functions-OnB3dj69.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/library-DoPihcmI.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "مكتبة مرتّبة: فصل ← مادة ← وحدة ← درس، لتتابع تقدّمك بكل مادة بمكان واحد.";
function PageRoute() {
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Library",
		subtitle: bi(description, "A tidy library: term → subject → unit → lesson, so you can track every subject in one place."),
		children: [
