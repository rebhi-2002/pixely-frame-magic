...
import { A as isResolvedRedirect, D as resolveManifestCssLink, E as resolveManifestAssetLink, I as invariant, N as rootRouteId, O as executeRewriteInput, P as isNotFound, T as getStylesheetHref, a as replaceSsrResponse, d as RouterProvider, i as normalizeSsrResponse, k as isRedirect, n as defineHandlerCallback, o as stripSsrResponseBody, r as isSsrResponse, t as renderRouterToStream, w as getScriptPreloadAttrs } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BTapPz0R.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CTBB_LQx.mjs"),
		import("./start-Ci_H9vh8.mjs"),
