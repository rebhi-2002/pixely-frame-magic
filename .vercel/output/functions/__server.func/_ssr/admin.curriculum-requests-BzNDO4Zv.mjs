...
import { E as Search, M as Plus, N as Pencil, Ot as Check, X as LoaderCircle, n as X, p as Trash2 } from "../_libs/lucide-react.mjs";
...
import { n as Toolbar, t as PageHeader } from "./page-header-BDwvM2RF.mjs";
import { n as Badge } from "./kit-CS2UTmaS.mjs";
...
import { o as saveCurriculumRequest, r as listCurriculumRequests, t as deleteCurriculumRequest } from "./admin-curriculum.functions-D5o1c3H4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin.curriculum-requests-BzNDO4Zv.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Toolbar, { children: [
				...
				can("admin_curriculum_requests", "show_add_form") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
					className: "ms-auto",
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										can("admin_curriculum_requests", "edit") && r.status !== "معتمد" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
											size: "icon",
											variant: "ghost",
										...
										can("admin_curriculum_requests", "edit") && r.status !== "مرفوض" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
											size: "icon",
											variant: "ghost",
											title: bi("رفض", "Reject"),
										...
										can("admin_curriculum_requests", "edit") && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
											size: "icon",
											variant: "ghost",
											title: bi("تعديل", "Edit"),
										...
										can("admin_curriculum_requests", "delete") && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
											size: "icon",
											variant: "ghost",
											title: bi("حذف", "Delete"),
											className: "text-destructive",
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-1.5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: bi("الكيان", "Entity") }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
									value: form.entityType,
									onValueChange: (v) => setForm((f) => ({
										...f,
										entityType: v
									})),
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, { children: ENTITY_TYPES.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
										value: t,
