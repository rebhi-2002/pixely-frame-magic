...
import { P as description$29 } from "./router-B49B_5De.mjs";
...
import { d as saveBadge, o as listBadges, t as deleteBadge } from "./student-evaluation.functions-BvZ2alR-.mjs";
import { a as getStudyStats, c as listLibrarySubjects } from "./student-learning.functions-CV2mHTOR.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/achievements-DzYsuUzR.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Trophy",
		subtitle: bi(description$29, "Progress measured by mastery, not hours: badges, streaks and per-subject mastery."),
		children: [
