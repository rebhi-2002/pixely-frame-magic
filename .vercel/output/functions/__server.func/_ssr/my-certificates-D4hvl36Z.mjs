...
import { D as description$22 } from "./router-D9kxMA2z.mjs";
...
import { f as saveCertificate, n as deleteCertificate, s as listCertificates } from "./student-evaluation.functions-Ra-JSMOC.mjs";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-CbSL31Oe.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/my-certificates-D4hvl36Z.js
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Award",
		subtitle: bi(description$22, "Your verifiable certificates — share the link and anyone can validate it."),
		children: [
