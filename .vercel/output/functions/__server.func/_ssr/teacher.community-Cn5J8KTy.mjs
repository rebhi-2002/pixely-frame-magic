...
import { It as Check, tt as LoaderCircle } from "../_libs/lucide-react.mjs";
...
import { i as listClassQuestions, t as answerClassQuestion } from "./teacher-followup.functions-DxyZt22N.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.community-Cn5J8KTy.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "أسئلة طلابك في مكان واحد، وسجّل جوابك عليها.";
function PageRoute() {
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppPage, {
		...
		icon: "MessagesSquare",
		subtitle: bi(description, "Your students' questions in one place, so you can log your answer."),
