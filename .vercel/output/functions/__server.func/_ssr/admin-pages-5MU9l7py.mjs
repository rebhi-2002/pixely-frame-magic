import { A as throwBilingual, d as apiClient } from "./rbac-static-data-6lJhuenE.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin-pages-5MU9l7py.js
function mapPage(p) {
	return {
		id: p.id ?? 0,
		name: p.name ?? "",
