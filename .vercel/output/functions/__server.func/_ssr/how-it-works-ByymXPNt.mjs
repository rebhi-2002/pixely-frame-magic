...
//#region node_modules/.nitro/vite/services/ssr/assets/how-it-works-ByymXPNt.js
var import_jsx_runtime = require_jsx_runtime();
var steps = ["role", "system", "subjects", "goal"];
function HowItWorks() {
            ...
            children: steps.map((s, i) =>
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                Reveal,
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "hover-lift shadow-elevation-1 flex gap-5 rounded-2xl border border-border bg-card p-6",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className:
                          "flex size-12 shrink-0 items-center justify-center rounded-xl bg-primary/12 font-display text-xl font-bold text-primary",
                        children: i + 1,
                      }),
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SessionCta, {
                  ...
                  className:
                    "btn-shine hover-press mt-7 inline-flex rounded-xl bg-primary px-6 py-3 text-sm font-bold text-primary-foreground",
                }),
              ],
            }),
          }),
