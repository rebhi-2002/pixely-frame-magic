...
import { M as Minus, gt as Check, m as Sparkles } from "../_libs/lucide-react.mjs";
...
import { t as FAQSection } from "./faq-section-CSlAaTLr.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/pricing-CRhVdc7v.js
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "shadow-elevation-1 mt-9 overflow-hidden rounded-2xl border border-border bg-card",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "grid grid-cols-[1fr_5rem_5rem] items-center gap-2 border-b border-border bg-card/60 px-5 py-3 sm:grid-cols-[1fr_7rem_7rem]",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                    className: "text-xs font-bold text-muted-foreground",
                    children: [t("pricing.compare.colFree"), " / ", t("pricing.compare.colPlus")],
                  }),
                    ...
                    children: [
                      ...
                      group.rows.map((row) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          ...
                          {
                            className:
                              "grid grid-cols-[1fr_5rem_5rem] items-center gap-2 border-t border-border px-5 py-3 sm:grid-cols-[1fr_7rem_7rem]",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  p.highlight &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                      className:
                        "mb-3 inline-flex w-fit items-center gap-1.5 rounded-full bg-primary/15 px-3 py-1 text-xs font-bold text-primary",
                      children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                        ...
                        children: [t("pricing.currency"), " / ", t(`pricing.${p.key}.note`)],
                      }),
                    ],
                  }),
