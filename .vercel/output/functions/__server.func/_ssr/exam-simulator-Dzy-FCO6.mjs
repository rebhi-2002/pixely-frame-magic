...
import { i as EmptyState, l as RowList, n as Badge, o as Panel, r as DataTable, t as AppPage, u as StatGrid } from "./kit--a5tGQyM.mjs";
...
import { a as deleteMockExam, c as listExamAttempts, h as saveMockExam, p as saveExamAttempt, r as deleteExamAttempt, u as listMockExams } from "./student-evaluation.functions-_PI2B2JK.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/exam-simulator-Dzy-FCO6.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "خطّط لامتحاناتك التجريبية، وسجّل نتيجتك وتحسّنك بعد كل محاولة.";
function PageRoute() {
...
function Body() {
	...
	const attempts = (0, import_react.useMemo)(() => attemptsQuery.data ?? [], [attemptsQuery.data]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "Timer",
		subtitle: bi(description, "Plan your practice exams, and log your score and progress after every attempt."),
		children: [
