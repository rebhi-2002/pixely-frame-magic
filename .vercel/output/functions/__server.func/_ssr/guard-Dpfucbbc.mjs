...
import {
  D as roleKeyFromName,
  E as roleHome,
  k as useBi,
  w as pageMatchesRole,
} from "./rbac-static-data-Bv6QEjHq.mjs";
import { R as ForbiddenIllustration } from "./router-D9hWsH17.mjs";
import { d as useAccess } from "./use-access-BL6Bw5Ej.mjs";
import { t as DashboardSkeleton } from "./dashboard-skeleton-CXWjwNnl.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/guard-Dpfucbbc.js
...
function Forbidden() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    className:
      "surface-mesh flex min-h-screen flex-col items-center justify-center bg-background px-5 text-center",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ForbiddenIllustration, {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
        ...
        className:
          "btn-shine hover-press mt-6 inline-flex items-center justify-center rounded-xl bg-primary px-6 py-3 text-sm font-bold text-primary-foreground",
