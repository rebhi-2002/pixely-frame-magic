...
import { Ct as CircleX, Nt as ChartLine, Rt as BookOpenCheck, mt as EyeOff, pt as Eye } from "../_libs/lucide-react.mjs";
import { Y as WelcomeIllustration, yt as useBi } from "./router-DK5KNs7n.mjs";
import { n as PreferenceToggles, t as BrandMark } from "./public-layout-CtH4MgCV.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-shell-BWOlnfLm.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mx-auto grid w-full max-w-6xl items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
									...
									className: "mt-1 max-w-md text-sm leading-6 text-muted-foreground",
									children: subtitle
								})]
							})]
						}), children]
