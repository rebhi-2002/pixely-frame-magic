...
import { c as listTeacherPerformance, d as saveTeacherPerformance, r as deleteTeacherPerformance } from "./supervisor-oversight.functions-Beyn8Pa2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/supervisor.teachers-iDIzfkwg.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "أداء كل معلم: سرعة الرد، زمن التصحيح، وإتقان طلابه.";
function PageRoute() {
