...
import { l as saveQuizItem, n as deleteQuizItem, o as listQuizItems } from "./teacher-teaching.functions-D_QDlVah.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.quizzes-DRAIm1kF.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "بنك أسئلتك واختباراتك: اختيار متعدد، صح/خطأ، ومقالي.";
function PageRoute() {
