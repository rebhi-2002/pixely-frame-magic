...
import { F as Plus, I as Pencil, It as Check, m as Trash2, tt as LoaderCircle } from "../_libs/lucide-react.mjs";
...
import { i as EmptyState, n as Badge, o as Panel, r as DataTable, t as AppPage, u as StatGrid } from "./kit--a5tGQyM.mjs";
...
import { a as listGradingItems, n as deleteGradingItem, s as saveGradingItem } from "./teacher-followup.functions-DxyZt22N.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/teacher.grading-Cx3f7w0u.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var description = "قائمة التصحيح: الأسئلة المقالية والملفات المرفوعة، مع ملاحظات لكل طالب.";
function PageRoute() {
...
function Body() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppPage, {
		...
		icon: "PenSquare",
		subtitle: bi(description, "The grading queue: essay answers and uploaded files, with per-student feedback."),
		children: [
