...
import { o as requirePageAction, t as createServerRpc } from "./rbac.server-CL_Sz4LS.mjs";
import {
  a as UPCOMING_TASKS,
  i as STUDY_STATS,
  n as FLASHCARD_DECKS,
  o as WEEKLY_STUDY_LOG,
  r as LIBRARY_SUBJECTS,
  s as nextStudentId,
  t as ENROLLMENTS,
} from "./student-learning-data-C3xcWuN0.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/student-learning.functions-DVw8P797.js
...
var listEnrollments = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listEnrollments_createServerFn_handler, async ({ context }) => {
...
var saveEnrollment = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  ...
  .handler(saveEnrollment_createServerFn_handler, async ({ data, context }) => {
...
var deleteEnrollment = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteEnrollment_createServerFn_handler, async ({ data, context }) => {
...
var listLibrarySubjects = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listLibrarySubjects_createServerFn_handler, async ({ context }) => {
...
var saveLibrarySubject = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
  ...
  .handler(saveLibrarySubject_createServerFn_handler, async ({ data, context }) => {
...
var deleteLibrarySubject = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteLibrarySubject_createServerFn_handler, async ({ data, context }) => {
...
var listFlashcardDecks = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listFlashcardDecks_createServerFn_handler, async ({ context }) => {
...
var saveFlashcardDeck = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
  ...
  .handler(saveFlashcardDeck_createServerFn_handler, async ({ data, context }) => {
...
var deleteFlashcardDeck = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteFlashcardDeck_createServerFn_handler, async ({ data, context }) => {
...
var listWeeklyStudyLog = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listWeeklyStudyLog_createServerFn_handler, async ({ context }) => {
...
var updateWeeklyStudyMinutes = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      dayAr: stringType(),
  ...
  .handler(updateWeeklyStudyMinutes_createServerFn_handler, async ({ data, context }) => {
...
var listUpcomingTasks = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(listUpcomingTasks_createServerFn_handler, async ({ context }) => {
    await requirePageAction(context.userId, "student_dashboard", "view_list");
...
var saveUpcomingTask = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
      id: stringType().optional(),
      ...
      type: enumType(["امتحان", "واجب", "مراجعة"]),
    }).parse(input),
  )
  .handler(saveUpcomingTask_createServerFn_handler, async ({ data, context }) => {
...
var deleteUpcomingTask = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) => objectType({ id: stringType() }).parse(input))
  .handler(deleteUpcomingTask_createServerFn_handler, async ({ data, context }) => {
...
var getStudyStats = createServerFn({ method: "GET" })
  .middleware([requireAuth])
  .handler(getStudyStats_createServerFn_handler, async ({ context }) => {
    await requirePageAction(context.userId, "student_dashboard", "view_list");
    return STUDY_STATS;
  });
...
var saveStudyStats = createServerFn({ method: "POST" })
  .middleware([requireAuth])
  .inputValidator((input) =>
    objectType({
  ...
  .handler(saveStudyStats_createServerFn_handler, async ({ data, context }) => {
    await requirePageAction(context.userId, "student_dashboard", "edit");
...
export {
  ...
  deleteFlashcardDeck_createServerFn_handler,
  deleteLibrarySubject_createServerFn_handler,
  deleteUpcomingTask_createServerFn_handler,
  getStudyStats_createServerFn_handler,
  listEnrollments_createServerFn_handler,
  listFlashcardDecks_createServerFn_handler,
  listLibrarySubjects_createServerFn_handler,
  listUpcomingTasks_createServerFn_handler,
  listWeeklyStudyLog_createServerFn_handler,
  saveEnrollment_createServerFn_handler,
  saveFlashcardDeck_createServerFn_handler,
  saveLibrarySubject_createServerFn_handler,
  saveStudyStats_createServerFn_handler,
