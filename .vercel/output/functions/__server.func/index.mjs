...
var services = { ["ssr"]: lazyService(() => import("./_ssr/ssr.mjs").then((n) => n.f)) };
...
var _lazy_wfKs6W = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_wfKs6W
	};
	return ((_m, p) => {
		return {
			data,
