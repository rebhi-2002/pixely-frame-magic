    ...
    if (node.wildcard)
      for (let i = node.wildcard.length - 1; i >= 0; i--) {
        ...
        if (suffix) {
          ...
          if (
            (segment.caseSensitive ? suffixPart : suffixPart.toLowerCase()) !== suffix ||
      ...
      if (!isBeyondPath)
        for (let i = node.optional.length - 1; i >= 0; i--) {
          ...
          if (prefix || suffix) {
            ...
            if (suffix && casePart.indexOf(suffix, casePart.length - suffix.length) < prefix.length)
              continue;
          }
          stack.push({
            node: segment,
...
function createLoaderTask$1(router, lane, index, tasks, semanticParent, options, retainedEnd) {
  ...
  const background = !!(
    ...
    !preload &&
    !options[4] &&
    ((isLoaderFn ? void 0 : routeLoader.staleReloadMode) ??
...
function ClientOnly({ children, fallback = null }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Fragment, {
    children: useHydrated() ? children : fallback,
  });
}
/**
...
//#endregion
export {
  _getRenderedMatches as A,
  rootRouteId as B,
  TSR_SCRIPT_BARRIER_ID as C,
  getStylesheetHref as D,
  getScriptPreloadAttrs as E,
  dehydrateSsrMatchId as F,
  require_shim as H,
  isRedirect as I,
  isResolvedRedirect as L,
  invariant as M,
  createLRUCache as N,
  resolveManifestAssetLink as O,
  decodePath as P,
  parseRedirect as R,
  GLOBAL_TSR as S,
  createInlineCssStyleAsset as T,
  isNotFound as V,
  createFileRoute as _,
  isSsrResponse as a,
  useNavigate as b,
  stripSsrResponseBody as c,
  useLocation as d,
  useRouterState as f,
  lazyRouteComponent as g,
  Outlet as h,
  disposeSsrResponseDetached as i,
  executeRewriteInput as j,
  resolveManifestCssLink as k,
  Scripts as l,
  createRouter as m,
  bindSsrResponseToRequest as n,
  normalizeSsrResponse as o,
  RouterProvider as p,
  defineHandlerCallback as r,
  replaceSsrResponse as s,
  renderRouterToStream as t,
  HeadContent as u,
  createRootRouteWithContext as v,
  createInlineCssPlaceholderAsset as w,
  useRouter as x,
  Link as y,
  redirect as z,
};
