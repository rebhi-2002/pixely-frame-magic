...
function useControllableState({
  prop,
  defaultProp,
  onChange = /* @__PURE__ */ __name$7(() => {}, "onChange"),
  caller,
}) {
...
function createSlottable(ownerName) {
  const Slottable2 = /* @__PURE__ */ __name$6(
...
var [createCollapsibleContext, createCollapsibleScope] =
  /* @__PURE__ */ createContextScope(COLLAPSIBLE_NAME);
var [CollapsibleProvider, useCollapsibleContext] = createCollapsibleContext(COLLAPSIBLE_NAME);
var Collapsible = /* @__PURE__ */ import_react.forwardRef(
  /* @__PURE__ */ __name$1(function Collapsible2(props, forwardedRef) {
    const {
      __scopeCollapsible,
      open: openProp,
      defaultOpen,
...
var CollapsibleTrigger = /* @__PURE__ */ import_react.forwardRef(
  /* @__PURE__ */ __name$1(function CollapsibleTrigger2(props, forwardedRef) {
...
var CollapsibleContent = /* @__PURE__ */ import_react.forwardRef(
  /* @__PURE__ */ __name$1(function CollapsibleContent2(props, forwardedRef) {
...
var CollapsibleContentImpl = /* @__PURE__ */ import_react.forwardRef(
  /* @__PURE__ */ __name$1(function CollapsibleContentImpl2(props, forwardedRef) {
...
var [Collection, useCollection, createCollectionScope] =
  /* @__PURE__ */ createCollection(ACCORDION_NAME);
var [createAccordionContext, createAccordionScope] = /* @__PURE__ */ createContextScope(
  ACCORDION_NAME,
  [createCollectionScope, createCollapsibleScope],
);
var useCollapsibleScope = createCollapsibleScope();
var Accordion = /* @__PURE__ */ import_react.forwardRef(
...
var AccordionImplSingle = /* @__PURE__ */ import_react.forwardRef(
  /* @__PURE__ */ __name(function AccordionImplSingle2(props, forwardedRef) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionValueProvider, {
      ...
      onItemOpen: setValue,
      onItemClose: import_react.useCallback(
...
var AccordionImplMultiple = /* @__PURE__ */ import_react.forwardRef(
  /* @__PURE__ */ __name(function AccordionImplMultiple2(props, forwardedRef) {
    const {
      value: valueProp,
      defaultValue,
      onValueChange = /* @__PURE__ */ __name(() => {}, "onValueChange"),
    ...
    const handleItemOpen = import_react.useCallback(
      (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
      [setValue],
    );
    const handleItemClose = import_react.useCallback(
      (itemValue) =>
...
var AccordionImpl = /* @__PURE__ */ import_react.forwardRef(
...
var AccordionItem = /* @__PURE__ */ import_react.forwardRef(
...
var AccordionHeader = /* @__PURE__ */ import_react.forwardRef(
...
var AccordionTrigger = /* @__PURE__ */ import_react.forwardRef(
...
var AccordionContent = /* @__PURE__ */ import_react.forwardRef(
...
export {
  ...
  Item as r,
  createCollection as s,
  Content2 as t,
  dispatchDiscreteCustomEvent as u,
  require_jsx_runtime as v,
};
