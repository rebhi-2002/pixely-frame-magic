...
function line_default(x$1, y$1) {
  var defined = constant_default(true),
    context = null,
  ...
  function line(data) {
    var i,
      n = (data = array_default(data)).length,
      d,
      defined0 = false,
      buffer;
  ...
  line.x = function (_) {
    return arguments.length
      ? ((x$1 = typeof _ === "function" ? _ : constant_default(+_)), line)
      : x$1;
  };
  line.y = function (_) {
    return arguments.length
      ? ((y$1 = typeof _ === "function" ? _ : constant_default(+_)), line)
      : y$1;
  };
  line.defined = function (_) {
    return arguments.length
      ? ((defined = typeof _ === "function" ? _ : constant_default(!!_)), line)
      : defined;
  };
...
function area_default(x0, y0, y1) {
  ...
  area.defined = function (_) {
    return arguments.length
      ? ((defined = typeof _ === "function" ? _ : constant_default(!!_)), area)
      : defined;
  };
...
function Symbol(type, size) {
  ...
  symbol.type = function (_) {
    return arguments.length
      ? ((type = typeof _ === "function" ? _ : constant_default(_)), symbol)
      : type;
  };
  symbol.size = function (_) {
    return arguments.length
      ? ((size = typeof _ === "function" ? _ : constant_default(+_)), symbol)
      : size;
  };
...
function stack_default() {
  var keys = constant_default([]),
    order = none_default,
    offset = none_default$1,
    value = stackValue;
  function stack(data) {
    var sz = Array.from(keys.apply(this, arguments), stackSeries),
      ...
      oz;
    for (const d of data)
      for (i = 0, ++j; i < n; ++i) (sz[i][j] = [0, +value(d, sz[i].key, j, data)]).data = d;
  ...
  stack.keys = function (_) {
    return arguments.length
      ? ((keys = typeof _ === "function" ? _ : constant_default(Array.from(_))), stack)
      : keys;
  };
  stack.value = function (_) {
    return arguments.length
      ? ((value = typeof _ === "function" ? _ : constant_default(+_)), stack)
      : value;
  };
  stack.order = function (_) {
    return arguments.length
      ? ((order =
          _ == null ? none_default : typeof _ === "function" ? _ : constant_default(Array.from(_))),
        stack)
      : order;
  };
...
export {
  ...
  monotoneY as f,
  basis_default as g,
  basisClosed_default as h,
  stack_default as i,
  linear_default as k,
  step_default as l,
  basisOpen_default as m,
  silhouette_default as n,
  none_default$1 as o,
  linearClosed_default as p,
  expand_default as r,
  stepAfter as s,
  wiggle_default as t,
  natural_default as u,
  wye_default as v,
  circle_default as w,
  square_default as x,
  triangle_default as y,
};
