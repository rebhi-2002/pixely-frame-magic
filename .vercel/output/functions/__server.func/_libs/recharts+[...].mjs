...
import {
  C as require_get,
  E as require_isObject,
  S as require_isNil,
  T as require_isFunction,
  _ as require_uniqBy,
  a as require_range,
  b as require_isNumber,
  c as require_minBy,
  d as require_isEqual,
  f as require_flatMap,
  g as require_sortBy,
  h as require_throttle,
  i as require_some,
  l as require_maxBy,
  m as require_max,
  n as require_every,
  o as require_isBoolean,
  p as require_min,
  r as require_mapValues,
  s as require_isPlainObject,
  t as require_find,
  u as require_last,
  v as require_upperFirst,
  w as require_memoize,
  x as require_isString,
  y as require_isNaN,
} from "./lodash.mjs";
...
import {
  ...
  f as monotoneY,
  g as basis_default,
  h as basisClosed_default,
  i as stack_default,
  k as linear_default,
  l as step_default,
  m as basisOpen_default,
  n as silhouette_default,
  o as none_default,
  p as linearClosed_default,
  r as expand_default,
  s as stepAfter,
  t as wiggle_default,
  u as natural_default,
  v as wye_default,
  w as circle_default,
  x as square_default,
  y as triangle_default,
} from "./d3-shape.mjs";
import {
  C as linear,
  D as implicit,
  ...
  T as band,
  _ as radial,
  a as divergingSymlog,
  b as symlog,
  c as sequentialLog,
  d as sequentialSymlog,
  f as utcTime,
  g as quantile,
  h as quantize,
  i as divergingSqrt,
  ...
  return ary.find(function (entry) {
    return (
      ...
      (typeof specifiedKey === "function"
        ? specifiedKey(entry)
        : (0, import_get.default)(entry, specifiedKey)) === specifiedValue
    );
  });
}
/**
...
function findAllByType(children, type) {
  ...
  toArray(children).forEach(function (child) {
    var childType =
      (0, import_get.default)(child, "type.displayName") ||
      (0, import_get.default)(child, "type.name");
...
var isSvgElement = function isSvgElement(child) {
  return (
    child &&
    child.type &&
    (0, import_isString.default)(child.type) &&
 ...
 */
var isValidSpreadableProp = function isValidSpreadableProp(
  property,
  key,
  includeEvents,
  svgElementType,
  ...
  return (
    key.startsWith("data-") ||
    (!(0, import_isFunction.default)(property) &&
...
var isSingleChildEqual = function isSingleChildEqual(nextChild, prevChild) {
  ...
  if (!(0, import_isNil.default)(nextChild) && !(0, import_isNil.default)(prevChild)) {
    var _ref = nextChild.props || {},
      ...
      nextProps = _objectWithoutProperties$18(_ref, _excluded$18);
    var _ref2 = prevChild.props || {},
      prevChildren = _ref2.children,
      prevProps = _objectWithoutProperties$18(_ref2, _excluded2$7);
...
function Surface(props) {
  var children = props.children,
    ...
    title = props.title,
    desc = props.desc,
    others = _objectWithoutProperties$17(props, _excluded$17);
  var svgView = viewBox || {
    width,
    height,
    x: 0,
  ...
  return /*#__PURE__*/ import_react.createElement(
    "svg",
    _extends$30({}, filterProps(others, true, "svg"), {
    ...
    /*#__PURE__*/ import_react.createElement("title", null, title),
    /*#__PURE__*/ import_react.createElement("desc", null, desc),
    children,
  );
}
//#endregion
...
var Layer = /*#__PURE__*/ import_react.forwardRef(function (props, ref) {
  var children = props.children,
    className = props.className,
    others = _objectWithoutProperties$16(props, _excluded$16);
  var layerClass = clsx("recharts-layer", className);
  return /*#__PURE__*/ import_react.createElement(
    "g",
    _extends$29({ className: layerClass }, filterProps(others, true), { ref }),
    children,
  );
});
//#endregion
...
var _excluded$15 = ["type", "size", "sizeType"];
function _extends$28() {
  _extends$28 = Object.assign
    ? Object.assign.bind()
    : function (target) {
        for (var i = 1; i < arguments.length; i++) {
          var source = arguments[i];
...
function _objectSpread$35(e) {
  for (var r = 1; r < arguments.length; r++) {
    ...
    r % 2
      ? ownKeys$35(Object(t), !0).forEach(function (r) {
          _defineProperty$40(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$35(Object(t)).forEach(function (r) {
...
var Symbols = function Symbols(_ref) {
  ...
  var props = _objectSpread$35(
    _objectSpread$35({}, _objectWithoutProperties$15(_ref, _excluded$15)),
    {},
    {
      type,
      size,
...
function _objectSpread$34(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$34(Object(t), !0).forEach(function (r) {
          _defineProperty$39(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$34(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function _callSuper$17(t, o, e) {
  return (
    (o = _getPrototypeOf$17(o)),
    _possibleConstructorReturn$17(
      t,
      _isNativeReflectConstruct$17()
        ? Reflect.construct(o, e || [], _getPrototypeOf$17(t).constructor)
        : o.apply(t, e),
    )
  );
}
...
function _getPrototypeOf$17(o) {
  _getPrototypeOf$17 = Object.setPrototypeOf
...
function _setPrototypeOf$17(o, p) {
  _setPrototypeOf$17 = Object.setPrototypeOf
      ...
      value:
        ...
        function renderIcon(data) {
          ...
          if (data.type === "plainline")
            return /*#__PURE__*/ import_react.createElement("line", {
              strokeWidth: 4,
              fill: "none",
              stroke: color,
    ...
    },
    {
      ...
      value: function renderItems() {
        ...
        return payload.map(function (entry, i) {
          ...
          var className = clsx(
            _defineProperty$39(
              _defineProperty$39({ "recharts-legend-item": true }, "legend-item-".concat(i), true),
              "inactive",
              entry.inactive,
            ),
          );
          ...
          warn(
            !(0, import_isFunction.default)(entry.value),
...
function _objectSpread$33(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$33(Object(t), !0).forEach(function (r) {
          _defineProperty$38(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$33(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function _callSuper$16(t, o, e) {
  return (
    (o = _getPrototypeOf$16(o)),
    _possibleConstructorReturn$16(
      t,
      _isNativeReflectConstruct$16()
        ? Reflect.construct(o, e || [], _getPrototypeOf$16(t).constructor)
        : o.apply(t, e),
    )
  );
}
...
function _getPrototypeOf$16(o) {
  _getPrototypeOf$16 = Object.setPrototypeOf
    ? Object.getPrototypeOf.bind()
    : function _getPrototypeOf(o) {
        return o.__proto__ || Object.getPrototypeOf(o);
      };
...
function _setPrototypeOf$16(o, p) {
  _setPrototypeOf$16 = Object.setPrototypeOf
    ? Object.setPrototypeOf.bind()
    : function _setPrototypeOf(o, p) {
        o.__proto__ = p;
        return o;
...
function renderContent$1(content, props) {
  if (/*#__PURE__*/ import_react.isValidElement(content))
    return /*#__PURE__*/ import_react.cloneElement(content, props);
  if (typeof content === "function")
    return /*#__PURE__*/ import_react.createElement(content, props);
  props.ref;
      ...
      },
      {
        ...
        value: function getBBoxSnapshot() {
          if (this.lastBoundingBox.width >= 0 && this.lastBoundingBox.height >= 0)
            return _objectSpread$33({}, this.lastBoundingBox);
          return {
            width: 0,
            height: 0,
          };
      ...
      },
      {
        ...
        value: function render() {
          ...
          var _this$props2 = this.props,
            ...
            payload = _this$props2.payload;
          var outerStyle = _objectSpread$33(
            _objectSpread$33(
              {
                position: "absolute",
                width: width || "auto",
    ...
    [
      {
        ...
        value: function getWithHeight(item, chartWidth) {
          ...
          if (layout === "vertical" && isNumber(item.props.height))
            return { height: item.props.height };
...
function _slicedToArray$10(arr, i) {
  return (
    _arrayWithHoles$10(arr) ||
    _iterableToArrayLimit$10(arr, i) ||
    _unsupportedIterableToArray$16(arr, i) ||
    _nonIterableRest$10()
  );
}
...
function _objectSpread$32(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$32(Object(t), !0).forEach(function (r) {
          _defineProperty$37(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$32(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
var DefaultTooltipContent = function DefaultTooltipContent(props) {
  ...
  return /*#__PURE__*/ import_react.createElement(
    ...
    /*#__PURE__*/ import_react.createElement(
      ...
      /*#__PURE__*/ import_react.isValidElement(finalLabel) ? finalLabel : "".concat(finalLabel),
    ),
    renderContent(),
  );
};
...
function getTooltipTranslateXY(_ref2) {
  ...
  if (positive + tooltipDimension > viewBox[key] + viewBoxDimension)
    return Math.max(negative, viewBox[key]);
...
function getTransformStyle(_ref3) {
  ...
  return {
    transform: _ref3.useTranslate3d
...
function _objectSpread$31(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$31(Object(t), !0).forEach(function (r) {
          _defineProperty$35(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$31(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function _callSuper$15(t, o, e) {
  return (
    (o = _getPrototypeOf$15(o)),
    _possibleConstructorReturn$15(
      t,
      _isNativeReflectConstruct$15()
        ? Reflect.construct(o, e || [], _getPrototypeOf$15(t).constructor)
        : o.apply(t, e),
    )
  );
}
...
function _getPrototypeOf$15(o) {
  _getPrototypeOf$15 = Object.setPrototypeOf
    ? Object.getPrototypeOf.bind()
    : function _getPrototypeOf(o) {
        return o.__proto__ || Object.getPrototypeOf(o);
      };
...
function _setPrototypeOf$15(o, p) {
  _setPrototypeOf$15 = Object.setPrototypeOf
    ? Object.setPrototypeOf.bind()
    : function _setPrototypeOf(o, p) {
        o.__proto__ = p;
        return o;
  ...
  return _createClass$18(TooltipBoundingBox, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var outerStyle = _objectSpread$31(
          _objectSpread$31(
            {
              transition:
...
function _objectSpread$30(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$30(Object(t), !0).forEach(function (r) {
          _defineProperty$34(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$30(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function _callSuper$14(t, o, e) {
  return (
    (o = _getPrototypeOf$14(o)),
    _possibleConstructorReturn$14(
      t,
      _isNativeReflectConstruct$14()
        ? Reflect.construct(o, e || [], _getPrototypeOf$14(t).constructor)
        : o.apply(t, e),
    )
  );
}
...
function _getPrototypeOf$14(o) {
  _getPrototypeOf$14 = Object.setPrototypeOf
    ? Object.getPrototypeOf.bind()
    : function _getPrototypeOf(o) {
        return o.__proto__ || Object.getPrototypeOf(o);
      };
...
function _setPrototypeOf$14(o, p) {
  _setPrototypeOf$14 = Object.setPrototypeOf
    ? Object.setPrototypeOf.bind()
    : function _setPrototypeOf(o, p) {
        o.__proto__ = p;
        return o;
  ...
  return _createClass$17(Tooltip, [
    {
      ...
      value: function render() {
        ...
        return /*#__PURE__*/ import_react.createElement(
          ...
          renderContent(
            content,
            _objectSpread$30(_objectSpread$30({}, this.props), {}, { payload: finalPayload }),
          ),
        );
      },
    },
...
function _objectSpread$29(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$29(Object(t), !0).forEach(function (r) {
          _defineProperty$33(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$29(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function _slicedToArray$9(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$15(arr, i) ||
    _nonIterableRest$9()
  );
}
...
var ResponsiveContainer = /*#__PURE__*/ (0, import_react.forwardRef)(function (_ref, ref) {
  ...
  var _useState2 = _slicedToArray$9(
  ...
  var chartContent = (0, import_react.useMemo)(
    function () {
      ...
      return import_react.Children.map(children, function (child) {
        if (/*#__PURE__*/ import_react.isValidElement(child))
          return /*#__PURE__*/ (0, import_react.cloneElement)(
            child,
            _objectSpread$29(
              {
...
function _objectSpread$28(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$28(Object(t), !0).forEach(function (r) {
          _defineProperty$32(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$28(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function _slicedToArray$8(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$14(arr, i) ||
    _nonIterableRest$8()
  );
}
...
var _excluded2$6 = ["dx", "dy", "angle", "className", "breakAll"];
function _extends$25() {
  _extends$25 = Object.assign
    ? Object.assign.bind()
    : function (target) {
        for (var i = 1; i < arguments.length; i++) {
          var source = arguments[i];
...
function _slicedToArray$7(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$13(arr, i) ||
    _nonIterableRest$7()
  );
}
...
var calculateWordsByLines = function calculateWordsByLines(
  _ref2,
  ...
  var calculate = function calculate() {
    return (arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : []).reduce(function (
      result,
      _ref3,
    ) {
      var word = _ref3.word,
  ...
  while (start <= end && iterations <= text.length - 1) {
    ...
    var _checkOverflow2 = _slicedToArray$7(checkOverflow(middle - 1), 2),
...
var getWordsWithoutCalculate = function getWordsWithoutCalculate(children) {
  return [
    {
      words: !(0, import_isNil.default)(children) ? children.toString().split(BREAKING_SPACES) : [],
    },
  ];
};
...
var Text = function Text(_ref5) {
  var _ref5$x = _ref5.x,
    ...
    props = _objectWithoutProperties$13(_ref5, _excluded$13);
  ...
  var dx = props.dx,
    ...
    className = props.className,
    breakAll = props.breakAll,
    textProps = _objectWithoutProperties$13(props, _excluded2$6);
  ...
  return /*#__PURE__*/ import_react.createElement(
    "text",
    _extends$25({}, filterProps(textProps, true), {
      x,
      y,
...
function _toConsumableArray$7(arr) {
  return (
    ...
    _unsupportedIterableToArray$12(arr) ||
...
function _toConsumableArray$6(arr) {
  return (
    ...
    _unsupportedIterableToArray$11(arr) ||
...
function _slicedToArray$6(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$11(arr, i) ||
    _nonIterableRest$6()
  );
}
...
function getFormatStep(roughStep, allowDecimals, correctionFactor) {
  ...
  var formatStep = new decimal_default(Math.ceil(stepRatio.div(stepRatioScale).toNumber()))
...
function getNiceTickValuesFn(_ref3) {
  ...
  var _getValidInterval2 = _slicedToArray$6(getValidInterval([min, max]), 2),
  ...
  if (cormin === -Infinity || cormax === Infinity) {
    var _values =
      cormax === Infinity
        ? [cormin].concat(
            _toConsumableArray$6(
              range$2(0, tickCount - 1).map(function () {
                return Infinity;
              }),
            ),
          )
  ...
  var values = arithmetic_default.rangeStep(
    tickMin,
...
function getTickValuesFixedDomainFn(_ref7, tickCount) {
  var _ref8 = _slicedToArray$6(_ref7, 2),
    ...
    max = _ref8[1];
  var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
  var _getValidInterval6 = _slicedToArray$6(getValidInterval([min, max]), 2),
  ...
  var values = [].concat(
    _toConsumableArray$6(
      arithmetic_default.rangeStep(
        new decimal_default(cormin),
        new decimal_default(cormax).sub(new decimal_default(0.99).mul(step)),
        step,
      ),
    ),
    [cormax],
...
function _slicedToArray$5(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$10(arr, i) ||
    _nonIterableRest$5()
  );
}
...
function _callSuper$13(t, o, e) {
  return (
    (o = _getPrototypeOf$13(o)),
    _possibleConstructorReturn$13(
      t,
      _isNativeReflectConstruct$13()
        ? Reflect.construct(o, e || [], _getPrototypeOf$13(t).constructor)
        : o.apply(t, e),
    )
  );
}
...
function _getPrototypeOf$13(o) {
  _getPrototypeOf$13 = Object.setPrototypeOf
    ? Object.getPrototypeOf.bind()
    : function _getPrototypeOf(o) {
        return o.__proto__ || Object.getPrototypeOf(o);
      };
...
function _setPrototypeOf$13(o, p) {
  _setPrototypeOf$13 = Object.setPrototypeOf
    ? Object.setPrototypeOf.bind()
    : function _setPrototypeOf(o, p) {
        o.__proto__ = p;
        return o;
            ...
            _extends$24(
              {
                ...
                key: "bar-".concat(
                  lineCoordinates.map(function (c) {
...
function _objectSpread$27(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$27(Object(t), !0).forEach(function (r) {
          _defineProperty$30(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$27(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
var getLegendProps = function getLegendProps(_ref) {
  ...
  var legendProps =
    legendDefaultProps !== void 0
      ? _objectSpread$27(_objectSpread$27({}, legendDefaultProps), legendItem.props)
      : {};
  var legendData;
    ...
    legendData = (formattedGraphicalItems || []).map(function (_ref3) {
      ...
      var itemProps =
        itemDefaultProps !== void 0
          ? _objectSpread$27(_objectSpread$27({}, itemDefaultProps), item.props)
          : {};
  ...
  return _objectSpread$27(
    _objectSpread$27(
      _objectSpread$27({}, legendProps),
...
function _objectSpread$26(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$26(Object(t), !0).forEach(function (r) {
          _defineProperty$29(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$26(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function getDomainOfDataByKey(data, key, type, filterNil) {
  ...
  if (type === "number") {
    ...
    return domain.length
      ? [(0, import_min.default)(domain), (0, import_max.default)(domain)]
      : [Infinity, -Infinity];
  }
  return (
    filterNil
...
var calculateActiveTickIndex = function calculateActiveTickIndex(coordinate) {
  ...
  if (
    ...
    for (var _i = 0; _i < len; _i++)
      if (
        (_i === 0 && coordinate <= (ticks[_i].coordinate + ticks[_i + 1].coordinate) / 2) ||
        (_i > 0 &&
          _i < len - 1 &&
          coordinate > (ticks[_i].coordinate + ticks[_i - 1].coordinate) / 2 &&
          coordinate <= (ticks[_i].coordinate + ticks[_i + 1].coordinate) / 2) ||
        (_i === len - 1 && coordinate > (ticks[_i].coordinate + ticks[_i - 1].coordinate) / 2)
      ) {
...
var getMainColorOfGraphicItem = function getMainColorOfGraphicItem(item) {
  ...
  var defaultedProps =
    (_item$type = item.type) !== null && _item$type !== void 0 && _item$type.defaultProps
      ? _objectSpread$26(_objectSpread$26({}, item.type.defaultProps), item.props)
      : item.props;
      ...
      if (barItems && barItems.length) {
        ...
        var barItemProps =
          barItemDefaultProps !== void 0
            ? _objectSpread$26(_objectSpread$26({}, barItemDefaultProps), barItems[0].props)
            : barItems[0].props;
        ...
        result[cateId].push({
          ...
          barSize: (0, import_isNil.default)(barSize)
            ? void 0
            : getPercentValue(barSize, totalSize, 0),
        });
      }
    }
  }
  ...
  if (legendProps) {
    ...
    if (
      ...
      return _objectSpread$26(
        _objectSpread$26({}, offset),
        {},
        _defineProperty$29({}, align, offset[align] + (boxWidth || 0)),
      );
    if (
      ...
      return _objectSpread$26(
        _objectSpread$26({}, offset),
        {},
        _defineProperty$29({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)),
      );
  }
  return offset;
};
    ...
    return data.reduce(
      function (result, entry) {
        ...
        var mainValue = Array.isArray(entryValue)
          ? [(0, import_min.default)(entryValue), (0, import_max.default)(entryValue)]
          : [entryValue, entryValue];
        var errorDomain = keys.reduce(
          function (prevErrorArr, k) {
 ...
 * @return {Array}        Domain
 */
var getDomainOfItemsWithSameAxis = function getDomainOfItemsWithSameAxis(
  data,
  items,
  type,
  layout,
...
var parseScale = function parseScale(axis, chartType, hasBar) {
  ...
  return (0, import_isFunction.default)(scale)
    ? { scale }
    : {
        scale: point(),
        realScaleType: "point",
...
var getStackedData = function getStackedData(data, stackItems, offsetType) {
  ...
  return stack_default()
    ...
    .order(none_default$1)
    .offset(offsetAccessor)(data);
};
var getStackGroupsByAxisId = function getStackGroupsByAxisId(
  data,
  _items,
  numericAxisId,
  cateAxisId,
  ...
  var stackGroups = (reverseStackOrder ? _items.reverse() : _items).reduce(function (result, item) {
    ...
    return _objectSpread$26(
      _objectSpread$26({}, result),
      {},
      _defineProperty$29({}, axisId, parentGroup),
    );
  }, {});
  return Object.keys(stackGroups).reduce(function (result, axisId) {
    ...
    if (group.hasStack)
      group.stackGroups = Object.keys(group.stackGroups).reduce(function (res, stackId) {
        ...
        return _objectSpread$26(
          _objectSpread$26({}, res),
          {},
          _defineProperty$29({}, stackId, {
            numericAxisId,
            cateAxisId,
            items: g.items,
    ...
    return _objectSpread$26(
      _objectSpread$26({}, result),
      {},
      _defineProperty$29({}, axisId, group),
    );
  }, {});
};
/**
...
var getTicksOfScale = function getTicksOfScale(scale, opts) {
  ...
  if (tickCount && type === "number")
    return { niceTicks: getTickValuesFixedDomain(scale.domain(), tickCount, allowDecimals) };
  return null;
};
function getCateCoordinateOfLine(_ref5) {
  ...
  if (axis.type === "category") {
    if (
      ...
      axis.dataKey &&
      !(0, import_isNil.default)(entry[axis.dataKey])
    ) {
  ...
  var value = getValueByDataKey(
    entry,
    !(0, import_isNil.default)(dataKey) ? dataKey : axis.dataKey,
  );
...
var getDomainOfSingle = function getDomainOfSingle(data) {
  return data.reduce(
    function (result, entry) {
      return [
        (0, import_min.default)(entry.concat([result[0]]).filter(isNumber)),
        (0, import_max.default)(entry.concat([result[1]]).filter(isNumber)),
      ];
    },
    [Infinity, -Infinity],
  );
  ...
  return Object.keys(stackGroups)
    .reduce(
      function (result, stackId) {
        var domain = stackGroups[stackId].stackedData.reduce(
          function (res, entry) {
...
var parseSpecifiedDomain = function parseSpecifiedDomain(
  specifiedDomain,
  dataDomain,
  allowDataOverflow,
) {
  if ((0, import_isFunction.default)(specifiedDomain))
  ...
  } else if ((0, import_isFunction.default)(specifiedDomain[0]))
  ...
  } else if ((0, import_isFunction.default)(specifiedDomain[1]))
 ...
 */
var parseDomainOfCategoryAxis = function parseDomainOfCategoryAxis(
  specifiedDomain,
  calculatedDomain,
  axisChild,
) {
  ...
  if (
    (0, import_isEqual.default)(
      specifiedDomain,
      (0, import_get.default)(axisChild, "type.defaultProps.domain"),
    )
  )
...
var getTooltipItem = function getTooltipItem(graphicalItem, payload) {
  var defaultedProps = graphicalItem.type.defaultProps
    ? _objectSpread$26(_objectSpread$26({}, graphicalItem.type.defaultProps), graphicalItem.props)
    : graphicalItem.props;
  ...
  return _objectSpread$26(
    _objectSpread$26({}, filterProps(graphicalItem, false)),
    {},
    {
      dataKey,
      unit,
...
function _objectSpread$25(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$25(Object(t), !0).forEach(function (r) {
          _defineProperty$28(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$25(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function _slicedToArray$4(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$8(arr, i) ||
    _nonIterableRest$4()
  );
}
...
var formatAxisMap$1 = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
  ...
  return Object.keys(axisMap).reduce(function (result, id) {
    ...
    var ticks = getTicksOfScale(
      scale,
      _objectSpread$25(_objectSpread$25({}, axis), {}, { realScaleType }),
    );
    var finalAxis = _objectSpread$25(
      _objectSpread$25(_objectSpread$25({}, axis), ticks),
      {},
      {
        range,
        radius: outerRadius,
    ...
    return _objectSpread$25(
      _objectSpread$25({}, result),
      {},
      _defineProperty$28({}, id, finalAxis),
    );
  }, {});
};
...
var getTickClassName = function getTickClassName(tick) {
  return !(/*#__PURE__*/ (0, import_react.isValidElement)(tick)) &&
    !(0, import_isFunction.default)(tick) &&
    typeof tick !== "boolean"
    ? tick.className
    : "";
};
...
function _toConsumableArray$4(arr) {
  return (
    ...
    _unsupportedIterableToArray$7(arr) ||
...
function _objectSpread$24(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$24(Object(t), !0).forEach(function (r) {
          _defineProperty$27(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$24(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
var renderRadialLabel = function renderRadialLabel(labelProps, label, attrs) {
  ...
  var path = "M"
    ...
    .concat(endPoint.x, ",")
    .concat(endPoint.y);
  var id = (0, import_isNil.default)(labelProps.id)
...
var getAttrsOfCartesianLabel = function getAttrsOfCartesianLabel(props) {
  ...
  if (
    (0, import_isObject.default)(position) &&
...
function Label(_ref4) {
  var _ref4$offset = _ref4.offset,
    ...
    restProps = _objectWithoutProperties$11(_ref4, _excluded$11);
  ...
  if (
    !viewBox ||
    ((0, import_isNil.default)(value) &&
      (0, import_isNil.default)(children) &&
      !(/*#__PURE__*/ (0, import_react.isValidElement)(content)) &&
      !(0, import_isFunction.default)(content))
  )
    return null;
  if (/*#__PURE__*/ (0, import_react.isValidElement)(content))
    return /*#__PURE__*/ (0, import_react.cloneElement)(content, props);
  var label;
  ...
  if (
    isPolarLabel &&
    (position === "insideStart" || position === "insideEnd" || position === "end")
  )
    return renderRadialLabel(props, label, attrs);
  var positionAttrs = isPolarLabel ? getAttrsOfPolarLabel(props) : getAttrsOfCartesianLabel(props);
  return /*#__PURE__*/ import_react.createElement(
    Text,
    _extends$23({ className: clsx("recharts-label", className) }, attrs, positionAttrs, {
...
var parseLabel = function parseLabel(label, viewBox) {
  ...
  if (/*#__PURE__*/ (0, import_react.isValidElement)(label)) {
    if (label.type === Label)
      return /*#__PURE__*/ (0, import_react.cloneElement)(label, {
        key: "label-implicit",
        viewBox,
      });
    return /*#__PURE__*/ import_react.createElement(Label, {
  ...
  if ((0, import_isFunction.default)(label))
    return /*#__PURE__*/ import_react.createElement(Label, {
      key: "label-implicit",
      content: label,
      viewBox,
    });
  if ((0, import_isObject.default)(label))
    return /*#__PURE__*/ import_react.createElement(
      Label,
      _extends$23({ viewBox }, label, { key: "label-implicit" }),
    );
  return null;
};
var renderCallByParent$1 = function renderCallByParent(parentProps, viewBox) {
  ...
  return [parseLabel(parentProps.label, viewBox || parentViewBox)].concat(
    _toConsumableArray$4(explicitChildren),
  );
};
...
var _excluded2$5 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
...
function _objectSpread$23(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$23(Object(t), !0).forEach(function (r) {
          _defineProperty$26(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$23(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function LabelList(_ref) {
  var _ref$valueAccessor = _ref.valueAccessor,
    ...
    restProps = _objectWithoutProperties$10(_ref, _excluded$10);
  var data = restProps.data,
    dataKey = restProps.dataKey,
    clockWise = restProps.clockWise,
    id = restProps.id,
    textBreakAll = restProps.textBreakAll,
    others = _objectWithoutProperties$10(restProps, _excluded2$5);
  if (!data || !data.length) return null;
  return /*#__PURE__*/ import_react.createElement(
    Layer,
    { className: "recharts-label-list" },
    data.map(function (entry, index) {
      var value = (0, import_isNil.default)(dataKey)
        ? valueAccessor(entry, index)
        : getValueByDataKey(entry && entry.payload, dataKey);
      var idProps = (0, import_isNil.default)(id) ? {} : { id: "".concat(id, "-").concat(index) };
      return /*#__PURE__*/ import_react.createElement(
        Label,
        _extends$22({}, filterProps(entry, true), others, idProps, {
          parentViewBox: entry.parentViewBox,
          value,
          textBreakAll,
          viewBox: Label.parseViewBox(
            (0, import_isNil.default)(clockWise)
              ? entry
              : _objectSpread$23(_objectSpread$23({}, entry), {}, { clockWise }),
          ),
          key: "label-".concat(index),
          index,
        }),
...
function parseLabelList(label, data) {
  if (!label) return null;
  if (label === true)
    return /*#__PURE__*/ import_react.createElement(LabelList, {
      key: "labelList-implicit",
      data,
    });
  if (/*#__PURE__*/ import_react.isValidElement(label) || (0, import_isFunction.default)(label))
    return /*#__PURE__*/ import_react.createElement(LabelList, {
      key: "labelList-implicit",
      data,
      content: label,
  ...
  if ((0, import_isObject.default)(label))
    return /*#__PURE__*/ import_react.createElement(
      LabelList,
      _extends$22({ data }, label, { key: "labelList-implicit" }),
    );
  return null;
}
...
function _objectSpread$22(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$22(Object(t), !0).forEach(function (r) {
          _defineProperty$25(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$22(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
var getTangentCircle = function getTangentCircle(_ref) {
  ...
  return {
    center,
    circleTangency,
    lineTangency: polarToCartesian(
      cx,
      cy,
      centerRadius * Math.cos(theta * RADIAN$1),
      lineTangencyAngle,
    ),
    theta,
  };
...
var Sector = function Sector(sectorProps) {
  ...
  return /*#__PURE__*/ import_react.createElement(
    "path",
    _extends$21({}, filterProps(props, true), {
      className: layerClass,
      d: path,
      role: "img",
    }),
...
function _objectSpread$21(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$21(Object(t), !0).forEach(function (r) {
          _defineProperty$24(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$21(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
var Curve = function Curve(props) {
  ...
  return /*#__PURE__*/ import_react.createElement(
    "path",
    _extends$20({}, filterProps(props, false), adaptEventHandlers(props), {
...
function _objectSpread$20(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$20(Object(t), !0).forEach(function (r) {
          _defineProperty$23(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$20(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
var Rectangle = function Rectangle(rectangleProps) {
  ...
  var _useState2 = _slicedToArray$3((0, import_react.useState)(-1), 2),
  ...
  if (!isUpdateAnimationActive)
    return /*#__PURE__*/ import_react.createElement(
      "path",
      _extends$19({}, filterProps(props, true), {
        className: layerClass,
...
var Polygon = function Polygon(props) {
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /*#__PURE__*/ import_react.createElement(
      ...
      /*#__PURE__*/ import_react.createElement(
        "path",
        _extends$18({}, filterProps(others, true), {
...
var Dot = function Dot(props) {
  ...
  if (cx === +cx && cy === +cy && r === +r)
    return /*#__PURE__*/ import_react.createElement(
      "circle",
      _extends$17({}, filterProps(props, false), adaptEventHandlers(props), {
        className: layerClass,
        cx,
        cy,
        r,
...
function _objectSpread$19(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$19(Object(t), !0).forEach(function (r) {
          _defineProperty$22(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$19(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
var Cross = function Cross(_ref) {
  ...
  return /*#__PURE__*/ import_react.createElement(
    "path",
    _extends$16({}, filterProps(props, true), {
...
var _excluded2$4 = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
...
function _objectSpread$18(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$18(Object(t), !0).forEach(function (r) {
          _defineProperty$21(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$18(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function _callSuper$12(t, o, e) {
  return (
    (o = _getPrototypeOf$12(o)),
    _possibleConstructorReturn$12(
      t,
      _isNativeReflectConstruct$12()
        ? Reflect.construct(o, e || [], _getPrototypeOf$12(t).constructor)
        : o.apply(t, e),
    )
  );
}
...
function _getPrototypeOf$12(o) {
  _getPrototypeOf$12 = Object.setPrototypeOf
    ? Object.getPrototypeOf.bind()
    : function _getPrototypeOf(o) {
        return o.__proto__ || Object.getPrototypeOf(o);
      };
...
function _setPrototypeOf$12(o, p) {
  _setPrototypeOf$12 = Object.setPrototypeOf
    ? Object.setPrototypeOf.bind()
    : function _setPrototypeOf(o, p) {
        o.__proto__ = p;
        return o;
      ...
      },
      {
        ...
        value: function getViewBox() {
          ...
          return {
            ...
            endAngle: angle,
            innerRadius:
              (0, import_minBy.default)(ticks, function (entry) {
                return entry.coordinate || 0;
              }).coordinate || 0,
      ...
      },
      {
        ...
        value: function renderAxisLine() {
          ...
          var props = _objectSpread$18(
            _objectSpread$18(
              _objectSpread$18({}, filterProps(others, false)),
              {},
              { fill: "none" },
          ...
          return /*#__PURE__*/ import_react.createElement(
            "line",
            _extends$15({ className: "recharts-polar-radius-axis-line" }, props),
          );
        },
      },
      {
        ...
        value: function renderTicks() {
          ...
          var items = ticks.map(function (entry, i) {
            ...
            var tickProps = _objectSpread$18(
              _objectSpread$18(
                _objectSpread$18(
                  _objectSpread$18(
                    {
    ...
    [
      {
        ...
        value: function renderTickItem(option, props, value) {
          var tickItem;
          if (/*#__PURE__*/ import_react.isValidElement(option))
            tickItem = /*#__PURE__*/ import_react.cloneElement(option, props);
          else if ((0, import_isFunction.default)(option)) tickItem = option(props);
          else
            tickItem = /*#__PURE__*/ import_react.createElement(
              Text,
              _extends$15({}, props, { className: "recharts-polar-radius-axis-tick-value" }),
              value,
            );
          return tickItem;
        },
...
function _objectSpread$17(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$17(Object(t), !0).forEach(function (r) {
          _defineProperty$20(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$17(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function _callSuper$11(t, o, e) {
  return (
    (o = _getPrototypeOf$11(o)),
    _possibleConstructorReturn$11(
      t,
      _isNativeReflectConstruct$11()
        ? Reflect.construct(o, e || [], _getPrototypeOf$11(t).constructor)
        : o.apply(t, e),
    )
  );
}
...
function _getPrototypeOf$11(o) {
  _getPrototypeOf$11 = Object.setPrototypeOf
    ? Object.getPrototypeOf.bind()
    : function _getPrototypeOf(o) {
        return o.__proto__ || Object.getPrototypeOf(o);
      };
...
function _setPrototypeOf$11(o, p) {
  _setPrototypeOf$11 = Object.setPrototypeOf
    ? Object.setPrototypeOf.bind()
    : function _setPrototypeOf(o, p) {
        o.__proto__ = p;
        return o;
      ...
      },
      {
        ...
        value: function renderAxisLine() {
          ...
          var props = _objectSpread$17(
            _objectSpread$17({}, filterProps(this.props, false)),
            {},
            { fill: "none" },
            filterProps(axisLine, false),
          );
          if (axisLineType === "circle")
            return /*#__PURE__*/ import_react.createElement(
              Dot,
              _extends$14({ className: "recharts-polar-angle-axis-line" }, props, {
                cx,
                cy,
                r: radius,
              }),
          ...
          return /*#__PURE__*/ import_react.createElement(
            Polygon,
            _extends$14({ className: "recharts-polar-angle-axis-line" }, props, { points }),
          );
        },
      },
      {
        ...
        value: function renderTicks() {
          ...
          var customTickProps = filterProps(tick, false);
          var tickLineProps = _objectSpread$17(
            _objectSpread$17({}, axisProps),
            {},
            { fill: "none" },
          ...
          var items = ticks.map(function (entry, i) {
            ...
            var tickProps = _objectSpread$17(
              _objectSpread$17(
                _objectSpread$17({ textAnchor: _this.getTickTextAnchor(entry) }, axisProps),
                {},
                {
                  stroke: "none",
                  fill: stroke,
    ...
    [
      {
        ...
        value: function renderTickItem(option, props, value) {
          ...
          if (/*#__PURE__*/ import_react.isValidElement(option))
            ...
            tickItem = /*#__PURE__*/ import_react.createElement(
              Text,
              _extends$14({}, props, { className: "recharts-polar-angle-axis-tick-value" }),
              value,
            );
          return tickItem;
        },
...
function _objectSpread$16(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$16(Object(t), !0).forEach(function (r) {
          _defineProperty$19(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$16(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
var Trapezoid = function Trapezoid(props) {
  ...
  var pathRef = (0, import_react.useRef)();
  var _useState2 = _slicedToArray$2((0, import_react.useState)(-1), 2),
    totalLength = _useState2[0],
    setTotalLength = _useState2[1];
  (0, import_react.useEffect)(function () {
    if (pathRef.current && pathRef.current.getTotalLength)
  ...
  if (!isUpdateAnimationActive)
    return /*#__PURE__*/ import_react.createElement(
      ...
      /*#__PURE__*/ import_react.createElement(
        "path",
        _extends$13({}, filterProps(trapezoidProps, true), {
          className: layerClass,
...
function _objectSpread$15(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$15(Object(t), !0).forEach(function (r) {
          _defineProperty$18(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$15(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function ShapeSelector(_ref) {
  ...
  switch (shapeType) {
    case "rectangle":
      return /*#__PURE__*/ import_react.createElement(Rectangle, elementProps);
    case "trapezoid":
      return /*#__PURE__*/ import_react.createElement(Trapezoid, elementProps);
    case "sector":
      return /*#__PURE__*/ import_react.createElement(Sector, elementProps);
    case "symbols":
      if (isSymbolsProps(shapeType, elementProps))
        return /*#__PURE__*/ import_react.createElement(Symbols, elementProps);
      break;
    default:
      return null;
  }
...
function Shape(_ref2) {
  ...
  var shape;
  if (/*#__PURE__*/ (0, import_react.isValidElement)(option))
    shape = /*#__PURE__*/ (0, import_react.cloneElement)(
      option,
      _objectSpread$15(_objectSpread$15({}, props), getPropsFromShapeOption(option)),
    );
  ...
  if (isActive)
    return /*#__PURE__*/ import_react.createElement(Layer, { className: activeClassName }, shape);
  return shape;
}
/**
...
function getActiveShapeIndexForTooltip(_ref3) {
  ...
  var activeItemMatches = itemData.filter(function (datum, dataIndex) {
    ...
    var coordinatesMatch =
      dataIndex ===
      graphicalItem.props[shapeKey].indexOf(
...
function _objectSpread$14(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$14(Object(t), !0).forEach(function (r) {
          _defineProperty$17(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$14(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function _callSuper$10(t, o, e) {
  return (
    (o = _getPrototypeOf$10(o)),
    _possibleConstructorReturn$10(
      t,
      _isNativeReflectConstruct$10()
        ? Reflect.construct(o, e || [], _getPrototypeOf$10(t).constructor)
        : o.apply(t, e),
    )
  );
}
...
function _getPrototypeOf$10(o) {
  _getPrototypeOf$10 = Object.setPrototypeOf
    ? Object.getPrototypeOf.bind()
    : function _getPrototypeOf(o) {
        return o.__proto__ || Object.getPrototypeOf(o);
      };
...
function _setPrototypeOf$10(o, p) {
  _setPrototypeOf$10 = Object.setPrototypeOf
    ? Object.setPrototypeOf.bind()
    : function _setPrototypeOf(o, p) {
        o.__proto__ = p;
        return o;
      ...
      },
      {
        ...
        value: function renderLabels(sectors) {
          ...
          var labels = sectors.map(function (entry, i) {
            ...
            var labelProps = _objectSpread$14(
              _objectSpread$14(
                _objectSpread$14(_objectSpread$14({}, pieProps), entry),
                {},
                { stroke: "none" },
                customLabelProps,
              ),
            ...
            var lineProps = _objectSpread$14(
              _objectSpread$14(
                _objectSpread$14(_objectSpread$14({}, pieProps), entry),
                {},
                {
      ...
      },
      {
        ...
        value: function renderSectorsStatically(sectors) {
          ...
          return sectors.map(function (entry, i) {
            ...
            var sectorProps = _objectSpread$14(
              _objectSpread$14({}, entry),
              {},
              {
          ...
          return /*#__PURE__*/ import_react.createElement(
            ...
            function (_ref2) {
              ...
              sectors.forEach(function (entry, index) {
                ...
                var paddingAngle =
                  index > 0 ? (0, import_get.default)(entry, "paddingAngle", 0) : 0;
                if (prev) {
                  var angleIp = interpolateNumber$1(
                    prev.endAngle - prev.startAngle,
                    entry.endAngle - entry.startAngle,
                  );
                  var latest = _objectSpread$14(
                    _objectSpread$14({}, entry),
                    {},
                    {
      ...
      },
      {
        ...
        value: function renderSectors() {
          ...
          if (
            ...
            sectors &&
            sectors.length &&
            (!prevSectors || !(0, import_isEqual.default)(prevSectors, sectors))
          )
    ...
    [
      ...
      },
      {
        ...
        value: function renderLabelLineItem(option, props, key) {
          if (/*#__PURE__*/ import_react.isValidElement(option))
            return /*#__PURE__*/ import_react.cloneElement(option, props);
      ...
      },
      {
        ...
        value: function renderLabelItem(option, props, value) {
          ...
          var className = clsx(
            ...
            typeof option !== "boolean" && !(0, import_isFunction.default)(option)
              ? option.className
              : "",
          );
          return /*#__PURE__*/ import_react.createElement(
  ...
  if (data && data.length)
    return data.map(function (entry, index) {
      return _objectSpread$14(
        _objectSpread$14(_objectSpread$14({ payload: entry }, presentationProps), entry),
...
_defineProperty$17(Pie, "parseCoordinateOfPie", function (itemProps, offset) {
  ...
  return {
    ...
    outerRadius: getPercentValue(itemProps.outerRadius, maxPieRadius, maxPieRadius * 0.8),
...
_defineProperty$17(Pie, "getComposedData", function (_ref4) {
  ...
  var itemProps =
    item.type.defaultProps !== void 0
      ? _objectSpread$14(_objectSpread$14({}, item.type.defaultProps), item.props)
      : item.props;
          ...
          _objectSpread$14(
            {
              ...
              midAngle,
              middleRadius,
              tooltipPosition: polarToCartesian(
                coordinate.cx,
                coordinate.cy,
                middleRadius,
                midAngle,
...
function _objectSpread$13(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$13(Object(t), !0).forEach(function (r) {
          _defineProperty$16(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$13(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
var generatePrefixStyle = function generatePrefixStyle(name, value) {
  ...
  var result = PREFIX_LIST.reduce(function (res, entry) {
    return _objectSpread$13(
      _objectSpread$13({}, res),
      {},
      _defineProperty$16({}, entry + camelName, value),
    );
  }, {});
  result[name] = value;
  return result;
...
function _objectSpread$12(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$12(Object(t), !0).forEach(function (r) {
          _defineProperty$15(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$12(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
    ...
    [
      ...
      },
      {
        ...
        value: function handleTravellerMove(e) {
          ...
          this.setState(
            _defineProperty$15(
              _defineProperty$15({}, movingTravellerId, prevValue + delta),
              "brushMoveStartX",
              e.pageX,
            ),
            function () {
      ...
      },
      {
        ...
        value: function renderTravellerLayer(travellerX, id) {
          ...
          var travellerProps = _objectSpread$12(
            _objectSpread$12({}, filterProps(this.props, false)),
            {},
            {
              x,
              y,
    ...
    [
      ...
      },
      {
        ...
        value: function renderTraveller(option, props) {
          var rectangle;
          if (/*#__PURE__*/ import_react.isValidElement(option))
            rectangle = /*#__PURE__*/ import_react.cloneElement(option, props);
...
function _objectSpread$11(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$11(Object(t), !0).forEach(function (r) {
          _defineProperty$14(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$11(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
...
function typeguardBarRectangleProps(_ref, props) {
  ...
  return _objectSpread$11(
    _objectSpread$11(
      _objectSpread$11(_objectSpread$11(_objectSpread$11({}, props), option), x ? { x } : {}),
      y ? { y } : {},
    ),
    {},
    {
...
function _objectSpread$10(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2
      ? ownKeys$10(Object(t), !0).forEach(function (r) {
          _defineProperty$13(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$10(Object(t)).forEach(function (r) {
            Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
          });
  }
  return e;
          ...
          return (
            ...
            data.map(function (entry, i) {
              ...
              var props = _objectSpread$10(
                _objectSpread$10(_objectSpread$10({}, baseProps), entry),
                {},
                {
                  isActive,
                  option,
              ...
              return /*#__PURE__*/ import_react.createElement(
                ...
                /*#__PURE__*/ import_react.createElement(BarRectangle, props),
              );
            })
          );
        },
      ...
      },
      {
        ...
        value: function renderRectangles() {
          ...
          if (
            ...
            data &&
            data.length &&
            (!prevData || !(0, import_isEqual.default)(prevData, data))
          )
        ...
        value: function renderBackground() {
          ...
          return data.map(function (entry, i) {
            ...
            var props = _objectSpread$10(
              _objectSpread$10(
                _objectSpread$10(
                  _objectSpread$10(_objectSpread$10({}, rest), {}, { fill: "#eee" }, background),
                  backgroundProps,
                ),
...
_defineProperty$13(Bar, "getComposedData", function (_ref2) {
  ...
  var itemProps =
    itemDefaultProps !== void 0
      ? _objectSpread$10(_objectSpread$10({}, itemDefaultProps), item.props)
      : item.props;
  var dataKey = itemProps.dataKey,
    children = itemProps.children,
...
var formatAxisMap = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function (result, id) {
    ...
    var ticks = getTicksOfScale(
      scale,
      _objectSpread$9(_objectSpread$9({}, axis), {}, { realScaleType }),
    );
    if (axisType === "xAxis") {
    ...
    var finalAxis = _objectSpread$9(
      _objectSpread$9(_objectSpread$9({}, axis), ticks),
      {},
      {
        realScaleType,
        x,
...
var createLabeledScales = function createLabeledScales(options) {
  var scales = Object.keys(options).reduce(function (res, key) {
    return _objectSpread$9(
      _objectSpread$9({}, res),
      {},
      _defineProperty$12({}, key, ScaleHelper.create(options[key])),
    );
  }, {});
  return _objectSpread$9(
    _objectSpread$9({}, scales),
    {},
    {
...
var getAngledRectangleWidth = function getAngledRectangleWidth(_ref6) {
  var width = _ref6.width,
    height = _ref6.height;
  var angleRadians =
    (normalizeAngle(arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0) * Math.PI) /
    180;
 ...
 */
var calculateViewBox = (0, import_memoize.default)(
  function (offset) {
    return {
      x: offset.left,
      y: offset.top,
...
var useYAxisWithFiniteDomainOrRandom = function useYAxisWithFiniteDomainOrRandom() {
  ...
  return (
    (0, import_find.default)(yAxisMap, function (axis) {
...
var renderLine = function renderLine(option, props) {
  var line;
  if (/*#__PURE__*/ import_react.isValidElement(option))
    line = /*#__PURE__*/ import_react.cloneElement(option, props);
  else if ((0, import_isFunction.default)(option)) line = option(props);
  else
    line = /*#__PURE__*/ import_react.createElement(
      "line",
      _extends$8({}, props, { className: "recharts-reference-line-line" }),
    );
  return line;
};
var getEndPoints = function getEndPoints(
  ...
  if (isSegment) {
    ...
    if (
      ...
      (0, import_some.default)(_points2, function (p) {
...
function ReferenceLineImpl(props) {
  ...
  var _endPoints = _slicedToArray$1(endPoints, 2),
    ...
    x2 = _endPoints$2.x,
    y2 = _endPoints$2.y;
  var lineProps = _objectSpread$8(
    _objectSpread$8(
      { clipPath: ifOverflowMatches(props, "hidden") ? "url(#".concat(clipPathId, ")") : void 0 },
  ...
  return _createClass$7(ReferenceDot, [
    {
      ...
      value: function render() {
        ...
        var dotProps = _objectSpread$7(
          _objectSpread$7(
            {
              clipPath: ifOverflowMatches(this.props, "hidden")
...
_defineProperty$10(ReferenceDot, "renderDot", function (option, props) {
  var dot;
  if (/*#__PURE__*/ import_react.isValidElement(option))
    dot = /*#__PURE__*/ import_react.cloneElement(option, props);
  else if ((0, import_isFunction.default)(option)) dot = option(props);
  else
    dot = /*#__PURE__*/ import_react.createElement(
      Dot,
      _extends$7({}, props, {
        cx: props.cx,
        cy: props.cy,
      ...
      value: function render() {
        ...
        return /*#__PURE__*/ import_react.createElement(
          ...
          ReferenceArea.renderRect(
            shape,
            _objectSpread$6(_objectSpread$6({ clipPath }, filterProps(this.props, true)), rect),
          ),
...
_defineProperty$9(ReferenceArea, "renderRect", function (option, props) {
  var rect;
  if (/*#__PURE__*/ import_react.isValidElement(option))
    rect = /*#__PURE__*/ import_react.cloneElement(option, props);
  else if ((0, import_isFunction.default)(option)) rect = option(props);
  else
    rect = /*#__PURE__*/ import_react.createElement(
      Rectangle,
      _extends$6({}, props, { className: "recharts-reference-area-rect" }),
    );
  return rect;
});
//#endregion
...
function getEveryNthWithCondition(array, n, isValid) {
  ...
  for (var i = 0; i < array.length; i += n)
    if (isValid === void 0 || isValid(array[i]) === true) result.push(array[i]);
    else return;
  return result;
}
//#endregion
...
function getTicksEnd(sign, boundaries, getTickSize, ticks, minTickGap) {
  ...
  var _loop = function _loop(i) {
    ...
    if (i === len - 1) {
      ...
      result[i] = entry = _objectSpread$5(
        _objectSpread$5({}, entry),
        {},
...
function getTicksStart(sign, boundaries, getTickSize, ticks, minTickGap, preserveEnd) {
  ...
  if (preserveEnd) {
    ...
    result[len - 1] = tail = _objectSpread$5(
      _objectSpread$5({}, tail),
      {},
...
function getTicks(props, fontSize, letterSpacing) {
  ...
  var getTickSize = function getTickSize(content, index) {
    var value = (0, import_isFunction.default)(tickFormatter)
    ...
    [
      ...
      },
      {
        ...
        value: function renderAxisLine() {
          ...
          var props = _objectSpread$4(
            _objectSpread$4(
              _objectSpread$4({}, filterProps(this.props, false)),
              filterProps(axisLine, false),
            ),
            {},
            { fill: "none" },
          ...
          return /*#__PURE__*/ import_react.createElement(
            ...
            _extends$5({}, props, {
              className: clsx(
                ...
                (0, import_get.default)(axisLine, "className"),
              ),
            }),
          );
        },
        ...
        value:
          ...
          function renderTicks(ticks, fontSize, letterSpacing) {
            ...
            var finalTicks = getTicks(
              _objectSpread$4(_objectSpread$4({}, this.props), {}, { ticks }),
              fontSize,
              letterSpacing,
            );
            var textAnchor = this.getTickTextAnchor();
            ...
            var axisProps = filterProps(this.props, false);
            var customTickProps = filterProps(tick, false);
            var tickLineProps = _objectSpread$4(
              _objectSpread$4({}, axisProps),
              {},
              { fill: "none" },
              filterProps(tickLine, false),
            );
            var items = finalTicks.map(function (entry, i) {
              ...
              return /*#__PURE__*/ import_react.createElement(
                ...
                tickLine &&
                  /*#__PURE__*/ import_react.createElement(
                    "line",
                    _extends$5({}, tickLineProps, lineCoord, {
                      className: clsx(
                        "recharts-cartesian-axis-tick-line",
                        (0, import_get.default)(tickLine, "className"),
                      ),
                    }),
                  ),
                tick &&
                  CartesianAxis.renderTickItem(
                    ...
                    ""
                      .concat(
                        (0, import_isFunction.default)(tickFormatter)
      ...
      },
      {
        ...
        value: function render() {
          ...
          if ((0, import_isFunction.default)(ticksGenerator))
            finalTicks =
              ticks && ticks.length > 0 ? ticksGenerator(this.props) : ticksGenerator(noTicksProps);
    ...
    [
      {
        ...
        value: function renderTickItem(option, props, value) {
          ...
          if (/*#__PURE__*/ import_react.isValidElement(option))
            tickItem = /*#__PURE__*/ import_react.cloneElement(
              option,
              _objectSpread$4(_objectSpread$4({}, props), {}, { className: combinedClassName }),
            );
          else if ((0, import_isFunction.default)(option))
            tickItem = option(
              _objectSpread$4(_objectSpread$4({}, props), {}, { className: combinedClassName }),
            );
          else
            tickItem = /*#__PURE__*/ import_react.createElement(
              Text,
              _extends$5({}, props, { className: "recharts-cartesian-axis-tick-value" }),
              value,
            );
          return tickItem;
        },
...
function renderLineItem(option, props) {
  var lineItem;
  if (/*#__PURE__*/ import_react.isValidElement(option))
    lineItem = /*#__PURE__*/ import_react.cloneElement(option, props);
    ...
    var x1 = props.x1,
      ...
      y2 = props.y2,
      key = props.key,
      _filterProps = filterProps(_objectWithoutProperties$2(props, _excluded$2), false);
    _filterProps.offset;
    var restOfFilteredProps = _objectWithoutProperties$2(_filterProps, _excluded2$2);
    lineItem = /*#__PURE__*/ import_react.createElement(
      "line",
      _extends$4({}, restOfFilteredProps, {
        x1,
        y1,
        x2,
        y2,
...
function HorizontalStripes(props) {
  ...
  if (
    !(_props$horizontal2 === void 0 ? true : _props$horizontal2) ||
    !horizontalFill ||
    !horizontalFill.length
  )
    return null;
  ...
  var items = roundedSortedHorizontalPoints.map(function (entry, i) {
    var lineHeight = !roundedSortedHorizontalPoints[i + 1]
      ? y + height - entry
...
function VerticalStripes(props) {
  ...
  var items = roundedSortedVerticalPoints.map(function (entry, i) {
    var lineWidth = !roundedSortedVerticalPoints[i + 1]
      ? x + width - entry
...
var defaultVerticalCoordinatesGenerator = function defaultVerticalCoordinatesGenerator(
  _ref,
  syncWithTicks,
) {
  ...
  return getCoordinatesOfGrid(
    getTicks(
      _objectSpread$3(
        _objectSpread$3(_objectSpread$3({}, CartesianAxis.defaultProps), xAxis),
        {},
        {
...
var defaultHorizontalCoordinatesGenerator = function defaultHorizontalCoordinatesGenerator(
  _ref2,
  syncWithTicks,
) {
  ...
  return getCoordinatesOfGrid(
    getTicks(
      _objectSpread$3(
        _objectSpread$3(_objectSpread$3({}, CartesianAxis.defaultProps), yAxis),
        {},
        {
...
function CartesianGrid(props) {
  ...
  var propsIncludingDefaults = _objectSpread$3(
    _objectSpread$3({}, props),
    {},
    {
      stroke:
  ...
  if (
    ...
    (0, import_isFunction.default)(horizontalCoordinatesGenerator)
  ) {
  ...
  if (
    ...
    (0, import_isFunction.default)(verticalCoordinatesGenerator)
  ) {
  ...
  return /*#__PURE__*/ import_react.createElement(
    ...
    /*#__PURE__*/ import_react.createElement(Background, {
    ...
    /*#__PURE__*/ import_react.createElement(
      HorizontalGridLines,
      _extends$4({}, propsIncludingDefaults, {
        offset,
        horizontalPoints,
        xAxis,
        yAxis,
    ...
    /*#__PURE__*/ import_react.createElement(
      HorizontalStripes,
      _extends$4({}, propsIncludingDefaults, { horizontalPoints }),
    ),
    /*#__PURE__*/ import_react.createElement(
      VerticalStripes,
      _extends$4({}, propsIncludingDefaults, { verticalPoints }),
    ),
  );
}
    ...
    [
      {
        ...
        value: function renderDots(needClip, clipDot, clipPathId) {
          ...
          return /*#__PURE__*/ import_react.createElement(
            Layer,
            _extends$3({ className: "recharts-area-dots" }, dotsProps),
            dots,
          );
        },
      },
            ...
            function (_ref) {
              ...
              if (prevPoints) {
                ...
                if (isNumber(baseLine) && typeof baseLine === "number")
                  stepBaseLine = interpolateNumber$1(prevBaseLine, baseLine)(t);
                else if ((0, import_isNil.default)(baseLine) || (0, import_isNaN.default)(baseLine))
                  stepBaseLine = interpolateNumber$1(prevBaseLine, 0)(t);
                else
        ...
        value: function renderArea(needClip, clipPathId) {
          ...
          if (
            ...
            ((!prevPoints && totalLength > 0) ||
              !(0, import_isEqual.default)(prevPoints, points) ||
              !(0, import_isEqual.default)(prevBaseLine, baseLine))
          )
      ...
      },
      {
        ...
        value: function render() {
          ...
          var _ref3$clipDot = (hasClipDot(dot) ? dot : {}).clipDot,
...
_defineProperty$5(Area, "renderDotItem", function (option, props) {
  var dotItem;
  if (/*#__PURE__*/ import_react.isValidElement(option))
    dotItem = /*#__PURE__*/ import_react.cloneElement(option, props);
    ...
    dotItem = /*#__PURE__*/ import_react.createElement(
      Dot,
      _extends$3({}, rest, {
        key,
        className,
...
var detectReferenceElementsDomain = function detectReferenceElementsDomain(
  children,
  domain,
  axisId,
  axisType,
...
function Cursor(props) {
  ...
  return /*#__PURE__*/ (0, import_react.isValidElement)(elementPropsCursor)
    ? /*#__PURE__*/ (0, import_react.cloneElement)(elementPropsCursor, cursorProps)
    : /*#__PURE__*/ (0, import_react.createElement)(cursorComp, cursorProps);
}
//#endregion
...
var getActiveCoordinate = function getActiveCoordinate(
  layout,
  tooltipTicks,
  activeIndex,
  rangeObj,
...
var getTooltipContent = function getTooltipContent(state, chartData, activeIndex, activeLabel) {
  ...
  return graphicalItems.reduce(function (result, child) {
    ...
    if (tooltipAxis.dataKey && !tooltipAxis.allowDuplicatedCategory)
      payload = findEntryInArray(
        data === void 0 ? displayedData : data,
        tooltipAxis.dataKey,
        activeLabel,
      );
        ...
        return (
          (axisIdKey in item.props
            ...
            : (_defaultProps = item.type.defaultProps) === null || _defaultProps === void 0
              ? void 0
              : _defaultProps[axisIdKey]) === axisId
        );
      }),
      dataStartIndex,
      dataEndIndex,
    ...
    if (!result[axisId]) {
      ...
      return _objectSpread(
        ...
        _defineProperty(
          ...
          axisId,
          _objectSpread(
            _objectSpread({ axisType }, Axis.defaultProps),
            {},
            {
              hide: true,
              orientation: (0, import_get.default)(
                ORIENT_MAP,
                "".concat(axisType, ".").concat(index % 2),
                null,
              ),
              domain,
              originalDomain,
    ...
    function (result, id) {
      ...
      if (!entry.mirror && !entry.hide)
        return _objectSpread(
          _objectSpread({}, result),
          {},
          _defineProperty({}, orientation, result[orientation] + entry.width),
        );
      return result;
    },
    {
          ...
          if (!entry.mirror && !entry.hide)
            return _objectSpread(
              ...
              _defineProperty(
                {},
                orientation,
                (0, import_get.default)(result, "".concat(orientation)) + entry.height,
              ),
            );
          return result;
        },
...
var generateCategoricalChart = function generateCategoricalChart(_ref6) {
    ...
    graphicalItems.forEach(function (item, index) {
      ...
      var axisObj = axisComponents.reduce(function (result, entry) {
        ...
        return _objectSpread(
          ...
          {},
          _defineProperty(
            _defineProperty({}, entry.axisType, axis),
      ...
      if (itemIsBar) {
        ...
        var maxBarSize = (0, import_isNil.default)(childMaxBarSize)
          ? globalMaxBarSize
          : childMaxBarSize;
        var barBandSize =
          (_ref7 =
  ...
  var updateStateOfAxisMapsOffsetAndStackGroups =
    function updateStateOfAxisMapsOffsetAndStackGroups(_ref8, prevState) {
      ...
      return _objectSpread(
        _objectSpread(
          {
            formattedGraphicalItems: getFormatItems(
              props,
              _objectSpread(
                _objectSpread({}, axisObj),
                {},
  ...
  var CategoricalChartWrapper = /*#__PURE__*/ (function (_Component) {
    function CategoricalChartWrapper(_props) {
      ...
      _defineProperty(_this, "triggeredAfterMouseMove", function (e) {
        var mouse = _this.getMouseInfo(e);
        var nextState = mouse
          ? _objectSpread(_objectSpread({}, mouse), {}, { isTooltipActive: true })
      ...
      _defineProperty(_this, "renderActivePoints", function (_ref10) {
        ...
        var itemItemProps =
          item.item.type.defaultProps !== void 0
            ? _objectSpread(_objectSpread({}, item.item.type.defaultProps), item.item.props)
            : item.item.props;
      ...
      _defineProperty(_this, "renderGraphicChild", function (element, displayName, index) {
        ...
        var graphicalItem = /*#__PURE__*/ (0, import_react.cloneElement)(
          element,
        ...
        if (hasActive) {
          if (activeTooltipIndex >= 0) {
            ...
            if (activeShape || activeBar) {
              var activeIndex =
                element.props.activeIndex !== void 0
                  ...
                  : activeTooltipIndex;
              return [
                /*#__PURE__*/ (0, import_react.cloneElement)(
                  element,
                  _objectSpread(
                    _objectSpread(_objectSpread({}, item.props), itemEvents),
                    {},
            ...
            if (!(0, import_isNil.default)(activePoint))
            ...
            return [/*#__PURE__*/ (0, import_react.cloneElement)(xyItem, elementProps), null, null];
          }
        }
      ...
      _defineProperty(_this, "renderCustomized", function (element, displayName, index) {
        return /*#__PURE__*/ (0, import_react.cloneElement)(
          element,
          _objectSpread(
            _objectSpread({ key: "recharts-customized-".concat(index) }, _this.props),
            _this.state,
          ),
        );
      });
      ...
      _this.throttleTriggeredAfterMouseMove = (0, import_throttle.default)(
    ...
    return _createClass(CategoricalChartWrapper, [
      ...
      },
      {
        ...
        value: function parseEventsOfWrapper() {
          ...
          return _objectSpread(
            _objectSpread({}, adaptEventHandlers(this.props, this.handleOuterEvent)),
            tooltipEvents,
          );
        },
      },
          ...
          return xAxisMap
            ? Object.entries(xAxisMap).reduce(function (res, _ref13) {
                ...
                return _objectSpread(
                  _objectSpread({}, res),
                  {},
                  _defineProperty({}, axisId, axisProps.scale),
                );
              }, {})
            : null;
        },
  ...
  _defineProperty(
    ...
    function (nextProps, prevState) {
      ...
      if (prevState.updateId === void 0) {
        ...
        return _objectSpread(
          _objectSpread(
            ...
            { updateId: 0 },
            updateStateOfAxisMapsOffsetAndStackGroups(
              _objectSpread(_objectSpread({ props: nextProps }, defaultState), {}, { updateId: 0 }),
              prevState,
            ),
          ),
          {},
      ...
      if (
        ...
        return _objectSpread(
          _objectSpread(
            ...
            updateStateOfAxisMapsOffsetAndStackGroups(
              _objectSpread({ props: nextProps }, newState),
              prevState,
            ),
          ),
          {},
      ...
      if (!isChildrenEqual(children, prevState.prevChildren)) {
        ...
        var newUpdateId =
          !(0, import_isNil.default)(data) && !hasDifferentStartOrEndIndex
            ? prevState.updateId
        ...
        return _objectSpread(
          _objectSpread(
            ...
            updateStateOfAxisMapsOffsetAndStackGroups(
              _objectSpread(
                _objectSpread({ props: nextProps }, prevState),
                {},
                {
                  updateId: newUpdateId,
                  dataStartIndex: startIndex,
  ...
  _defineProperty(CategoricalChartWrapper, "renderActiveDot", function (option, props, key) {
    var dot;
    if (/*#__PURE__*/ (0, import_react.isValidElement)(option))
      dot = /*#__PURE__*/ (0, import_react.cloneElement)(option, props);
    else if ((0, import_isFunction.default)(option)) dot = option(props);
  ...
  var CategoricalChart = /*#__PURE__*/ (0, import_react.forwardRef)(
