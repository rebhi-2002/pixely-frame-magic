...
*Chapter 3 --- companion to the SRS (v1.0) and Milestone M3*
...
> *Everything in sections 3.4--3.8 below was cross-checked directly
...
> *The repository currently has two nearly-identical projects,
...
> *Revision (v1.1): the wallet screen must show a full record of money
...
> bank for a withdrawal).*

![](media/e565206f7c4bd8c1efe9dbbbe926dc095bc01793.png){width="6.25in"
height="4.4375in"}

*Figure 3.2 --- Proposed Wallet & Financial Transactions ERD (revised)*
...
***Relationships:** 1:1 with AspNetUsers. 1:N with WalletTransactions.*
...
***Relationships:** N:1 with Wallets. References the source request
(top-up/withdrawal/enrollment) via RelatedEntityType/Id, and is kept in
sync with that request\'s status.*
...
***Relationships:** N:1 with AspNetUsers (student). Creates one
...
credits Wallets.Balance, rejection flips it to Rejected.*
...
***Relationships:** N:1 with AspNetUsers (instructor). Creates one
...
any pre-completion stage flips it to Rejected.*
...
***Relationships:** 1:N with PlatformRevenueLedger (each enrollment fee
split uses the active rate at the time).*
...
***Relationships:** N:1 with Enrollments. Written by the same service
call that creates the instructor\'s InstructorCredit transaction
(FR-W03b), so the two always agree.*

***WalletTransactions --- Status Lifecycle***
...
> *Reversed applies to any Completed entry that Admin later corrects
...
*Figure 3.3 --- Proposed Enrollment, Courses & Content ERD*
...
***Relationships:** 1:N with Groups and Courses.*
...
***Relationships:** 1:N with Courses.*
...
***Relationships:** N:1 with Teachers, Subjects, CourseCategories. 1:N
with Lessons, JoinRequests, Enrollments.*
...
***Relationships:** N:1 with Students; references exactly one of Group
or Course. Produces one Enrollments row on approval.*
...
***Relationships:** N:1 with Students, Groups/Courses, and the
originating JoinRequest. Drives FR-W03a/FR-W03b (fee deduction &
commission split) and PlatformRevenueLedger.*
...
***Relationships:** N:1 with Groups or Courses. 1:N with
LessonMaterials.*
...
***Relationships:** N:1 with Lessons.*
...
*Figure 3.4 --- Proposed Academic Tracking, Notifications & Audit ERD*
...
***Relationships:** N:1 with Students and Groups.*
...
***Relationships:** N:1 with Groups/Courses. 1:N with ExamResults.*
...
***Relationships:** N:1 with Exams and Students.*
...
***Relationships:** N:1 with AspNetUsers.*
...
> *Every new endpoint must sit behind the existing \[Authorize\] +
