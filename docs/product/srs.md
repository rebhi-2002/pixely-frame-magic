...
*Note: use \"Maximum Number of Students\" rather than \"Number of
...
*Note: the displayed student information shall be limited to the
...
*Note: the system records and displays externally hosted meeting
...
*Note: the lesson is cancelled rather than deleted, so that attendance
and reporting history is preserved.*
